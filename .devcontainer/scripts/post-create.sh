...
echo "============================================"
echo "  Helios — Dev Container Setup"
echo "============================================"
echo ""

# --- 0. Fix ownership of named volumes (created as root by Docker) ---
echo "==> [0/7] Fixing volume permissions ..."
for vol_dir in /workspace/node_modules /workspace/apps/helios/.next /workspace/apps/helios/storage; do
