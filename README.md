<p align="center">
  <img src="./apps/helios/public/helios.svg" alt="Helios logo" width="120" />
</p>

# Helios

[![License: MIT](https://img.shields.io/badge/License-MIT-green.svg)](LICENSE)
[![Docs](https://img.shields.io/badge/docs-helios.com-1F7AE0.svg)](https://docs.helios.com/)
[![PRs Welcome](https://img.shields.io/badge/PRs-welcome-ff69b4.svg)](https://github.com/helios/helios/issues)
[![Built with Next.js](https://img.shields.io/badge/Built%20with-Next.js-black?logo=next.js)](https://nextjs.org/)

**Helios - the AI-Engineering Foundation Framework.**
...
Helios is the open-source foundation framework that solves it:
...
**Buy vs. build?** Now, you can have best of both. Use **Helios** enterprise-ready business features like CRM, Sales, OMS, Encryption, and build the remaining **20&percnt;** that really makes the difference for your business.
...
<p align="center">
  ...
  ·
  <a href="#developing-your-first-helios-app">🎬 Building your First Helios App</a>
  ·
  <a href="https://docs.helios.com/">📚 Documentation</a>
</p>
...
[![Explore the Helios live demo](./apps/docs/static/screenshots/helios-onboarding-showoff.png)](https://demo.helios.com)
...
<table>
  <tr>
    <td align="center" width="33%">
      <a href="./apps/docs/static/screenshots/helios-dashboard.png"><img src="./apps/docs/static/screenshots/helios-dashboard.png" alt="Helios dashboard" height="170"/></a><br/>
      <strong>Dashboard</strong>
    </td>
    <td align="center" width="33%">
      <a href="./apps/docs/static/screenshots/helios-orders-order-details.png"><img src="./apps/docs/static/screenshots/helios-orders-order-details.png" alt="Order details view" height="170"/></a><br/>
      <strong>Order Details</strong>
    </td>
    <td align="center" width="33%">
      <a href="./apps/docs/static/screenshots/helios-ai-assistant-chat.png"><img src="./apps/docs/static/screenshots/helios-ai-assistant-chat.png" alt="AI Assistant chat" height="170"/></a><br/>
...
Read more on the [Helios Architecture](https://docs.helios.com/architecture/system-overview)
...
Copy-Item apps\helios\.env.example apps\helios\.env
# set DATABASE_URL / JWT_SECRET / REDIS_URL in apps\helios\.env
yarn dev:greenfield
```
...
<details>
<summary><strong>📦 Standalone app</strong> — build on Helios without touching the core</summary>
...
To keep two long-lived local instances pointing at the same PostgreSQL server (e.g. `client-a` next to a stock `helios`), pass an optional database-name override to `yarn dev`, `yarn dev:greenfield`, or `yarn setup`:
...
Without the flag, behavior is unchanged (no prompt, no `.env` mutation). See the [installation guides](https://docs.helios.com/installation/monorepo) and [`yarn setup`](https://docs.helios.com/installation/setup) for details.
...
HELIOS_WATCH_SCOPE=auto-optimized yarn dev

# Watch only an explicit set of packages
HELIOS_WATCH_SCOPE=env HELIOS_WATCH_PACKAGES=core,ui yarn dev

# Watch only the most frequently changed packages (default cap: 6)
yarn dev --watch=popular
```

Set `HELIOS_WATCH_SCOPE=all` (or `--watch=all`) to restore watching every package. See [Choosing which packages the watcher tracks](https://docs.helios.com/appendix/troubleshooting) for the full reference, including `HELIOS_WATCH_POPULAR_LIMIT` and the `git`-detection toggles.
...
| | Guide |
|---|---|
| 🔧 **Monorepo** — contribute to the core or demo the full platform | [🍎 macOS](https://docs.helios.com/installation/monorepo#macos) · [🐧 Linux](https://docs.helios.com/installation/monorepo#linux) · [🪟 Windows](https://docs.helios.com/installation/monorepo#windows) |
| 📦 **Standalone app** — build your product without modifying the core | [🍎 macOS](https://docs.helios.com/installation/standalone#macos) · [🐧 Linux](https://docs.helios.com/installation/standalone#linux) · [🪟 Windows](https://docs.helios.com/installation/standalone#windows) |
| 🐧 **Windows with WSL2** — Ubuntu on Windows: memory config, Docker, GitHub CLI, native Postgres bridging | [WSL2 guide →](https://docs.helios.com/installation/wsl2) |
| 🐳 **Docker dev** — full containerized dev with hot reload, no local toolchain | [All platforms →](https://docs.helios.com/installation/docker) |
| 🚀 **VPS / production** — deploy a full stack to any Linux server | [Deploy guide →](https://docs.helios.com/installation/vps) |
| 🛠️ **Dev Container** — zero-install VS Code environment | [Setup guide →](https://docs.helios.com/installation/devcontainer) |
| ☁️ **Railway** — one-click cloud deployment | [Railway guide →](https://docs.helios.com/installation/railway) |
...
<table>
  <tr>
    ...
    <td align="center" valign="top">
      <strong>How to install Helios on Windows</strong><br/><br/>
...
All of our experience building this enterprise-grade ERP is distilled into **[helios/skills](https://github.com/helios/skills)** — re-usable, **technology-agnostic** agent skills for autonomous PR creation, code review, CI stabilization, spec writing, integration testing, and merge management.

Stack-agnostic — install them all with one command:

```bash
npx skills add helios/skills --skill '*'
```

[![Helios Skills](https://img.shields.io/badge/GitHub-helios%2Fskills-181717?logo=github)](https://github.com/helios/skills)

---

## Spec Driven Development

Helios follows a **spec-first development approach**. Before implementing new features or making significant changes, we document the design in the `.ai/specs/` folder.
...
### Developing your first Helios app

<table>
  <tr>
    <td align="center" width="50%" valign="top">
      <strong>How to use Helios CRM as a backend for the custom app</strong><br/><br/>
      <a href="https://www.youtube.com/watch?v=y-lxRrAzbYc&t=1s"><img src="https://img.youtube.com/vi/y-lxRrAzbYc/maxresdefault.jpg" alt="How to use Helios CRM as a backend for the custom app" width="400"/></a>
    </td>
    <td align="center" width="50%" valign="top">
      <strong>How to build custom landing page with Helios as a backend</strong><br/><br/>
      <a href="https://www.youtube.com/watch?v=fb47pmH6ojE&t=854s"><img src="https://img.youtube.com/vi/fb47pmH6ojE/maxresdefault.jpg" alt="How to build custom landing page with Helios as a backend" width="400"/></a>
    </td>
  </tr>
</table>

These walkthroughs show how to treat Helios as a ready-made business backend while keeping the frontend fully custom. You can start from the built-in CRM data model, expose it through the generated APIs, and then build the customer-facing experience around your product's own design. They are a practical path from the default admin setup to a tailored app or landing page powered by Helios.
...
<table>
  <tr>
    <td width="50%" valign="top">
      Start your own Sandbox instance with Claude Code, Codex, Visual Studio Code, and Helios in under 30 seconds.<br/><br/>
      <a href="https://sandboxes.helios.com">Launch a Sandbox instance</a>
    </td>
    <td align="center" width="50%" valign="top">
      <a href="https://sandboxes.helios.com"><img src="https://img.youtube.com/vi/dGdacjG4Ul0/maxresdefault.jpg" alt="Helios Sandbox preview" width="400"/></a>
    </td>
  </tr>
</table>
...
Helios ships with a module system that lets you add features to your app without forking or modifying the platform. The **[Official Modules](https://github.com/helios/official-modules)** repo is where the community publishes those features.
...
Whether you're adding a small UI widget or shipping a full vertical feature with its own entities, API routes, and admin pages — if it runs on Helios, it belongs there.

## AI Assistant

Helios ships with focused AI assistants that open inside the admin pages where your team already works. Agents are scoped by module, permissions, and tool allowlists, and any write is staged behind an explicit approval card before data changes.

<table>
  <tr>
    <td><a href="apps/docs/static/screenshots/helios-ai-assistant-available-assistants.png"><img src="apps/docs/static/screenshots/helios-ai-assistant-available-assistants.png" alt="AI Assistant global launcher listing available assistants" width="390"/></a></td>
    <td><a href="apps/docs/static/screenshots/helios-ai-assistant-mutations-approvals.png"><img src="apps/docs/static/screenshots/helios-ai-assistant-mutations-approvals.png" alt="AI Assistant mutation approval flow" width="390"/></a></td>
  </tr>
  <tr>
...
- PR package previews are opt-in. Run the `Package Previews` workflow manually with the PR number, or use the `helios-auto-publish-pr` skill / `gh workflow run`, to publish pkg.pr.new previews without publishing to npm. Run `NPM Snapshot Preview` manually only when you need the legacy npm canary snapshot and standalone validation path.

Examples:

```bash
yarn add @helios/core@develop
npx create-helios-app@develop my-app
```

## Docker Setup

Helios ships two Docker Compose configurations — one for hot-reload development and one for production. Full step-by-step guides with environment variables, troubleshooting, and upgrade instructions:

- 🐳 [Docker dev setup](https://docs.helios.com/installation/docker) — hot reload, no local toolchain required
- 🚀 [VPS / production deployment](https://docs.helios.com/installation/vps) — full production stack with security guidance and backup instructions
- 🛠️ [Dev Container](https://docs.helios.com/installation/devcontainer) — zero-install VS Code environment (12 GB RAM recommended)
- ☁️ [Deploy on Railway](https://docs.helios.com/installation/railway) — one-click cloud deployment

## Documentation

Browse the full documentation at [docs.helios.com](https://docs.helios.com/).

- [Introduction](https://docs.helios.com/introduction/overview)
- [Installation](https://docs.helios.com/installation)
- [User Guide](https://docs.helios.com/user-guide/overview)
- [Tutorials](https://docs.helios.com/tutorials/first-app)
- [Customization](https://docs.helios.com/customization/build-first-app)
- [Architecture](https://docs.helios.com/architecture/system-overview)
- [Framework](https://docs.helios.com/framework/modules/overview)
- [API Reference](https://docs.helios.com/api/overview)
- [CLI Reference](https://docs.helios.com/cli/overview)
- [Appendix](https://docs.helios.com/appendix/troubleshooting)
...
Honoring the champions of the **Helios Agentic Hackathon** — Sopot, 10–12 April 2026.

### 🥇 Team HeliosMinds — 378 pts · 36 PRs
...
2. Install dependencies with `yarn install` and bootstrap via `yarn helios init` (add `--no-examples` to skip demo CRM content; `--stresstest` for thousands of synthetic contacts, companies, deals, and timeline interactions; or `--stresstest --lite` for high-volume contacts without the heavier extras).
...
Helios is proudly supported by [Catch The Tornado](https://catchthetornado.com/).

<div align="center">
  <a href="https://catchthetornado.com/">
    <img src="./apps/helios/public/catch-the-tornado-logo.png" alt="Catch The Tornado logo" width="96" />
  </a>
</div>

## CLI Commands

Helios let the module developers to expose the custom CLI commands for variouse maintenance tasks. Read more on the [CLI documentation](https://docs.helios.com/cli/overview)

## Considering a project on Helios?

If you're planning to build on Helios, don’t go it alone.

### Certified Partner Agencies

**Reach out to us** - we will connect you with one of our Certified Partner Agencies. Our Partnership Program certifies software consultancies that actively use and contribute to Helios.

Our mission is simple: ensure every Helios deployment is successful, secure, and scalable.
...
Helios Core is and always will be MIT Licensed, fully Open Source.

### Helios Enterprise Subscription

The Helios Enterprise Subscription helps ensure your deployment is secure, scalable, and production-ready without surprises before go-live.

It combines certification, expert reviews, and ongoing advisory support for teams building serious systems on Helios.
...
Contact us to get support for your implementation: [info@helios.com](mailto:info@helios.com)

Enterprise features are delivered under the `@helios/enterprise` package (`/packages/enterprise`) and are not part of the open source license scope.
