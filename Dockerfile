...
COPY apps/helios/package.json ./apps/helios/
...
COPY --from=builder /app/apps/helios/package.json ./apps/helios/
...
RUN yarn workspaces focus @helios/app --production

# Copy workspace sources after production dependencies are installed.
COPY --from=builder /app/packages/ ./packages/

# Copy built Next.js application
COPY --from=builder /app/apps/helios/.helios/next ./apps/helios/.helios/next
COPY --from=builder /app/apps/helios/public ./apps/helios/public
COPY --from=builder /app/apps/helios/next.config.ts ./apps/helios/
COPY --from=builder /app/apps/helios/components.json ./apps/helios/
COPY --from=builder /app/apps/helios/tsconfig.json ./apps/helios/
COPY --from=builder /app/apps/helios/postcss.config.mjs ./apps/helios/

# Copy generated files and other runtime necessities
COPY --from=builder /app/apps/helios/.helios/generated ./apps/helios/.helios/generated
COPY --from=builder /app/apps/helios/src ./apps/helios/src
COPY --from=builder /app/apps/helios/types ./apps/helios/types
