...
describe('resolveSafeHostAddress — connect-time SSRF pinning', () => {
  afterEach(() => {
    delete process.env.HELIOS_CHANNEL_IMAP_ALLOW_INTERNAL_HOSTS
  })
  ...
  it('skips resolution and returns the host verbatim when HELIOS_CHANNEL_IMAP_ALLOW_INTERNAL_HOSTS=true', async () => {
