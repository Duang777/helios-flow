import type { ChannelCapabilities } from '@helios/core/modules/communication_channels/lib/adapter'
import { baseEmailCapabilities } from '@helios/core/modules/communication_channels/lib/email-capabilities'
