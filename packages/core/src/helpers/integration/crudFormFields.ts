...
export const CRUDFORM_EXTENSION_TESTS_DISABLED_ENV = 'HELIOS_INTEGRATION_CRUDFORM_EXTENSION_TESTS_DISABLED';
 ...
 * via `HELIOS_INTEGRATION_CRUDFORM_EXTENSION_TESTS_DISABLED=1` (or `true`/`yes`/`on`).
 */
