...
jest.mock('@helios/shared/lib/db/mikro', () => {
  const baseEm: any = {
    fork: () => baseEm,
...
jest.mock('@helios/shared/lib/query/engine', () => ({
  __esModule: true,
  BasicQueryEngine: class {},
}))

jest.mock('@helios/shared/lib/data/engine', () => ({
  __esModule: true,
  DefaultDataEngine: class {},
}))

jest.mock('@helios/shared/lib/commands', () => ({
  __esModule: true,
  commandRegistry: {},
  CommandBus: class { constructor() {} },
}))

jest.mock('@helios/shared/modules/overrides', () => ({
  __esModule: true,
...
jest.mock('@helios/shared/lib/encryption/subscriber', () => ({
  __esModule: true,
...
jest.mock('@helios/core/modules/notifications/lib/notificationService', () => {
  const actual = jest.requireActual(
    '@helios/core/modules/notifications/lib/notificationService',
  )
  return {
    __esModule: true,
    ...actual,
...
import { register as registerCatalogDi } from '@helios/core/modules/catalog/di'
import { register as registerNotificationsDi } from '@helios/core/modules/notifications/di'
import { createNotificationService } from '@helios/core/modules/notifications/lib/notificationService'
