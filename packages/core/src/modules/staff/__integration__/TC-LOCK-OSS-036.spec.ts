...
} from '@helios/core/modules/core/__integration__/helpers/staffFixtures'
import {
  bumpRecordViaApi,
 ...
 * so the now-stale `x-helios-ext-optimistic-lock-expected-updated-at` header triggers
...
test.describe('TC-LOCK-OSS-036: staff job-history nested edit optimistic lock (STF-06, API)', () => {
   ...
   * `x-helios-ext-optimistic-lock-expected-updated-at` header (additive — the
