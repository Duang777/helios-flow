...
import { Tabs, TabsList, TabsTrigger } from '@helios/ui/primitives/tabs'
import { readApiResultOrThrow } from '@helios/ui/backend/utils/apiCall'
import { extractCustomFieldEntries } from '@helios/shared/lib/crud/custom-fields-client'
import { updateCrud, deleteCrud } from '@helios/ui/backend/utils/crud'
import { switchTeamMemberSchedule } from '@helios/core/modules/staff/lib/scheduleSwitch'
import { flash } from '@helios/ui/backend/FlashMessages'
import { useT } from '@helios/shared/lib/i18n/context'
import { createTranslatorWithFallback } from '@helios/shared/lib/i18n/translate'
import { AvailabilityRulesEditor } from '@helios/core/modules/planner/components/AvailabilityRulesEditor'
import { buildMemberScheduleItems } from '@helios/core/modules/staff/lib/memberSchedule'
import { TeamMemberForm, buildTeamMemberPayload, type TeamMemberFormValues } from '@helios/core/modules/staff/components/TeamMemberForm'
import { buildRecordInjectionContext, useSetCurrentRecordInjectionContext } from '@helios/ui/backend/injection/recordContext'
import { NotesSection } from '@helios/ui/backend/detail'
import { ActivitiesSection, type SectionAction } from '@helios/ui/backend/detail'
import { AddressesSection as SharedAddressesSection } from '@helios/ui/backend/detail'
import { ErrorMessage, RecordNotFoundState } from '@helios/ui/backend/detail'
import { renderDictionaryColor, renderDictionaryIcon, ICON_SUGGESTIONS } from '@helios/core/modules/dictionaries/components/dictionaryAppearance'
import { createStaffNotesAdapter } from '@helios/core/modules/staff/components/detail/notesAdapter'
import { createStaffActivitiesAdapter } from '@helios/core/modules/staff/components/detail/activitiesAdapter'
import { createStaffAddressAdapter, createStaffAddressTypesAdapter } from '@helios/core/modules/staff/components/detail/addressesAdapter'
import { MarkdownContent } from '@helios/ui/backend/markdown/MarkdownContent'
import {
  createStaffDictionaryEntry,
  loadStaffDictionary,
  type DictionaryEntryOption,
} from '@helios/core/modules/staff/components/detail/dictionaries'
import { JobHistorySection } from '@helios/core/modules/staff/components/detail/JobHistorySection'
import type { DictionarySelectLabels } from '@helios/core/modules/dictionaries/components/DictionaryEntrySelect'
import { Plus } from 'lucide-react'
import { TranslationDrawerAction } from '@helios/core/modules/translations/components/TranslationDrawerAction'
