...
import { StaffTimeEntry, StaffTimeEntrySegment } from '@helios/core/modules/staff/data/entities'
...
jest.mock('@helios/core/modules/staff/lib/staffMemberResolver', () => ({
  getStaffMemberByUserId: jest.fn((...args: unknown[]) => mockGetStaffMemberByUserId(...args)),
}))

jest.mock('@helios/core/modules/staff/api/guards', () => ({
...
jest.mock('@helios/core/modules/staff/events', () => ({
  emitStaffEvent: jest.fn((...args: unknown[]) => mockEmitStaffEvent(...args)),
}))

jest.mock('@helios/shared/lib/api/scoped', () => ({
