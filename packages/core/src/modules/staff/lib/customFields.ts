...
import type { FieldSetInput } from '@helios/core/modules/entities/lib/field-definitions'
...
export const STAFF_TEAM_MEMBER_CUSTHELIOS_FIELDS: CustomFieldDefinition[] = [
...
export const STAFF_TEAM_MEMBER_ACTIVITY_CUSTHELIOS_FIELDS: CustomFieldDefinition[] = [
...
export const STAFF_TEAM_MEMBER_CUSTHELIOS_FIELD_SETS: FieldSetInput[] = [
  defineFields(E.staff.staff_team_member, STAFF_TEAM_MEMBER_CUSTHELIOS_FIELDS, 'staff'),
]

export const STAFF_TEAM_MEMBER_ACTIVITY_CUSTHELIOS_FIELD_SETS: FieldSetInput[] = [
  defineFields(E.staff.staff_team_member_activity, STAFF_TEAM_MEMBER_ACTIVITY_CUSTHELIOS_FIELDS, 'staff'),
]
