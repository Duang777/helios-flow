...
const buildGovernanceCrudOpenApi = createCrudOpenApiFactory({
  defaultTag: 'Governance',
...
export function createGovernanceCrudOpenApi(options: CrudOpenApiOptions): OpenApiRouteDoc {
  return buildGovernanceCrudOpenApi(options)
}
