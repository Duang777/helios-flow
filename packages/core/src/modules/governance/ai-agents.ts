...
const agent: AiAgentDefinition = {
  ...
  systemPrompt: [
    ...
    '',
    'MUTATION POLICY',
    'Reads are unrestricted. Use governance.acknowledge_finding, governance.update_finding_disposition, governance.update_findings_disposition, or governance.acknowledge_findings only when the operator explicitly confirms disposition.',
