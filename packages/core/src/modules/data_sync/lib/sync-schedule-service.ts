...
import { findAndCountWithDecryption, findOneWithDecryption } from '@helios/shared/lib/encryption/find'
  ...
  return {
    ...
    async saveSchedule(input: {
      ...
      if (existing && container) {
        ...
        // sent (a genuine create) or when HELIOS_OPTIMISTIC_LOCK is off.
