...
import { metadata, POST } from '@helios/core/modules/inbox_ops/api/proposals/[id]/translate/route'
...
jest.mock('@helios/core/modules/inbox_ops/lib/translationProvider', () => ({
