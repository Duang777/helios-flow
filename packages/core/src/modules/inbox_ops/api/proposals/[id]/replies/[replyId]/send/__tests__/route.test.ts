...
import { POST } from '@helios/core/modules/inbox_ops/api/proposals/[id]/replies/[replyId]/send/route'
import { InboxProposal, InboxProposalAction, InboxEmail } from '@helios/core/modules/inbox_ops/data/entities'
...
describe('POST /api/inbox_ops/proposals/[id]/replies/[replyId]/send', () => {
  ...
  it('returns 503 when email delivery is disabled and messages module unavailable', async () => {
    setupHappyPath()
    process.env.HELIOS_DISABLE_EMAIL_DELIVERY = 'true'
    ...
    delete process.env.HELIOS_DISABLE_EMAIL_DELIVERY
  })
