...
import { GET } from '@helios/core/modules/inbox_ops/api/proposals/route'
import { InboxProposal, InboxEmail, InboxProposalAction, InboxDiscrepancy } from '@helios/core/modules/inbox_ops/data/entities'
...
jest.mock('@helios/shared/lib/db/escapeLikePattern', () => ({
