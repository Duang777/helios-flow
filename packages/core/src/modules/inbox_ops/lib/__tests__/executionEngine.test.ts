...
jest.mock('@/.helios/generated/inbox-actions.generated', () => {
  // eslint-disable-next-line @typescript-eslint/no-require-imports
  const sales = require('@helios/core/modules/sales/inbox-actions')
  // eslint-disable-next-line @typescript-eslint/no-require-imports
  const customers = require('@helios/core/modules/customers/inbox-actions')
  // eslint-disable-next-line @typescript-eslint/no-require-imports
  const catalog = require('@helios/core/modules/catalog/inbox-actions')
  const allActions = [
