...
import type { InboxActionExecutionContext } from '@helios/shared/modules/inbox-actions'
...
async function executeByType(
  ...
  const { getInboxAction } = await import('@/.helios/generated/inbox-actions.generated')
