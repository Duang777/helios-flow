...
} from '@helios/core/modules/dictionaries/data/validators'
import { ensureDictionaryEntryScope } from '@helios/core/modules/dictionaries/commands/factory'
import { registerCommand, type CommandHandler } from '@helios/shared/lib/commands'
...
import { emitCrudSideEffects, emitCrudUndoSideEffects } from '@helios/shared/lib/commands/helpers'
