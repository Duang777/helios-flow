...
const seedGuardRules: ModuleCli = {
  ...
  async run(rest: string[]) {
    ...
    if (!tenantId || !organizationId) {
      console.error('Usage: helios business_rules seed-guard-rules --tenant <tenantId> --org <organizationId>')
      console.error('   or: helios business_rules seed-guard-rules -t <tenantId> -o <organizationId>')
      return
    }
