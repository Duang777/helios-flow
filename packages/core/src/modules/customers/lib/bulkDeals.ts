...
import { createModuleQueue, type Queue } from '@helios/queue'
...
// their generated loader was registered into the SAME `@helios/shared` instance
...
// to different `@helios/shared` instances, leaving the lazy loader unreachable
