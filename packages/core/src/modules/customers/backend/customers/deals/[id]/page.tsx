...
import { AttachmentsSection, ErrorMessage, LoadingMessage, NotesSection, RecordNotFoundState } from '@helios/ui/backend/detail'
...
import { CollapsibleZoneLayout } from '@helios/ui/backend/crud/CollapsibleZoneLayout'
