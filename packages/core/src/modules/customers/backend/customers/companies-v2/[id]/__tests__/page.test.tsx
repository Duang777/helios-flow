...
jest.mock('@helios/ui/backend/injection/InjectionSpot', () => ({
  InjectionSpot: () => null,
...
jest.mock('@helios/ui/backend/crud/CollapsibleZoneLayout', () => ({
...
describe('CompanyDetailV2Page schedule dialog state', () => {
  ...
  it('sends the optimistic-lock header on company delete (PR #2055 QA)', async () => {
    ...
    const deleteCrudMock = jest.requireMock('@helios/ui/backend/utils/crud').deleteCrud as jest.Mock
