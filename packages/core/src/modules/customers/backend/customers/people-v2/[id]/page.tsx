...
import { CollapsibleZoneLayout, type ZoneSectionDescriptor } from '@helios/ui/backend/crud/CollapsibleZoneLayout'
import { useIsMobile } from '@helios/ui/hooks/useIsMobile'
import { updateCrud, deleteCrud } from '@helios/ui/backend/utils/crud'
import { apiCallOrThrow } from '@helios/ui/backend/utils/apiCall'
...
import { AttachmentsSection, ErrorMessage, LoadingMessage, RecordNotFoundState, type SectionAction } from '@helios/ui/backend/detail'
...
import type { TagsSectionController } from '@helios/ui/backend/detail'
import {
