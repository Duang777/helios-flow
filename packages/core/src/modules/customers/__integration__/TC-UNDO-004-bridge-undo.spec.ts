 ...
 * log entry, so they exposed NO undo affordance (no x-helios-operation header). They
 * must now emit the x-helios-operation undo token (while still carrying their
