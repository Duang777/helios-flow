...
import type { OptimisticLockCurrentReader } from '@helios/shared/lib/crud/optimistic-lock'
import { registerOptimisticLockReaders } from '@helios/shared/lib/crud/optimistic-lock-store'
...
// guard's mode check short-circuits when `HELIOS_OPTIMISTIC_LOCK=off`.
