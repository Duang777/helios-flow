 ...
 * objects so jest can load it without pulling `@helios/ai-assistant`
 ...
 * subset of `AiToolDefinition` from `@helios/ai-assistant`; the
 ...
 * `AiToolLoadBeforeSingleRecord` from `@helios/ai-assistant/lib/types`;
...
export interface CustomersAiToolDefinition<TInput = unknown, TOutput = unknown> {
   ...
   * `@helios/ai-assistant` framework `AiToolDefinition.isDestructive`
