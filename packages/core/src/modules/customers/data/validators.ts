...
import { COORDINATE_RANGES } from '@helios/shared/lib/location/coordinates'
import { dictionaryEntrySortModeSchema } from '@helios/core/modules/dictionaries/lib/entrySort'
...
const dictionaryKindEnum = z.string().trim().refine(
  (value) =>
    ...
    CUSTHELIOS_DICTIONARY_KIND_PATTERN.test(value),
