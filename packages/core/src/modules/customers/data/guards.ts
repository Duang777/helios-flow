...
import type { MutationGuard } from '@helios/shared/lib/crud/mutation-guard-registry'
import { createRequestContainer } from '@helios/shared/lib/di/container'
import { parseOptimisticLockEnv } from '@helios/shared/lib/crud/optimistic-lock'
 ...
 */
const RECORD_LOCK_RESOLUTION_HEADER_NAME = 'x-helios-record-lock-resolution'
