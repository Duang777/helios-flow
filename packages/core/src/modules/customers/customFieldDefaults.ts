import { cf } from '@helios/shared/modules/dsl'
import type { CustomFieldSet } from '@helios/shared/modules/entities'
import { E as CoreEntities } from '#generated/entities.ids.generated'

export const CUSTOMER_PERSON_CUSTHELIOS_FIELDS = [
...
export const CUSTOMER_COMPANY_CUSTHELIOS_FIELDS = [
...
export const CUSTOMER_DEAL_CUSTHELIOS_FIELDS = [
...
export const CUSTOMER_ACTIVITY_CUSTHELIOS_FIELDS = [
...
export const CUSTOMER_CUSTHELIOS_FIELD_SETS: CustomFieldSet[] = [
  {
    entity: CoreEntities.customers.customer_person_profile,
    fields: CUSTOMER_PERSON_CUSTHELIOS_FIELDS,
  },
  {
    entity: CoreEntities.customers.customer_company_profile,
    fields: CUSTOMER_COMPANY_CUSTHELIOS_FIELDS,
  },
  {
    entity: CoreEntities.customers.customer_deal,
    fields: CUSTOMER_DEAL_CUSTHELIOS_FIELDS,
  },
  {
    entity: CoreEntities.customers.customer_activity,
    fields: CUSTOMER_ACTIVITY_CUSTHELIOS_FIELDS,
  },
  {
