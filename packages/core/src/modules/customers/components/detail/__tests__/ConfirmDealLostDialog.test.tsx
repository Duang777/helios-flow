...
import { loadDictionaryEntriesByKey } from '@helios/core/modules/dictionaries/lib/clientEntries'

jest.mock('@helios/core/modules/dictionaries/lib/clientEntries', () => ({
...
jest.mock('@helios/ui/primitives/alert', () => ({
