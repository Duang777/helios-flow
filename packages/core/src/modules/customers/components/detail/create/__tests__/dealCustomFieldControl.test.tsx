...
jest.mock('@helios/ui/primitives/checkbox', () => {
  const React = require('react')
  return {
...
jest.mock('@helios/ui/primitives/checkbox-field', () => {
  const React = require('react')
  return {
...
jest.mock('@helios/ui/primitives/date-picker', () => {
  const React = require('react')
  return {
...
jest.mock('@helios/ui/primitives/tag-input', () => {
  const React = require('react')
  return {
