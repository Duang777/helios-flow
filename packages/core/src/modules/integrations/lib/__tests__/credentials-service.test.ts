...
import { decryptWithAesGcm, encryptWithAesGcm, generateDek } from '@helios/shared/lib/encryption/aes'
...
describe('integration credentials service encryption', () => {
  ...
  it('source file no longer contains the hardcoded emergency fallback literal', () => {
    ...
    expect(source).not.toContain('helios-emergency-fallback-rotate-me')
  })
})
