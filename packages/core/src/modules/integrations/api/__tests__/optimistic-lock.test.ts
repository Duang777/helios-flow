...
import { getIntegration } from '@helios/shared/modules/integrations/types'
import {
...
jest.mock('@helios/shared/modules/integrations/types', () => ({
  ...jest.requireActual('@helios/shared/modules/integrations/types'),
