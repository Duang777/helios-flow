...
import { runApiInterceptorsAfter, runApiInterceptorsBefore } from '@helios/shared/lib/crud/interceptor-runner'
import { applyResponseEnrichers, applyResponseEnricherToRecord } from '@helios/shared/lib/crud/enricher-runner'

jest.mock('@helios/shared/lib/crud/interceptor-runner', () => ({
  runApiInterceptorsBefore: jest.fn(),
  runApiInterceptorsAfter: jest.fn(),
}))

jest.mock('@helios/shared/lib/crud/enricher-runner', () => ({
