...
import { OPTIMISTIC_LOCK_CONFLICT_CODE } from '@helios/shared/lib/crud/optimistic-lock-headers'
...
jest.mock('@helios/ui/backend/utils/apiCall', () => {
  const actual = jest.requireActual('@helios/ui/backend/utils/apiCall')
  return {
    ...actual,
...
jest.mock('@helios/ui/backend/custom-fields/FieldDefinitionsManager', () => {
...
jest.mock('@helios/ui/backend/utils/customFieldForms', () => ({
  __esModule: true,
...
import { dismissRecordConflict, getRecordConflictForTest } from '@helios/ui/backend/conflicts'
