import { type IntegrationDefinition, LEGACY_INTEGRATION_DETAIL_TABS_SPOT_ID } from '@helios/shared/modules/integrations/types'
import type { LoadedInjectionSpotWidget } from '@helios/ui/backend/injection/InjectionSpot'
