...
jest.mock('@helios/shared/lib/commands/flush', () => ({
...
jest.mock('@helios/core/modules/directory/lib/hierarchy', () => {
  const actual = jest.requireActual('@helios/core/modules/directory/lib/hierarchy')
  return {
    ...actual,
...
jest.mock('@helios/shared/lib/commands/helpers', () => {
  const actual = jest.requireActual('@helios/shared/lib/commands/helpers')
  return {
    ...actual,
...
import '@helios/core/modules/directory/commands/organizations'
