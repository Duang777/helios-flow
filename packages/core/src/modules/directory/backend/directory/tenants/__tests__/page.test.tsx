...
jest.mock('@helios/shared/lib/i18n/context', () => ({
  ...jest.requireActual('@helios/shared/lib/i18n/context'),
  useT: () => mockTranslate,
}))
...
jest.mock('@helios/ui/backend/filters/ListEmptyState', () => ({
  ListEmptyState: () => null,
}))
...
const { readApiResultOrThrow } = jest.requireMock('@helios/ui/backend/utils/apiCall') as {
