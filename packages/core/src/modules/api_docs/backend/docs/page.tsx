import { getApiDocsResources, resolveApiDocsBaseUrl } from '@helios/core/modules/api_docs/lib/resources'
    ...
    <div className="space-y-8">
      <div className="space-y-2">
        ...
        <p className="text-sm text-muted-foreground max-w-3xl">
          Use the links below to explore the Helios platform APIs. The OpenAPI exports are generated from the current module registry.
        </p>
      </div>
