...
import { DictionarySelectControl } from '@helios/core/modules/dictionaries/components/DictionarySelectControl'
import { AppearanceSelector } from '@helios/core/modules/dictionaries/components/AppearanceSelector'
import { AttachmentsSection, TagsSection, type TagOption, type TagsSectionLabels } from '@helios/ui/backend/detail'
...
import { RESOURCES_CAPACITY_UNIT_DICTIONARY_KEY } from '@helios/core/modules/resources/lib/capacityUnits'
import { RESOURCES_RESOURCE_FIELDSET_DEFAULT, resolveResourcesResourceFieldsetCode } from '@helios/core/modules/resources/lib/resourceCustomFields'
