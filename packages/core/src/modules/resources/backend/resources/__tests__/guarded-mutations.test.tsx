...
jest.mock('@helios/shared/lib/i18n/translate', () => ({
...
jest.mock('@helios/ui/backend/forms', () => ({
...
jest.mock('@helios/ui/backend/utils/optimisticLock', () => ({
  buildOptimisticLockHeader: (updatedAt?: string | null) =>
    updatedAt ? { 'x-helios-ext-optimistic-lock-expected-updated-at': updatedAt } : {},
}))
...
jest.mock('@helios/ui/backend/version-history', () => ({
...
jest.mock('@helios/core/modules/resources/components/detail/dictionaries', () => ({
...
jest.mock('@helios/core/modules/planner/components/AvailabilityRulesEditor', () => ({
...
jest.mock('@helios/core/modules/resources/components/ResourceCrudForm', () => ({
