...
jest.mock('@helios/core/modules/directory/utils/organizationScopeFilter', () => ({
...
describe('Workflow Definition customize/reset event emissions', () => {
  ...
  beforeEach(() => {
    ...
    const { createRequestContainer } = require('@helios/shared/lib/di/container')
    createRequestContainer.mockResolvedValue(mockContainer)

    const { getAuthFromRequest } = require('@helios/shared/lib/auth/server')
    ...
    } = require('@helios/core/modules/directory/utils/organizationScope')
