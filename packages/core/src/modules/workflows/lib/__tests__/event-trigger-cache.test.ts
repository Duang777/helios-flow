 ...
 * `__heliosWorkflowTriggerCache__`, mirroring the workaround already used
 ...
 *   1. Asserting `globalThis.__heliosWorkflowTriggerCache__` exists as a
...
const GLOBAL_KEY = '__heliosWorkflowTriggerCache__'
