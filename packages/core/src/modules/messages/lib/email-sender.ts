...
import { resolveDefaultEmailFromAddress } from '@helios/shared/lib/email/config'
...
async function buildEmailCopy(sentAt: Date) {
  ...
  return {
    preview: t('messages.email.preview', 'You received a message in Helios'),
    ...
    footer: t('messages.email.footer', 'Helios messages'),
  }
}
