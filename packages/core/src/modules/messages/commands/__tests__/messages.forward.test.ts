import '@helios/core/modules/messages/commands/messages'
import { commandRegistry } from '@helios/shared/lib/commands/registry'
import { Message, MessageObject, MessageRecipient } from '@helios/core/modules/messages/data/entities'
...
jest.mock('@helios/core/modules/messages/events', () => ({
  emitMessagesEvent: (...args: unknown[]) => emitMessagesEventMock(...args),
}))

jest.mock('@helios/core/modules/messages/lib/forwarding', () => ({
...
jest.mock('@helios/core/modules/messages/lib/attachments', () => ({
