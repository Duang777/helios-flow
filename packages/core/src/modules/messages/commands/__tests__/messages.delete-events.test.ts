import { Message, MessageRecipient } from '@helios/core/modules/messages/data/entities'
...
jest.mock('@helios/shared/lib/commands/undo', () => ({
...
describe('messages.message.deleted event audience', () => {
  beforeAll(() => {
    require('@helios/core/modules/messages/commands/messages')
  })
