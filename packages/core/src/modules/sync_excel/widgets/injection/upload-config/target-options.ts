...
export const SYNC_EXCEL_PEOPLE_CUSTHELIOS_FIELD_ENTITY_IDS = [
...
function selectPreferredCustomFieldDefs(customFieldDefs: CustomFieldDefDto[]): CustomFieldDefDto[] {
  ...
  SYNC_EXCEL_PEOPLE_CUSTHELIOS_FIELD_ENTITY_IDS.forEach((entityId, index) => entityOrder.set(entityId, index))
