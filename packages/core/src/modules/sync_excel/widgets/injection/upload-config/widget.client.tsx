...
import { Table, TableBody, TableCell, TableHead, TableHeader, TableRow } from '@helios/ui/primitives/table'
...
import {
  ...
  SYNC_EXCEL_PEOPLE_CUSTHELIOS_FIELD_ENTITY_IDS,
...
export default function SyncExcelUploadConfigWidget({
  ...
  const t = useT()
  const { data: customFieldDefs = [] } = useCustomFieldDefs([...SYNC_EXCEL_PEOPLE_CUSTHELIOS_FIELD_ENTITY_IDS])
