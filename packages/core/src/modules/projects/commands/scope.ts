...
type ProjectsCommandScopedRecord = {
  organizationId: string
  tenantId: string
}

export function buildProjectsCommandWhere<T extends object>(
...
export function ensureProjectsCommandScope(
  ctx: CommandRuntimeContext,
  record: ProjectsCommandScopedRecord,
): void {
