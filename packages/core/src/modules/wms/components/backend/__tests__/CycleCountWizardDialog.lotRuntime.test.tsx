...
jest.mock('@helios/ui/backend/inputs/DateTimePicker', () => ({
  DateTimePicker: ({
    value,
    onChange,
    placeholder,
...
jest.mock('@helios/ui/backend/inputs/ComboboxInput', () => {
  const RealModule = jest.requireActual('@helios/ui/backend/inputs/ComboboxInput')
  return {
