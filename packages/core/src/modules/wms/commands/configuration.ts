...
// this file follow the standard Helios undoable pattern: each handler
...
import { CrudHttpError, isUniqueViolation } from '@helios/shared/lib/crud/errors'
...
import type { JsonValue } from '@helios/shared/lib/json'
import {
  InventoryLot,
