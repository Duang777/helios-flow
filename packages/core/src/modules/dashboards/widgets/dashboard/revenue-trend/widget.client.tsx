...
import { useWidgetData, type WidgetDataFetcher } from '@helios/ui/backend/dashboard/widgetData'
import { useT, useLocale } from '@helios/shared/lib/i18n/context'
import { LineChart, type LineChartDataItem } from '@helios/ui/backend/charts'
import {
  DateRangeSelect,
...
import type { DateGranularity } from '@helios/shared/modules/analytics'
