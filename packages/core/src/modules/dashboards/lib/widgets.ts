import type { Module, ModuleDashboardWidgetEntry } from '@helios/shared/modules/registry'
import type { DashboardWidgetMetadata, DashboardWidgetModule } from '@helios/shared/modules/dashboard/widgets'
import { applyDashboardWidgetOverridesToEntries } from '@helios/shared/modules/overrides'
