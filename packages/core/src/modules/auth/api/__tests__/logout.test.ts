...
jest.mock('@helios/core/modules/auth/lib/requestRedirect', () => {
...
import * as logoutRoute from '@helios/core/modules/auth/api/logout'
import { POST } from '@helios/core/modules/auth/api/logout'
