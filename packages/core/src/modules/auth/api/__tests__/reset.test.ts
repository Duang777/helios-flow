import { POST } from '@helios/core/modules/auth/api/reset'
...
jest.mock('@helios/core/modules/auth/emails/ResetPasswordEmail', () => ({
  __esModule: true,
...
jest.mock('@helios/core/modules/auth/notifications', () => ({
  __esModule: true,
  default: [],
}))
