...
import { Role, User } from '@helios/core/modules/auth/data/entities'
...
jest.mock('@helios/shared/lib/crud/factory', () => ({
...
jest.mock('@helios/shared/lib/crud/custom-fields', () => ({
...
jest.mock('@helios/core/modules/auth/lib/consentIntegrity', () => ({
  verifyConsentIntegrityHash: jest.fn(() => true),
}))

// Imported after mocks are registered.
import { PUT as usersPut, DELETE as usersDelete } from '@helios/core/modules/auth/api/users/route'
import { GET as usersAclGet, PUT as usersAclPut } from '@helios/core/modules/auth/api/users/acl/route'
import { GET as consentsGet } from '@helios/core/modules/auth/api/users/consents/route'
import { POST as createRolePost, PUT as rolesPut, DELETE as rolesDelete } from '@helios/core/modules/auth/api/roles/route'
