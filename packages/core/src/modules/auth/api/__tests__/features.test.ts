...
import { GET } from '@helios/core/modules/auth/api/features'
...
jest.mock('@helios/core/modules/entities/lib/restrictedEntityFeatures', () => ({
...
import { synthesizeRestrictedEntityFeatures } from '@helios/core/modules/entities/lib/restrictedEntityFeatures'
