import { POST } from '@helios/core/modules/auth/api/users/resend-invite/route'
...
jest.mock('@helios/core/modules/auth/emails/InviteUserEmail', () => ({
  __esModule: true,
...
jest.mock('@helios/shared/lib/http/readJsonSafe', () => ({
...
jest.mock('@helios/shared/lib/ratelimit/config', () => ({
