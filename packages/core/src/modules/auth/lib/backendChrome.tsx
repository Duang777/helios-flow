...
import type { BackendRouteManifestEntry } from '@helios/shared/modules/registry'
import type {
...
} from '@helios/shared/modules/navigation/backendChrome'
import {
  buildAdminNav,
  ...
  type AdminNavItem,
} from '@helios/ui/backend/utils/nav'
import { resolveRegisteredLucideIconNode } from '@helios/ui/backend/icons/lucideRegistry'
...
import { filterGrantsByEnabledModules } from '@helios/shared/security/enabledModulesRegistry'
import {
  getSelectedOrganizationFromRequest,
  resolveFeatureCheckContext,
} from '@helios/core/modules/directory/utils/organizationScope'
import { isAllOrganizationsSelection } from '@helios/core/modules/directory/constants'
import { Organization } from '@helios/core/modules/directory/data/entities'
import { CustomEntity } from '@helios/core/modules/entities/data/entities'
import { Role } from '@helios/core/modules/auth/data/entities'
import { findOneWithDecryption } from '@helios/shared/lib/encryption/find'
import {
  applySidebarPreference,
  loadFirstRoleSidebarPreference,
  loadSidebarPreference,
} from '@helios/core/modules/auth/services/sidebarPreferencesService'
import type { SidebarPreferencesSettings } from '@helios/shared/modules/navigation/sidebarPreferences'
