import type { QueryEngine, QueryOptions, QueryResult, QueryResultMeta, EncryptedSortRowCapWarning, FilterOp, Filter, QueryCustomFieldSource, PartialIndexWarning, QueryExtensionsConfig, Sort } from '@helios/shared/lib/query/types'
import { SortDir } from '@helios/shared/lib/query/types'
import type { EntityId } from '@helios/shared/modules/entities'
import type { EntityManager } from '@mikro-orm/postgresql'
import { BasicQueryEngine, resolveEntityTableName, resolveRegisteredEntityTableName } from '@helios/shared/lib/query/engine'
import { isOrmBackedSystemEntityId } from '@helios/shared/lib/data/engine'
...
import { createProfiler, shouldEnableProfiler, type Profiler } from '@helios/shared/lib/profiler'
import type { VectorIndexService } from '@helios/search/vector'
import { decryptIndexDocCustomFields } from '@helios/shared/lib/encryption/indexDoc'
...
import {
  ...
  type BaseFilter,
  type ResolvedJoin,
} from '@helios/shared/lib/query/join-utils'
import { resolveSearchConfig, type SearchConfig } from '@helios/shared/lib/search/config'
import { tokenizeText } from '@helios/shared/lib/search/tokenize'
import { runBeforeQueryPipeline, runAfterQueryPipeline, type QueryExtensionContext } from '@helios/shared/lib/query/query-extension-runner'
import { resolveEncryptedSortFields, resolveEncryptedSortMaxRows, sortRowsInMemory } from '@helios/shared/lib/query/encrypted-sort'
import { mapWithConcurrency } from '@helios/shared/lib/query/bounded-decrypt'
...
function resolveDebugVerbosity(): boolean {
  const queryIndexDebug = process.env.HELIOS_QUERY_INDEX_DEBUG
