...
import { POST } from '@helios/core/modules/payment_gateways/api/webhook/[provider]/route'
import { findWithDecryption } from '@helios/shared/lib/encryption/find'
import { getWebhookHandler } from '@helios/shared/modules/payment_gateways/types'
import { getPaymentGatewayQueue } from '@helios/core/modules/payment_gateways/lib/queue'
import { processPaymentGatewayWebhookJob } from '@helios/core/modules/payment_gateways/lib/webhook-processor'
...
jest.mock('@helios/shared/modules/payment_gateways/types', () => ({
  getWebhookHandler: jest.fn(),
}))

jest.mock('@helios/core/modules/payment_gateways/lib/queue', () => ({
  getPaymentGatewayQueue: jest.fn(),
}))

jest.mock('@helios/core/modules/payment_gateways/lib/webhook-processor', () => ({
