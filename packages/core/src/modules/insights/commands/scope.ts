...
type InsightsCommandScopedRecord = {
  organizationId: string
  tenantId: string
}

export function buildInsightsCommandWhere<T extends object>(
...
export function ensureInsightsCommandScope(
  ctx: CommandRuntimeContext,
  record: InsightsCommandScopedRecord,
): void {
