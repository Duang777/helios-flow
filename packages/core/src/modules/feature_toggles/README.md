...
- `yarn helios feature_toggles seed-defaults`: Load default toggles from a JSON file.
- `yarn helios feature_toggles toggle-create`: Create a new global toggle.
  - Usage: `... --identifier <id> --name <name> --type <type> --defaultValue <value>`
- `yarn helios feature_toggles toggle-update`: Update an existing toggle.
- `yarn helios feature_toggles toggle-delete`: Delete a toggle.
- `yarn helios feature_toggles override-set`: Set or update an override for a tenant.
