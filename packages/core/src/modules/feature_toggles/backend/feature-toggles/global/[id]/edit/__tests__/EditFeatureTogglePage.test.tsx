...
jest.mock('@helios/core/modules/feature_toggles/components/formConfig', () => ({
  createFieldDefinitions: () => [],
  createFormGroups: () => [],
}))

jest.mock('@helios/core/modules/feature_toggles/components/hooks/useFeatureToggleItem', () => ({
