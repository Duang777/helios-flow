...
import { z } from 'zod'
import { ScheduleView, type ScheduleItem, type ScheduleRange, type ScheduleSlot, type ScheduleViewMode } from '@helios/ui/backend/schedule'
...
import { apiCall, apiCallOrThrow, withScopedApiRequestHeaders } from '@helios/ui/backend/utils/apiCall'
import { createCrud, deleteCrud, updateCrud } from '@helios/ui/backend/utils/crud'
...
import { ComboboxInput, TimePicker } from '@helios/ui/backend/inputs'
import { DictionaryEntrySelect, type DictionarySelectLabels } from '@helios/core/modules/dictionaries/components/DictionaryEntrySelect'
import {
  createUnavailabilityReasonEntry,
  loadUnavailabilityReasonEntries,
  type UnavailabilityReasonEntry,
} from '@helios/core/modules/planner/components/unavailabilityReasons'
import { useT } from '@helios/shared/lib/i18n/context'
import { useConfirmDialog } from '@helios/ui/backend/confirm-dialog'
import { normalizeCrudServerError } from '@helios/ui/backend/utils/serverErrors'
import { parseAvailabilityRuleWindow } from '@helios/core/modules/planner/lib/availabilitySchedule'
import { deleteAvailabilityRuleSet } from '@helios/core/modules/planner/lib/deleteAvailabilityRuleSet'
