...
import type { MutationGuard, MutationGuardInput } from '@helios/shared/lib/crud/mutation-guard-registry'
...
const { guards } = require('@helios/core/modules/customer_accounts/data/guards') as {
