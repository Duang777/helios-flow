...
import { deleteGeneralEntityIfExists, expectId, readJsonSafe } from '@helios/core/helpers/integration/generalFixtures';
import { createCompanyFixture, createPersonFixture } from '@helios/core/helpers/integration/crmFixtures';
import {
  assertScalarFieldsPersisted,
  skipIfCrudFormExtensionTestsDisabled,
  type CrudRecord,
} from '@helios/core/helpers/integration/crudFormPersistence';
 ...
 *
 * Gated by `HELIOS_INTEGRATION_CRUDFORM_EXTENSION_TESTS_DISABLED` (default off → runs).
 */
