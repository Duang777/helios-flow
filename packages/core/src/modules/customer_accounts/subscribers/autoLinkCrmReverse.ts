...
export default async function handle(
  ...
  try {
    const { CustomerEntity } = await import('@helios/core/modules/customers/data/entities')
    ...
    if (!entity) {
      const { CustomerPersonProfile } = await import('@helios/core/modules/customers/data/entities')
