import { POST } from '@helios/core/modules/customer_accounts/api/signup'
...
jest.mock('@helios/shared/lib/ratelimit/helpers', () => ({
  rateLimitErrorSchema: {},
}))

jest.mock('@helios/core/modules/customer_accounts/lib/rateLimiter', () => ({
...
jest.mock('@helios/core/modules/customer_accounts/emails/CustomerSignupVerificationEmail', () => ({
  __esModule: true,
  default: jest.fn(() => '<verification-email />'),
}))

jest.mock('@helios/core/modules/customer_accounts/emails/CustomerExistingAccountEmail', () => ({
  __esModule: true,
