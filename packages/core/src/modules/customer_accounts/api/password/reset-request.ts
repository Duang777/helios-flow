...
import { passwordResetRequestSchema } from '@helios/core/modules/customer_accounts/data/validators'
import {
...
export async function POST(req: Request) {
  ...
  if (user) {
    ...
    void import('@helios/core/modules/customer_accounts/events').then(({ emitCustomerAccountsEvent }) =>
