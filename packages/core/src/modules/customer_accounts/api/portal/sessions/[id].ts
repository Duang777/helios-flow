...
import { getCustomerAuthFromRequest, readCookieFromHeader } from '@helios/core/modules/customer_accounts/lib/customerAuth'
...
import { CustomerUserSession } from '@helios/core/modules/customer_accounts/data/entities'
import { hashToken } from '@helios/core/modules/customer_accounts/lib/tokenGenerator'
