...
import { getCustomerAuthFromRequest } from '@helios/core/modules/customer_accounts/lib/customerAuth'
...
import { passwordChangeSchema } from '@helios/core/modules/customer_accounts/data/validators'
