...
import { z } from 'zod'
import type { OpenApiRouteDoc, OpenApiMethodDoc } from '@helios/shared/lib/openapi'
import { resolveTranslations } from '@helios/shared/lib/i18n/server'
import { sendEmail } from '@helios/shared/lib/email/send'
import { signupSchema } from '@helios/core/modules/customer_accounts/data/validators'
import { createRequestContainer } from '@helios/shared/lib/di/container'
import { CustomerUserService } from '@helios/core/modules/customer_accounts/services/customerUserService'
import { CustomerTokenService } from '@helios/core/modules/customer_accounts/services/customerTokenService'
import { CustomerRole, CustomerUserRole } from '@helios/core/modules/customer_accounts/data/entities'
import { emitCustomerAccountsEvent } from '@helios/core/modules/customer_accounts/events'
import CustomerSignupVerificationEmail from '@helios/core/modules/customer_accounts/emails/CustomerSignupVerificationEmail'
import CustomerExistingAccountEmail from '@helios/core/modules/customer_accounts/emails/CustomerExistingAccountEmail'
import { rateLimitErrorSchema } from '@helios/shared/lib/ratelimit/helpers'
import {
  checkAuthRateLimit,
  customerSignupRateLimitConfig,
  customerSignupIpRateLimitConfig,
} from '@helios/core/modules/customer_accounts/lib/rateLimiter'
import { readNormalizedEmailFromJsonRequest } from '@helios/core/modules/customer_accounts/lib/rateLimitIdentifier'
import { findOrganizationInTenant } from '@helios/core/modules/customer_accounts/lib/organizationLookup'
import { getSecurityEmailBaseUrl, mapSecurityEmailUrlError } from '@helios/shared/lib/url'
import {
  resolveTenantContext,
  TenantResolutionError,
} from '@helios/core/modules/customer_accounts/lib/resolveTenantContext'
import { urlForCustomerOrg } from '@helios/core/modules/customer_accounts/lib/customerUrl'
