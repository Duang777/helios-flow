...
import { magicLinkVerifySchema } from '@helios/core/modules/customer_accounts/data/validators'
...
import { CustomerUser } from '@helios/core/modules/customer_accounts/data/entities'
