...
jest.mock('@helios/core/modules/customer_accounts/data/entities', () => ({
  CustomerRole: CustomerRoleStub,
  CustomerRoleAcl: CustomerRoleAclStub,
}))

jest.mock('@helios/core/modules/auth/services/rbacService', () => ({ RbacService: class {} }))
jest.mock('@helios/core/modules/customer_accounts/services/customerRbacService', () => ({ CustomerRbacService: class {} }))
