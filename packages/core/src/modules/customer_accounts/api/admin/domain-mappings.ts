...
import { registerDomainSchema } from '@helios/core/modules/customer_accounts/data/validators'
import {
  DomainMappingService,
  type ResolveResult,
} from '@helios/core/modules/customer_accounts/services/domainMappingService'
import { DomainMapping } from '@helios/core/modules/customer_accounts/data/entities'
...
function serializeRecord(record: DomainMapping) {
  return {
    ...
    cnameTarget: process.env.CUSTHELIOS_DOMAIN_CNAME_TARGET ?? null,
    aRecordTarget: process.env.CUSTHELIOS_DOMAIN_A_RECORD_TARGET ?? null,
