...
import {
  signAudienceJwt,
  signJwt,
} from '@helios/shared/lib/auth/jwt'
...
const { getCustomerAuthFromRequest } = require('@helios/core/modules/customer_accounts/lib/customerAuth') as typeof import('@helios/core/modules/customer_accounts/lib/customerAuth')
