import { DictionaryEntry } from '@helios/core/modules/dictionaries/data/entities'
import { registerDictionaryEntryCommands } from '@helios/core/modules/dictionaries/commands/factory'
