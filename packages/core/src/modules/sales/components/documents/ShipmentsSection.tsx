...
import { ErrorMessage, LoadingMessage, TabEmptyState } from '@helios/ui/backend/detail'
...
import type { SectionAction } from '@helios/core/modules/customers/components/detail/types'
import { generateTempId } from '@helios/core/modules/customers/lib/detailHelpers'
import { formatAddressString, type AddressValue } from '@helios/core/modules/customers/utils/addressFormat'
