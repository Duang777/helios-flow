...
import { LoadingMessage, TabEmptyState } from "@helios/ui/backend/detail";
...
} from "@helios/core/modules/dictionaries/components/dictionaryAppearance";
...
import { emitSalesDocumentTotalsRefresh } from "@helios/core/modules/sales/lib/frontend/documentTotalsEvents";
...
import type { SectionAction } from "@helios/ui/backend/detail";
import { extractCustomFieldValues } from "./customFieldHelpers";
import { canonicalizeUnitCode } from "@helios/shared/lib/units/unitCodes";
...
import type { InjectionColumnDefinition } from "@helios/shared/modules/widgets/injection";
