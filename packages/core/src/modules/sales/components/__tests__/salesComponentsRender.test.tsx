...
jest.mock('@helios/ui/backend/DataTable', () => ({
...
jest.mock('@helios/ui/backend/RowActions', () => ({
  RowActions: ({ children }: { children?: React.ReactNode }) => <div>{children}</div>,
}))

jest.mock('@helios/ui/backend/ValueIcons', () => ({
...
jest.mock('@helios/ui/backend/inputs', () => ({
...
jest.mock('@helios/ui/backend/utils/customFieldValues', () => ({
...
jest.mock('@helios/ui/primitives/label', () => ({
...
jest.mock('@helios/ui/primitives/textarea', () => ({
  Textarea: ({ children, ...props }: any) => <textarea {...props}>{children}</textarea>,
}))

jest.mock('@helios/ui/primitives/dialog', () => ({
...
jest.mock('@helios/ui/primitives/badge', () => ({
  Badge: ({ children }: any) => <span>{children}</span>,
}))

jest.mock('@helios/core/modules/dictionaries/components/AppearanceSelector', () => ({
  AppearanceSelector: () => <div>appearance</div>,
}))

jest.mock('@helios/core/modules/dictionaries/components/dictionaryAppearance', () => ({
  renderDictionaryColor: () => <span>color</span>,
  renderDictionaryIcon: () => <span>icon</span>,
  ICON_SUGGESTIONS: [],
}))

jest.mock('@helios/core/modules/dictionaries/components/DictionaryForm', () => ({
...
jest.mock('@helios/core/modules/dictionaries/components/DictionaryTable', () => ({
  DictionaryTable: ({ entries = [] }: any) => (
    <div data-testid="dictionary-table-count">{entries.length}</div>
  ),
}))

jest.mock('@helios/core/modules/dictionaries/components/DictionaryEntrySelect', () => ({
...
jest.mock('@helios/shared/lib/custom-fields/normalize', () => ({
  normalizeCustomFieldResponse: (input: any) => input,
}))

jest.mock('@helios/core/modules/sales/lib/frontend/documentTotalsEvents', () => ({
  emitSalesDocumentTotalsRefresh: jest.fn(),
}))

jest.mock('@helios/core/modules/customers/components/detail/hooks/useCurrencyDictionary', () => ({
