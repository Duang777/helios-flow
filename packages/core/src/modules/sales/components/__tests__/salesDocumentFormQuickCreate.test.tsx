...
jest.mock('@helios/ui/backend/FlashMessages', () => ({ flash: jest.fn() }))
jest.mock('@helios/ui/backend/inputs', () => ({
  LookupSelect: ({ actionSlot }: any) => <div>{actionSlot}</div>,
}))
jest.mock('@helios/ui/primitives/input', () => ({ Input: (props: any) => <input {...props} /> }))
jest.mock('@helios/ui/primitives/email-input', () => ({ EmailInput: (props: any) => <input {...props} /> }))
...
jest.mock('@helios/ui/primitives/switch-field', () => ({ SwitchField: () => <div /> }))
...
jest.mock('@helios/core/modules/customers/backend/hooks/useEmailDuplicateCheck', () => ({
  useEmailDuplicateCheck: () => ({ checking: false, duplicate: false, check: jest.fn() }),
}))
jest.mock('@helios/core/modules/customers/components/formConfig', () => ({
...
jest.mock('@helios/core/modules/customers/components/AddressEditor', () => ({ AddressEditor: () => <div /> }))
jest.mock('@helios/core/modules/customers/utils/addressFormat', () => ({ formatAddressString: () => '' }))
