...
import { createSalesOrderFixture } from '@helios/core/modules/core/__integration__/helpers/salesFixtures'
...
test('TC-SALES-2055-ADDRESS-UNDO: undoing an order address edit restores the prior address', async ({ request }) => {
  ...
  try {
    ...
    const operation = deserializeOperationMetadata(update.headers()['x-helios-operation'])
