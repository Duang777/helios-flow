...
import { createProductFixture, deleteCatalogProductIfExists } from '@helios/core/modules/core/__integration__/helpers/catalogFixtures'
import {
  bumpRecordViaApi,
 ...
 * `x-helios-ext-optimistic-lock-expected-updated-at` header triggers the 409 →
...
test.describe('TC-LOCK-OSS-029: sales channel offer edit + list-delete conflict bar (SAL-13)', () => {
  ...
  // The browser sends `x-helios-ext-optimistic-lock-expected-updated-at` and the
