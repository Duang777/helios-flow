...
import { createSalesQuoteFixture } from '@helios/core/modules/core/__integration__/helpers/salesFixtures'
import {
  bumpRecordViaApi,
  readUpdatedAt,
 ...
 * against the `x-helios-ext-optimistic-lock-expected-updated-at` header the client
