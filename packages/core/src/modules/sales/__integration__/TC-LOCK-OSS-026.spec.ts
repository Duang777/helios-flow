...
import { createSalesOrderFixture, createOrderLineFixture } from '@helios/core/modules/core/__integration__/helpers/salesFixtures'
...
test.describe('TC-LOCK-OSS-026: sales payments + shipments parent-order aggregate optimistic locking', () => {
  ...
  // box — no manual `yarn helios auth sync-role-acls`, no self-skip.
