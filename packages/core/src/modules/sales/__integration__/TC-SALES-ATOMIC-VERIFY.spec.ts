...
import { deleteSalesEntityIfExists } from '@helios/core/helpers/integration/salesFixtures'
 ...
 *  - Undo round-trip via x-helios-operation header + /api/audit_logs/audit-logs/actions/undo:
