...
import { resolveTranslations, detectLocale } from '@helios/shared/lib/i18n/server'
...
} from '@helios/shared/lib/crud/mutation-guard-registry'
...
export async function POST(req: Request) {
  try {
    ...
    const copy = {
      ...
      footer: translate('sales.quotes.email.footer', 'Helios'),
    }
