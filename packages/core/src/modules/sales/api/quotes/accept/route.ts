...
import { checkRateLimit, getClientIp, RATE_LIMIT_FALLBACK_KEY, rateLimitErrorSchema } from '@helios/shared/lib/ratelimit/helpers'
    ...
    if (adminEmail) {
      try {
        ...
        const copy = {
          ...
          footer: translate('sales.quotes.accept.adminEmail.footer', 'Helios'),
        }
