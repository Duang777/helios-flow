...
import { PUT as updateOrder } from '@helios/core/modules/sales/api/orders/route'
import { PUT as updateQuote } from '@helios/core/modules/sales/api/quotes/route'
...
describe('sales document update routes', () => {
  ...
  it('uses command bus for order updates and returns operation metadata', async () => {
    ...
    expect(res.headers.get('x-helios-operation')).toBeTruthy()
  })
