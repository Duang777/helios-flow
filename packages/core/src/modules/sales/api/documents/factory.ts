import { z } from 'zod'
import { makeCrudRoute, type CrudCtx } from '@helios/shared/lib/crud/factory'
import { splitCustomFieldPayload, extractAllCustomFieldEntries } from '@helios/shared/lib/crud/custom-fields'
...
import { buildIlikeTerm } from '@helios/shared/lib/db/buildIlikeTerm'
