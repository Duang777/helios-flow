...
import type { CommandBus, CommandHandler, CommandRuntimeContext } from '@helios/shared/lib/commands'
...
const ingestInboundMessageCommand: CommandHandler<IngestInboundMessageInput, IngestInboundMessageResult> = {
  ...
  async execute(rawInput, ctx) {
    ...
    const TRUNCATE_MARKER =
      '\n\n[…message truncated by Helios — full body preserved in ExternalMessage.rawPayload]'
