...
import { extractUndoPayload as extractSharedUndoPayload } from '@helios/shared/lib/commands/undo'
 ...
 * `@helios/shared/lib/commands/undo.ts` helper with a narrow-by-shape
