...
test.describe('TC-045D-004a: reactions module contract', () => {
  test('process_inbound_reaction command exports stable id + execute', async () => {
    const mod = await import(
      '@helios/core/modules/communication_channels/commands/process-inbound-reaction'
    )
  ...
  test('toggle_outbound_reaction command exports stable id + execute', async () => {
    const mod = await import(
      '@helios/core/modules/communication_channels/commands/toggle-outbound-reaction'
    )
  ...
  test('reaction worker exports canonical queue + concurrency + max-attempts', async () => {
    const mod = await import(
      '@helios/core/modules/communication_channels/workers/reaction-processor'
    )
    ...
    const types = await import(
      '@helios/core/modules/communication_channels/lib/reaction-processor-types'
    )
