...
jest.mock('@helios/core/modules/attachments/lib/partitions', () => ({
...
jest.mock('@helios/core/modules/attachments/lib/partitionEnv', () => ({
  resolvePartitionEnvKey: (_code: string) => null,
}))

jest.mock('@helios/core/modules/attachments/lib/ocrConfig', () => ({
...
async function loadHandlers() {
  return import('@helios/core/modules/attachments/api/partitions/route')
}
