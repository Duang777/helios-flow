...
jest.mock('@helios/core/modules/attachments/lib/storage', () => ({
...
import { StorageDriverFactory } from '@helios/core/modules/attachments/lib/drivers/driverFactory'
import { LocalStorageDriver } from '@helios/core/modules/attachments/lib/drivers/localDriver'
import { LegacyPublicStorageDriver } from '@helios/core/modules/attachments/lib/drivers/legacyPublicDriver'
import type { StorageDriver, StoreFilePayload, StoredFile, ReadFileResult } from '@helios/core/modules/attachments/lib/drivers/types'
