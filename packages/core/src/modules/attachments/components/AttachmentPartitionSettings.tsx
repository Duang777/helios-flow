...
import { resolvePartitionEnvKey } from '@helios/core/modules/attachments/lib/partitionEnv'
              ...
              {s3Unavailable ? (
                <p className="text-xs text-muted-foreground">
                  {t(
                    ...
                    'S3 is disabled. Set HELIOS_ENABLE_STORAGE_S3=true and restart to enable S3 partitions.',
                  )}
                </p>
              ) : null}
            </div>
                ...
                {form.s3CredentialsSource === 'env' && (
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      placeholder="HELIOS_INTEGRATION_STORAGE_S3"
                      className="font-mono"
                    />
                    <p className="text-xs text-muted-foreground">
                      {t(
            ...
            {s3SelectedWhileUnavailable ? (
              <p className="text-sm text-status-error-text">
                {t(
                  ...
                  'This partition uses S3, but S3 is disabled. Set HELIOS_ENABLE_STORAGE_S3=true and restart the app.',
                )}
              </p>
            ) : null}
