...
export default function CreateCostPage() {
    ...
    () => [
      {
        ...
        fields: [
          ...
          },
          {
            id: 'incurredOn',
            type: 'text',
            label: t('commercial.costs.form.field.incurredOn'),
            helpText: t('commercial.costs.form.field.dateHelp'),
          },
          {
            id: 'note',
            type: 'text',
  ...
  return (
    <Page>
      <PageBody>
        <CrudForm
          title={t('commercial.costs.create.title')}
          ...
          onSubmit={async (values) => {
            await createCrud('commercial/costs', {
              organizationId,
              tenantId,
            ...
            flash(t('commercial.costs.flash.created'), 'success')
            router.push(
              values.projectId
                ? `/backend/commercial/costs?projectId=${encodeURIComponent(String(values.projectId))}`
                : '/backend/commercial/costs',
            )
          }}
        />
      </PageBody>
