...
const buildCommercialCrudOpenApi = createCrudOpenApiFactory({
  defaultTag: 'Commercial',
...
export function createCommercialCrudOpenApi(options: CrudOpenApiOptions): OpenApiRouteDoc {
  return buildCommercialCrudOpenApi(options)
}
