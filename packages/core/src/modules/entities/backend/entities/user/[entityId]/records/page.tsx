...
import { filterCustomFieldDefs, useCustomFieldDefs } from '@helios/ui/backend/utils/customFieldDefs'
...
import { raiseCrudError } from '@helios/ui/backend/utils/serverErrors'
...
import { useRecordsEntityGuard } from '@helios/core/modules/entities/components/useRecordsEntityGuard'
      ...
      <PageBody>
        <ContextHelp bulb title="API: Manage Records via cURL" className="mb-4">
          <p className="mb-2">
            ...
            <a className="underline" target="_blank" rel="noreferrer" href="https://docs.helios.com/user-guide/api-keys">
              Managing API keys guide
            </a>{' '}
            or the{' '}
            <a className="underline" target="_blank" rel="noreferrer" href="https://docs.helios.com/cli/api-keys">
