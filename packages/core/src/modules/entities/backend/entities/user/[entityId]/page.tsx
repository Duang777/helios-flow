...
import { apiCall, readApiResultOrThrow, withScopedApiRequestHeaders } from '@helios/ui/backend/utils/apiCall'
...
import { invalidateCustomFieldDefs } from '@helios/ui/backend/utils/customFieldDefs'
import { upsertCustomEntitySchema, upsertCustomFieldDefSchema } from '@helios/core/modules/entities/data/validators'
import { z } from 'zod'
...
import { loadGeneratedFieldRegistrations } from '@helios/ui/backend/fields/registry'
import { Spinner } from '@helios/ui/primitives/spinner'
import { createCrudFormError, raiseCrudError } from '@helios/ui/backend/utils/serverErrors'
import { FieldDefinitionsEditor, type FieldDefinition, type FieldDefinitionError } from '@helios/ui/backend/custom-fields/FieldDefinitionsEditor'
import { useT, type TranslateFn } from '@helios/shared/lib/i18n/context'
import {
  Dialog,
  DialogContent,
  DialogHeader,
...
import { normalizeCustomFieldOptions } from '@helios/shared/modules/entities/options'
import { TranslationManager } from '@helios/core/modules/translations/components/TranslationManager'
