...
jest.mock('@helios/ui/backend/custom-fields/FieldDefinitionsEditor', () => ({
  FieldDefinitionsEditor: () => <div data-testid="field-definitions-editor" />,
}))

jest.mock('@helios/core/modules/translations/components/TranslationManager', () => ({
  TranslationManager: () => null,
}))

jest.mock('@helios/ui/backend/fields/registry', () => ({
