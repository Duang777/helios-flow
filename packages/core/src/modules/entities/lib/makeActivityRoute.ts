...
import { resolveCrudRecordId, parseScopedCommandInput } from '@helios/shared/lib/api/scoped'
...
import type { CrudOpenApiOptions } from '@helios/shared/lib/openapi/crud'
import {
