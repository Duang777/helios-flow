...
import { CustomEntity, CustomFieldDef } from '@helios/core/modules/entities/data/entities'
import { getEntityIds } from '@helios/shared/lib/encryption/entityIds'
import { upsertCustomEntitySchema } from '@helios/core/modules/entities/data/validators'
import type { OpenApiRouteDoc } from '@helios/shared/lib/openapi'
import { isSystemEntitySelectable } from '@helios/shared/lib/entities/system-entities'
...
const CUSTHELIOS_ENTITY_DEFINITION_RESOURCE_KIND = ENTITY_DEFINITION_RESOURCE_KIND
  ...
  if (ent) {
    try {
      await enforceCommandOptimisticLockWithGuards(container, {
        resourceKind: CUSTHELIOS_ENTITY_DEFINITION_RESOURCE_KIND,
        resourceId: ent.id,
