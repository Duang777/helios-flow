...
import type { QueryEngine, QueryOptions, Where, Sort } from '@helios/shared/lib/query/types'
import { normalizeExportFormat, serializeExport, defaultExportFilename, ensureColumns } from '@helios/shared/lib/crud/exporters'
import type { RbacService } from '@helios/core/modules/auth/services/rbacService'
import { resolveOrganizationScope, getSelectedOrganizationFromRequest } from '@helios/core/modules/directory/utils/organizationScope'
import { SYSTEM_ENTITY_RECORDS_BLOCKED_CODE, isOrmBackedSystemEntityId } from '@helios/shared/lib/data/engine'
...
import { getModules } from '@helios/shared/lib/i18n/server'
...
const CUSTHELIOS_ENTITY_RECORD_RESOURCE_KIND = 'entities.record'
  ...
  try {
    ...
    try {
      ...
      await enforceCommandOptimisticLockWithGuards(container, {
        resourceKind: CUSTHELIOS_ENTITY_RECORD_RESOURCE_KIND,
        resourceId: rid,
