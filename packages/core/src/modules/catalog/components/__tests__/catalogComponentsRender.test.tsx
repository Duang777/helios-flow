...
jest.mock('@helios/ui/primitives/radio', () => {
...
jest.mock('@helios/ui/backend/inputs/TagsInput', () => ({
...
jest.mock('@helios/ui/backend/utils/customFieldDefs', () => ({
  useCustomFieldDefs: () => ({ data: [] }),
}))

jest.mock('@helios/ui/backend/utils/customFieldColumns', () => ({
...
jest.mock('@helios/core/modules/attachments/lib/imageUrls', () => ({
