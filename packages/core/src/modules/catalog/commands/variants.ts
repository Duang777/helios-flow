...
import { buildChanges, requireId, parseWithCustomFields, setCustomFieldsIfAny, emitCrudSideEffects } from '@helios/shared/lib/commands/helpers'
...
import { loadCustomFieldSnapshot, buildCustomFieldResetMap } from '@helios/shared/lib/commands/customFieldSnapshots'
import { withAtomicFlush } from '@helios/shared/lib/commands/flush'
import { resolveRedoSnapshot, restoreCreatedRow } from '@helios/shared/lib/commands/redo'
...
import { resolveAttachmentScopePair } from '@helios/core/modules/attachments/lib/scope'
import {
  variantCreateSchema,
  variantUpdateSchema,
