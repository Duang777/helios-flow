...
import { AiChat, type AiChatSuggestion, type AiChatContextItem } from '@helios/ui/ai/AiChat'
import { AiIcon } from '@helios/ui/ai/AiIcon'
import { useAiDock } from '@helios/ui/ai/AiDock'
import { useAiChatSessions } from '@helios/ui/ai/AiChatSessions'
import { ChatPaneTabs } from '@helios/ui/ai/ChatPaneTabs'
...
import { ButtonGroup } from '@helios/ui/primitives/button-group'
...
function useMerchandisingAgents(): MerchandisingAgentsState {
  ...
  React.useEffect(() => {
    ...
    apiCall<AgentsResponse>('/api/ai_assistant/ai/agents', {
      ...
      headers: { 'x-helios-forbidden-redirect': '0', 'x-helios-unauthorized-redirect': '0' },
    })
      .then((call) => {
        if (cancelled) return
