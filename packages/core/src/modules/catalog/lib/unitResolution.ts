...
import {
  Dictionary,
  DictionaryEntry,
} from "@helios/core/modules/dictionaries/data/entities";
import { canonicalizeUnitCode } from "./unitCodes";

export const UHELIOS_DICTIONARY_KEYS = ["unit", "units", "measurement_units"] as const;
...
export async function resolveUnitDictionary(
  ...
  return findOneWithDecryption(
    ...
    Dictionary,
    {
      organizationId,
      tenantId,
      key: { $in: UHELIOS_DICTIONARY_KEYS },
      deletedAt: null,
      isActive: true,
    },
