 ...
 * is a strict subset of `AiToolDefinition` from `@helios/ai-assistant`.
 ...
 * Mirrors `AiToolLoadBeforeSingleRecord` from `@helios/ai-assistant/lib/types`.
 */
 ...
 * `AiToolLoadBeforeRecord` from `@helios/ai-assistant/lib/types` — the
