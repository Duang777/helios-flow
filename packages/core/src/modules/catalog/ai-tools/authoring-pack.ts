...
const DRAFT_DESCRIPTION_FRHELIOS_ATTRIBUTES_SCHEMA = 'DraftDescriptionFromAttributes'
  ...
  handler: async (rawInput, ctx) => {
    ...
    return {
      ...
      outputSchemaDescriptor: {
        schemaName: DRAFT_DESCRIPTION_FRHELIOS_ATTRIBUTES_SCHEMA,
        jsonSchema: toJsonSchema(draftDescriptionFromAttributesProposal, DRAFT_DESCRIPTION_FRHELIOS_ATTRIBUTES_SCHEMA),
      },
    }
  },
}
...
const EXTRACT_ATTRIBUTES_FRHELIOS_DESCRIPTION_SCHEMA = 'ExtractAttributesFromDescription'
...
const extractAttributesFromDescriptionTool: CatalogAiToolDefinition = {
  ...
  handler: async (rawInput, ctx) => {
    ...
    return {
      ...
      outputSchemaDescriptor: {
        schemaName: EXTRACT_ATTRIBUTES_FRHELIOS_DESCRIPTION_SCHEMA,
        jsonSchema: toJsonSchema(
          extractAttributesFromDescriptionProposal,
          EXTRACT_ATTRIBUTES_FRHELIOS_DESCRIPTION_SCHEMA,
        ),
      },
    }
  },
...
const DRAFT_DESCRIPTION_FRHELIOS_MEDIA_SCHEMA = 'DraftDescriptionFromMedia'
...
const draftDescriptionFromMediaTool: CatalogAiToolDefinition = {
  ...
  handler: async (rawInput, ctx) => {
    ...
    return {
      ...
      outputSchemaDescriptor: {
        schemaName: DRAFT_DESCRIPTION_FRHELIOS_MEDIA_SCHEMA,
        jsonSchema: toJsonSchema(draftDescriptionFromMediaProposal, DRAFT_DESCRIPTION_FRHELIOS_MEDIA_SCHEMA),
      },
    }
  },
}
