...
import { getAuthToken } from '@helios/core/modules/core/__integration__/helpers/api'
import {
  createProductFixture,
  createVariantFixture,
  deleteCatalogProductIfExists,
} from '@helios/core/modules/core/__integration__/helpers/catalogFixtures'
import {
  bumpRecordViaApi,
  readUpdatedAt,
 ...
 * browser so the now-stale `x-helios-ext-optimistic-lock-expected-updated-at`
