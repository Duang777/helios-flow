...
import { createShippingCarrierService } from '@helios/core/modules/shipping_carriers/lib/shipping-service'
...
import { getShippingAdapter } from '@helios/core/modules/shipping_carriers/lib/adapter-registry'

jest.mock('@helios/shared/lib/encryption/find', () => ({
  findOneWithDecryption: jest.fn(),
}))

jest.mock('@helios/core/modules/shipping_carriers/lib/adapter-registry', () => ({
  getShippingAdapter: jest.fn(),
}))

jest.mock('@helios/core/modules/shipping_carriers/events', () => ({
