...
// @helios/shared/lib/crud/errors for the same pattern).
const SHIPMENT_CANCEL_NOT_ALLOWED_MARKER = Symbol.for('@helios/shipping_carriers/ShipmentCancelNotAllowedError')
