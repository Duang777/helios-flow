...
import { POST } from '@helios/core/modules/shipping_carriers/api/webhook/[provider]/route'
...
import { getShippingCarrierQueue } from '@helios/core/modules/shipping_carriers/lib/queue'
...
jest.mock('@helios/core/modules/shipping_carriers/lib/queue', () => ({
