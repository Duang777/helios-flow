...
import { createFetchConfigFixture } from '@helios/core/modules/core/__integration__/helpers/currenciesFixtures';
 ...
 *
 * Committed follow-up to the `helios-auto-verify-pr-ui` run on #3438, which exercised this
