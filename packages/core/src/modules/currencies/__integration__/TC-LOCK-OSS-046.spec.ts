...
import { getAuthToken, apiRequest } from '@helios/core/modules/core/__integration__/helpers/api'
import {
  createCurrencyFixture,
  deleteCurrenciesEntityIfExists,
  generateUniqueCurrencyCode,
} from '@helios/core/modules/core/__integration__/helpers/currenciesFixtures'
import { createCompanyFixture, deleteEntityIfExists } from '@helios/core/modules/core/__integration__/helpers/crmFixtures'
import { login } from '@helios/core/modules/core/__integration__/helpers/auth'
import {
  readUpdatedAt,
  putWithLock,
} from '@helios/core/modules/core/__integration__/helpers/optimisticLockUi'
 ...
 *          the lock is opt-in via the `x-helios-ext-optimistic-lock-expected-updated-at`
 ...
 *   NEG-02 opt-out (HELIOS_OPTIMISTIC_LOCK=off): NOT runnable here — this shared app
...
test.describe('TC-LOCK-OSS-046: optimistic-lock negative / additive contract', () => {
  ...
  // NEG-02 opt-out (HELIOS_OPTIMISTIC_LOCK=off): this shared app boots default-ON, so a
  ...
  // "NEG-02: with HELIOS_OPTIMISTIC_LOCK=... a stale header is NOT enforced" case, which
