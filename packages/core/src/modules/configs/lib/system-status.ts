...
const SYSTEM_STATUS_DOC_BASE = 'https://docs.helios.com/docs/framework/operations/system-status'
const DEFAULT_SQLITE_CACHE_PATH = './.helios/cache/cache.db'
...
export const SYSTEM_STATUS_VARIABLES: SystemStatusVariableDefinition[] = [
  ...
  {
    key: 'NEXT_PUBLIC_HELIOS_PROFILE',
    category: 'profiling',
    kind: 'string',
  ...
  {
    key: 'HELIOS_PASSWORD_MIN_LENGTH',
    category: 'security',
    kind: 'string',
  ...
  {
    key: 'HELIOS_PASSWORD_REQUIRE_DIGIT',
    category: 'security',
    kind: 'boolean',
  ...
  {
    key: 'HELIOS_PASSWORD_REQUIRE_UPPERCASE',
    category: 'security',
    kind: 'boolean',
  ...
  {
    key: 'HELIOS_PASSWORD_REQUIRE_SPECIAL',
    category: 'security',
    kind: 'boolean',
