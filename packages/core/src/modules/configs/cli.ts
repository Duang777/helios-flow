...
import { runWithCacheTenant, type CacheStrategy } from '@helios/cache'
...
function printCacheHelp() {
  ...
  console.log('')
  console.log('🚀 Usage:')
  console.log('  yarn helios configs cache stats [--tenant <id> | --global | --all-tenants] [--json]')
  console.log('  yarn helios configs cache purge --all [--tenant <id> | --global | --all-tenants] [--dry-run] [--json]')
  console.log('  yarn helios configs cache purge --segment <segment> [--tenant <id> | --global | --all-tenants] [--dry-run] [--json]')
  console.log('  yarn helios configs cache purge --tag <tag1,tag2> [--tenant <id> | --global | --all-tenants] [--dry-run] [--json]')
  console.log('  yarn helios configs cache purge --key <key1,key2> [--tenant <id> | --global | --all-tenants] [--dry-run] [--json]')
  console.log('  yarn helios configs cache purge --id <token1,token2> [--tenant <id> | --global | --all-tenants] [--dry-run] [--json]')
  console.log('  yarn helios configs cache purge --pattern <glob> [--tenant <id> | --global | --all-tenants] [--dry-run] [--json]')
  console.log('  yarn helios configs cache structural [--tenant <id> | --global | --all-tenants] [--dry-run] [--json]')
  console.log('')
...
function envDisablesAutoIndexing(): boolean {
  const raw =
    process.env.HELIOS_DISABLE_VECTOR_SEARCH_AUTOINDEXING ??
    ...
    try {
      ...
      console.log(
        `[configs] Vector auto-indexing default set to ${defaultEnabled ? 'enabled' : 'disabled'}${
          disabledByEnv
            ? ' (forced by HELIOS_DISABLE_VECTOR_SEARCH_AUTOINDEXING or legacy DISABLE_VECTOR_SEARCH_AUTOINDEXING)'
            : ''
        }.`,
      )
    } finally {
...
const help: ModuleCli = {
  ...
  async run() {
    ...
    console.log('')
    console.log('🚀 Usage: yarn helios configs restore-defaults')
