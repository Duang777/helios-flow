...
import { QueuedJob, JobContext } from '@helios/queue'
...
jest.mock('@helios/shared/lib/indexers/error-log', () => ({
  recordIndexerError: jest.fn().mockResolvedValue(undefined),
}))

jest.mock('@helios/shared/lib/indexers/status-log', () => ({
  recordIndexerLog: jest.fn().mockResolvedValue(undefined),
}))

jest.mock('@helios/core/modules/query_index/lib/coverage', () => ({
