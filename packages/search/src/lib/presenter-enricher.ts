...
import { decryptIndexDocForSearch } from '@helios/shared/lib/encryption/indexDoc'
...
/** Diagnostic logger - surfaces issues without breaking flow, gated by HELIOS_LOG_LEVEL=debug */
