...
export function railwayDeployHelp(): string {
  return `Usage: helios deploy railway [options]

Deploy an Helios standalone app to Railway.

  --project <name>                 Railway project name
  --env <name>                     Environment name (default: production)
  --service <name>                 App service name (default: helios-app)
  ...
  --no-track                       Use .helios/railway.json.local
