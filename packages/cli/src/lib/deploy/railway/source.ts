...
const REQUIRED_IGNORE_ENTRIES = [
  ...
  { label: '.helios/railway.json', matches: (line: string) =>
    line === '.helios/railway.json' || line === '.helios/railway.json*' },
  { label: '.helios/railway.json.local', matches: (line: string) =>
    line === '.helios/railway.json.local' || line === '.helios/railway.json*' },
]
