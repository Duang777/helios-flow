...
// `@helios/events/single-delivery`. The CLI cannot import the events
...
const EVENTS_SINGLE_DELIVERY_ENV = 'HELIOS_EVENTS_SINGLE_DELIVERY'
const EVENTS_EXTERNAL_WORKER_ENV = 'HELIOS_EVENTS_EXTERNAL_WORKER'
