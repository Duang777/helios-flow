...
export async function generateModuleEntities(options: ModuleEntitiesOptions): Promise<GeneratorResult> {
  ...
  for (const entry of mods) {
    ...
    // From .helios/generated/, the relative path to src/modules/ is ../src/modules/
    let relImport: string
    if (isAppModule && fromApp) {
      // From .helios/generated/, go up two levels (../..) to reach the app root, then into src/modules/
