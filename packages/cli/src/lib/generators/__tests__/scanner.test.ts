...
beforeEach(() => {
  ...
  imps = {
    ...
    pkgBase: '@helios/core/modules/test_mod',
  }
...
describe('resolveModuleFile', () => {
  it('resolves package file when only package has it', () => {
    ...
    expect(result!.importPath).toBe('@helios/core/modules/test_mod/search')
  })
  ...
  it('resolves nested paths like data/extensions.ts', () => {
    ...
    expect(result).not.toBeNull()
    expect(result!.importPath).toBe('@helios/core/modules/test_mod/data/extensions')
  })
