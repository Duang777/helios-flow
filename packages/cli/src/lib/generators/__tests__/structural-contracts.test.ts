...
function createMockResolver(enabled: ModuleEntry[]): PackageResolver {
  return {
    ...
    getModuleImportBase: (entry: ModuleEntry) => ({
      ...
      pkgBase: `@helios/core/modules/${entry.id}`,
    }),
...
function scaffoldFixture(): ModuleEntry[] {
  ...
  touchFile(pkgModulePath('orders', 'commands', 'create.ts'), `import { registerCommand } from '@helios/shared/lib/commands'\nexport const ORDERS_CREATE_COMMAND_ID = 'orders.create'\nconst createOrderCommand = {\n  id: ORDERS_CREATE_COMMAND_ID,\n  async execute() { return { id: 'order-1' } },\n}\nregisterCommand(createOrderCommand)\n`)
  touchFile(pkgModulePath('orders', 'commands', 'archive.ts'), `import { registerCommand } from '@helios/shared/lib/commands'\nconst commandId = 'orders.archive'\nregisterCommand({\n  id: commandId,\n  async execute() { return { ok: true } },\n})\n`)
  ...
  return [
    { id: 'orders', from: '@helios/core' },
    { id: 'products', from: '@helios/core' },
...
beforeEach(() => {
  tmpDir = createTmpDir()
  outputDir = path.join(tmpDir, 'app', '.helios', 'generated')
...
describe('backend-routes.generated.ts', () => {
  ...
  it('keeps backend page imports lazy in route entries', () => {
    expect(content).toContain('@helios/core/modules/orders/backend')
    expect(content).toContain('load: async () =>')
    expect(content).toContain('import("@helios/core/modules/orders/backend')
  })
})
...
describe('api-routes.generated.ts', () => {
  ...
  it('keeps API handler imports lazy in route entries', () => {
    expect(content).toContain('@helios/core/modules/orders/api')
...
describe('notification-handlers.generated.ts', () => {
  ...
  it('imports NotificationHandler type', () => {
    expect(hasTypeImport(content, 'NotificationHandler', '@helios/shared/modules/notifications/handler')).toBe(true)
  })
})
...
describe('component-overrides.generated.ts', () => {
  ...
  it('imports ComponentOverride type', () => {
    expect(hasTypeImport(content, 'ComponentOverride', '@helios/shared/modules/widgets/component-registry')).toBe(true)
  })
})
...
describe('analytics.generated.ts', () => {
  ...
  it('imports AnalyticsModuleConfig type', () => {
    expect(hasTypeImport(content, 'AnalyticsModuleConfig', '@helios/shared/modules/analytics')).toBe(true)
  })
})
...
describe('search.generated.ts', () => {
  it('exports searchModuleConfigEntries and searchModuleConfigs even when empty', async () => {
    ...
    expect(hasTypeImport(content, 'SearchModuleConfig', '@helios/shared/modules/search')).toBe(true)
  })
})
...
describe('command-loaders.generated.ts', () => {
  it('includes command ids declared through const variables', async () => {
    ...
    expect(content).toContain('@helios/core/modules/orders/commands/archive')
    expect(content).toContain('@helios/core/modules/orders/commands/create')
  })
})
...
describe('enabled-module-ids.generated.ts', () => {
  it('exports a plain string array of every enabled module id without runtime imports', async () => {
    ...
    expect(content).not.toContain('@helios/')
    expect(content).not.toContain('createElement')
