 ...
 * (e.g. E.example.*, @/.helios/generated/entities/todo).
 */
import fs from 'node:fs'
import path from 'node:path'

const REPO_ROOT = path.resolve(__dirname, '..', '..', '..', '..', '..', '..')
const APP_DIR = path.join(REPO_ROOT, 'apps', 'helios')
...
// 1. Import from per-entity generated field selectors (e.g. @/.helios/generated/entities/todo)
//    Note: @/.helios/generated/entities/organization is OK (always-enabled module)
const EXAMPLE_ENTITY_IMPORT = /from\s+['"]@\/\.helios\/generated\/entities\/(todo|example_customer_priority)['"]/
...
const RELATIVE_GENERATED_IDS_IMPORT = /from\s+['"][\./]*\.helios\/generated\/entities\.ids\.generated['"]/
