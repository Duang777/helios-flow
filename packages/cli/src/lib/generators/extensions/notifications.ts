  ...
  return {
    ...
    generateOutput() {
      const notificationsOutput = renderGeneratedTsSource({
        ...
        imports: [
          { namedImports: [{ name: 'NotificationTypeDefinition', isTypeOnly: true }], moduleSpecifier: '@helios/shared/modules/notifications/types' },
          { namedImports: [{ name: 'applyNotificationTypeOverridesToEntries' }], moduleSpecifier: '@helios/shared/modules/overrides' },
          ...notificationImports,
        ],
        build(sourceFile) {
      ...
      const notificationsClientOutput = renderGeneratedTsSource({
        ...
        imports: [
          { namedImports: [{ name: 'ComponentType', isTypeOnly: true }], moduleSpecifier: 'react' },
          {
            ...
            moduleSpecifier: '@helios/shared/modules/notifications/types',
          },
          { namedImports: [{ name: 'applyNotificationTypeOverridesToEntries' }], moduleSpecifier: '@helios/shared/modules/overrides' },
      ...
      const notificationHandlersOutput = renderGeneratedTsSource({
        ...
        imports: [
          { namedImports: [{ name: 'NotificationHandler', isTypeOnly: true }], moduleSpecifier: '@helios/shared/modules/notifications/handler' },
