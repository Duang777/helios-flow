  ...
  return {
    ...
    generateOutput() {
      const messageTypesOutput = renderGeneratedTsSource({
        ...
        imports: [
          { namedImports: [{ name: 'MessageTypeDefinition', isTypeOnly: true }], moduleSpecifier: '@helios/shared/modules/messages/types' },
          ...messageTypeImports,
        ],
        build(sourceFile) {
      ...
      const messageObjectsOutput = renderGeneratedTsSource({
        ...
        imports: [
          { namedImports: [{ name: 'MessageObjectTypeDefinition', isTypeOnly: true }], moduleSpecifier: '@helios/shared/modules/messages/types' },
      ...
      const messagesClientOutput = renderGeneratedTsSource({
        ...
        imports: [
          { namedImports: [{ name: 'ComponentType', isTypeOnly: true }], moduleSpecifier: 'react' },
          {
            ...
            moduleSpecifier: '@helios/shared/modules/messages/types',
          },
          { namedImports: ['registerMessageObjectTypes'], moduleSpecifier: '@helios/core/modules/messages/lib/message-objects-registry' },
          { namedImports: ['configureMessageUiComponentRegistry'], moduleSpecifier: '@helios/core/modules/messages/components/utils/typeUiRegistry' },
          ...messageTypeImports,
          ...messageObjectTypeImports,
        ],
        build(sourceFile) {
