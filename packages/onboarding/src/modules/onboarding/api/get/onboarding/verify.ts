...
import { onboardingVerifySchema } from '@helios/onboarding/modules/onboarding/data/validators'
import type { OnboardingRequest } from '@helios/onboarding/modules/onboarding/data/entities'
import { OnboardingService } from '@helios/onboarding/modules/onboarding/lib/service'
import { sendWorkspaceReadyEmail } from '@helios/onboarding/modules/onboarding/lib/ready-email'
import {
  redirectToLogin,
  redirectToPreparing,
  redirectWithStatus,
} from '@helios/onboarding/modules/onboarding/lib/verify-redirects'
import { resolveVerifyRedirectBaseUrl } from '@helios/onboarding/modules/onboarding/lib/verify-base-url'
import {
  resolveProvisioningIds,
  runDeferredProvisioning,
} from '@helios/onboarding/modules/onboarding/lib/deferred-provisioning'
import { setupInitialTenant } from '@helios/core/modules/auth/lib/setup-app'
import { UserConsent } from '@helios/core/modules/auth/data/entities'
import { computeConsentIntegrityHash } from '@helios/core/modules/auth/lib/consentIntegrity'
import { resolveConsentClientIp } from '@helios/onboarding/modules/onboarding/lib/consentClientIp'
import { runBestEffortProvisioningStep } from '@helios/onboarding/modules/onboarding/lib/provisioning'
import { getModules } from '@helios/shared/lib/modules/registry'
import { isUniqueViolation } from '@helios/shared/lib/crud/errors'
import type { OpenApiMethodDoc, OpenApiRouteDoc } from '@helios/shared/lib/openapi'
