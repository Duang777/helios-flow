...
import VerificationEmail from '@helios/onboarding/modules/onboarding/emails/VerificationEmail'
import AdminNotificationEmail from '@helios/onboarding/modules/onboarding/emails/AdminNotificationEmail'
...
export async function POST(req: Request) {
  ...
  try {
    ...
    const emailCopy = {
      preview: translate('onboarding.email.preview', 'Confirm your email to activate your Helios workspace'),
      heading: translate('onboarding.email.heading', 'Welcome to Helios'),
      ...
      footer: translate('onboarding.email.footer', 'Helios · Onboarding service'),
    }
