...
import { translateWithFallback } from '@helios/shared/lib/i18n/translate'
import { formatPasswordRequirements, getPasswordPolicy } from '@helios/shared/lib/auth/passwordPolicy'
import { onboardingStartSchema } from '@helios/onboarding/modules/onboarding/data/validators'
import { apiCall } from '@helios/ui/backend/utils/apiCall'
import { Button } from '@helios/ui/primitives/button'
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from '@helios/ui/primitives/card'
      ...
      <Card className="relative w-full max-w-lg overflow-hidden shadow-lg">
            ...
            >
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                {translate(
                  ...
                  'Workspace creation is currently handled manually. Contact the Helios team or your administrator to request access before continuing.',
                )}
              </p>
        ...
        <CardHeader className="flex flex-col gap-4 p-10 text-center">
          <div className="flex flex-col items-center gap-3">
            <Image alt="Helios" src="/helios.svg" width={120} height={120} priority  className="dark:invert" />
            <CardTitle className="text-2xl font-semibold">
              {translate('onboarding.title', 'Create your Helios workspace')}
            </CardTitle>
            <CardDescription>
            ...
            <label className="flex items-start gap-3 text-sm text-muted-foreground">
              ...
              <span>
                {translate(
                  ...
                  "I consent to receiving direct marketing from Helios sp. z o.o. by email at the address I provide. I'm aware that I can withdraw my consent at any time (e.g., via the unsubscribe link), and that Helios sp. z o.o. may also process my email address under its legitimate interests to manage its mailing list, keep proof of my consent, and record opt-outs. See our {termsLink} and {privacyLink}.",
                )
