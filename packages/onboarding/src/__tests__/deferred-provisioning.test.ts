...
jest.mock('@helios/shared/lib/modules/registry', () => ({
...
jest.mock('@helios/onboarding/modules/onboarding/lib/ready-email', () => ({
  sendWorkspaceReadyEmail: (...args: unknown[]) => sendWorkspaceReadyEmail(...(args as [])),
}))

jest.mock('@helios/onboarding/modules/onboarding/lib/service', () => ({
...
import { runDeferredProvisioning } from '@helios/onboarding/modules/onboarding/lib/deferred-provisioning'
