 ...
 *
 * Stack traces are deliberately gated behind `HELIOS_AI_INCLUDE_HANDLER_STACK=1`
...
function buildHandlerErrorFromThrown(
  ...
  if (process.env.HELIOS_AI_INCLUDE_HANDLER_STACK === '1' && error instanceof Error && error.stack) {
