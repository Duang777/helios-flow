 ...
 *    inside `apps/<app>/.helios/generated/ai-agents.generated.ts`
 ...
 * (the umbrella dispatcher in `@helios/shared/modules/overrides`)
...
/**
 * Applier registered with `@helios/shared/modules/overrides` for
...
// umbrella dispatcher in `@helios/shared/modules/overrides` can
// route `entry.overrides.ai` here. Any consumer that imports
// `@helios/ai-assistant` (which apps do via `bootstrap.ts`) gets
