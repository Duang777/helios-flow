 ...
 * `ai-tools.ts`; they expose the existing `@helios/search` runtime to
 * agents that whitelist them via `allowedTools`.
 */
import { z } from 'zod'
import type { SearchOptions, SearchResult, SearchStrategyId } from '@helios/shared/modules/search'
