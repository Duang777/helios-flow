...
jest.mock('@helios/shared/lib/ai/opencode-provider', () => ({
...
describe('GET /api/ai_assistant/settings', () => {
  ...
  it('does not run LM Studio slashy model ids through the legacy OpenCode model parser', async () => {
    process.env.HELIOS_AI_PROVIDER = 'lm_studio'
    process.env.HELIOS_AI_MODEL = 'qwen/qwen3.5-9b'
    process.env.HELIOS_AI_AVAILABLE_PROVIDERS = 'openai,lm_studio'
    process.env.HELIOS_AI_AVAILABLE_MODELS_LM_STUDIO = 'qwen/qwen3.5-9b'
