...
import type { InitSetupContext } from '@helios/shared/modules/setup'
...
const TEMPLATE_SEEDS: TemplateSeed[] = [
  {
    ...
    customFields: {
      ...
      support_contact: 'ops@helios.com',
    },
  },
  {
    name: 'Donation',
    ...
    customFields: {
      ...
      support_contact: 'donations@helios.com',
    },
  },
  {
    name: 'Event Ticket',
    ...
    customFields: {
      ...
      event_location: 'Helios Hall, 12 River Street, New York',
      ticket_includes: '- Entry to the gala\n- Welcome drink\n- Networking session',
      support_contact: 'events@helios.com',
    },
  },
]
