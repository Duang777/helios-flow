...
import { CHECKOUT_LINK_CUSTHELIOS_FIELDS, CHECKOUT_LINK_FIELDSETS } from '../lib/customFields'
...
export async function ensureCheckoutFieldsetsAndDefinitions(
  ...
  await ensureCustomFieldDefinitions(
    em,
    [
      { entity: CHECKOUT_ENTITY_IDS.link, fields: CHECKOUT_LINK_CUSTHELIOS_FIELDS },
      { entity: CHECKOUT_ENTITY_IDS.template, fields: CHECKOUT_LINK_CUSTHELIOS_FIELDS },
    ],
    {
      organizationId: scope.organizationId,
      tenantId: scope.tenantId,
