...
import { buildFeatureNotificationFromType } from '@helios/core/modules/notifications/lib/notificationBuilder'
...
const logger = createLogger('checkout').child({ component: 'transaction-failed-notify' })
