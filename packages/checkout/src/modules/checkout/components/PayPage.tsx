...
import type { CustomFieldDisplayEntry } from '@helios/shared/lib/crud/custom-fields'
import { resolveLocaleFromCandidates } from '@helios/shared/lib/i18n/locale'
import { getPaymentGatewayRenderer } from '@helios/shared/modules/payment_gateways/client'
import type { PaymentGatewayRendererProps } from '@helios/shared/modules/payment_gateways/client'
import type { PaymentGatewayClientSession } from '@helios/shared/modules/payment_gateways/types'
import { InjectionSpot, useInjectionSpotEvents, useInjectionWidgets } from '@helios/ui/backend/injection/InjectionSpot'
...
import { Card, CardContent } from '@helios/ui/primitives/card'
      ...
      const runSubmit = async () => readApiResultOrThrow<SubmitResponse>(
        `/api/checkout/pay/${encodeURIComponent(slug)}/submit`,
        {
          ...
          headers: {
            ...
            'x-helios-unauthorized-redirect': '0',
          },
