...
} from '@helios/shared/lib/crud/custom-fields'
import type { CustomFieldDefinition } from '@helios/shared/modules/entities'
import { loadEntityFieldsetConfigs } from '@helios/core/modules/entities/lib/fieldsets'
...
export const CHECKOUT_LINK_CUSTHELIOS_FIELDS: CustomFieldDefinition[] = [
  {
