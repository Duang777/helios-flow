...
`@helios/checkout` provides the `checkout` module for standalone pay links and the Phase A public payment flow.
...
1. Add the workspace package to the app: `yarn workspace apps/helios add @helios/checkout@workspace:*`
2. Enable the module in [`apps/helios/src/modules.ts`](/Users/piotrkarwatka/Projects/helios-development-two/apps/helios/src/modules.ts):
...
- `yarn workspace @helios/checkout build`
- `yarn workspace @helios/checkout watch`
- `yarn workspace @helios/checkout test`
- `yarn workspace @helios/checkout typecheck`
