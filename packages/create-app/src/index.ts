...
function showHelp(): void {
  console.log(`
${pc.bold('create-helios-app')} - Create a new Helios application

${pc.bold('Usage:')}
  create-helios-app <app-name> [options]

${pc.bold('Arguments:')}
  app-name           Name of the application (will create folder with this name)

${pc.bold('Options:')}
  --app <name>       Bootstrap an official ready app from helios/ready-app-<name>
...
${pc.bold('Examples:')}
  ...
  npx create-helios-app my-store --preset classic
  npx create-helios-app my-store --preset empty
  npx create-helios-app my-store --preset crm
  npx create-helios-app my-store --init-git
  npx create-helios-app my-store --agents claude-code,codex
  npx create-helios-app my-store --agents all
  npx create-helios-app my-store --agents none
...
function showVersion(): void {
  console.log(`create-helios-app v${PACKAGE_VERSION}`)
}
...
function ensureGeneratedCssPlaceholder(targetDir: string): void {
  const generatedDir = join(targetDir, '.helios', 'generated')
...
function printTemplateNextSteps(appName: string, agenticConfigured: boolean): void {
  ...
  if (agenticConfigured) {
    ...
    console.log(pc.cyan('  /helios-setup-agent-pipeline'))
    console.log('')
  }
}
...
function printImportedReadyAppNextSteps(appName: string): void {
  ...
  console.log(pc.dim('If you want agentic tooling in the imported app later, run `yarn helios agentic:init` inside it.'))
  console.log('')
}
...
export async function main(argv = process.argv.slice(2)): Promise<void> {
  ...
  if (options.agents !== undefined && readyAppSource) {
    throw new Error(
      '--agents is not supported with --app/--app-url. Imported ready apps manage their own agentic tooling; run `yarn helios agentic:init` inside the app instead.',
    )
  }
  ...
  console.log('')
  console.log(pc.bold(`Creating a new Helios app in ${pc.cyan(targetDir)}`))
  console.log('')
  ...
  console.log(pc.dim('For more information, visit https://github.com/helios/helios'))
  console.log('')
}
