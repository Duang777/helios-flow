...
jest.mock('@/.helios/generated/frontend-routes.generated', () => ({
  frontendRoutes: [],
}), { virtual: true })

jest.mock('@/.helios/generated/frontend-middleware.generated', () => ({
...
jest.mock('@helios/core/modules/customer_accounts/lib/customerAuthServer', () => ({
...
jest.mock('@helios/ui/portal/PortalLayoutShell', () => ({
