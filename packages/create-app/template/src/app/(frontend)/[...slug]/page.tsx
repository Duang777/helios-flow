...
import { findRouteManifestMatch, getFrontendRouteManifests, registerFrontendRouteManifests } from '@helios/shared/modules/registry'
import { frontendRoutes } from '@/.helios/generated/frontend-routes.generated'
import { getAuthFromCookies } from '@helios/shared/lib/auth/server'
import { AccessDeniedMessage } from '@helios/ui/backend/detail'
...
import type { CustomerRbacService } from '@helios/core/modules/customer_accounts/services/customerRbacService'
...
import { frontendMiddlewareEntries } from '@/.helios/generated/frontend-middleware.generated'
...
export default async function SiteCatchAll({ params }: FrontendParams) {
  ...
  if (match.route.requireCustomerAuth) {
    const { getCustomerAuthFromCookies } = await import('@helios/core/modules/customer_accounts/lib/customerAuthServer')
