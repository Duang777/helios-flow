...
describe('RootLayout', () => {
  ...
  const originalIntegrationFlag = process.env.HELIOS_INTEGRATION_TEST
  ...
  afterEach(() => {
    ...
    if (originalIntegrationFlag === undefined) {
      delete process.env.HELIOS_INTEGRATION_TEST
    } else {
      process.env.HELIOS_INTEGRATION_TEST = originalIntegrationFlag
    }

    jest.resetModules()
  })

  it('disables notice bars when HELIOS_INTEGRATION_TEST is true', async () => {
    process.env.DEMO_MODE = 'true'
    process.env.HELIOS_INTEGRATION_TEST = 'true'
