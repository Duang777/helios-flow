...
const exampleInjectionWidgetsEnabled = parseBooleanWithDefault(
  process.env.NEXT_PUBLIC_HELIOS_EXAMPLE_INJECTION_WIDGETS_ENABLED,
  false,
)
...
const optionalCrossModuleInjectionTable: ModuleInjectionTable = {
  // Customer page injections are opt-in via NEXT_PUBLIC_HELIOS_EXAMPLE_INJECTION_WIDGETS_ENABLED.
