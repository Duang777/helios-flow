...
import type { WebhookEndpointAdapter } from '@helios/webhooks/modules/webhooks/lib/adapter-registry'
 ...
 * `NODE_ENV === 'production'`.
 */
export const MOCK_INBOUND_DEV_WEBHOOK_SECRET = 'helios-mock-dev-inbound-webhook-secret'
