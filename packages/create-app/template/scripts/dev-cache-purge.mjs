...
// route shape while preserving `.helios/next/dev/cache/turbopack`.
export const GREENFIELD_PURGE_TARGETS = Object.freeze([
  Object.freeze(['.helios', 'next', 'dev', 'lock']),
  Object.freeze(['.helios', 'next', 'dev', 'build-manifest.json']),
  Object.freeze(['.helios', 'next', 'dev', 'fallback-build-manifest.json']),
  Object.freeze(['.helios', 'next', 'dev', 'prerender-manifest.json']),
  Object.freeze(['.helios', 'next', 'dev', 'routes-manifest.json']),
  Object.freeze(['.helios', 'next', 'dev', 'server', 'app-paths-manifest.json']),
  Object.freeze(['.helios', 'next', 'dev', 'server', 'middleware-build-manifest.js']),
  Object.freeze(['.helios', 'next', 'dev', 'server', 'middleware-manifest.json']),
  Object.freeze(['.helios', 'next', 'dev', 'server', 'pages-manifest.json']),
  Object.freeze(['.next']),
])
