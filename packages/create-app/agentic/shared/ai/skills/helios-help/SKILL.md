...
name: helios-help
description: >
  Helios app navigator. Use when a developer asks: "what should I do now?",
...
| Version bump needed | Upgrade Helios |
...
**Recommended next step:** `/helios-<skill-name>`

**Why:** <one sentence explaining the match>

**After that:** `/helios-<next-skill>` → `/helios-<skill-after>`
```
...
|---------------|------------------------------------------|
| Create a new module | `helios-module-scaffold/SKILL.md` |
| Design entities, fields, migrations | `helios-data-model-design/SKILL.md` |
| Extend existing module (columns, fields, API) | `helios-system-extension/SKILL.md` + `references/extension-contracts.md` |
| Build admin pages, forms, data tables | `helios-backend-ui-design/SKILL.md` + `references/ui-components.md` |
| Build an integration provider | `helios-integration-builder/SKILL.md` |
| Write a spec | `helios-spec-writing/SKILL.md` |
| Write integration tests | `helios-integration-tests/SKILL.md` |
| Eject and customize core module | `helios-eject-and-customize/SKILL.md` |
| Something is broken | `helios-troubleshooter/SKILL.md` |
| Remove unused modules | `helios-trim-unused-modules/SKILL.md` |
| Code review | `helios-code-review/SKILL.md` + `references/review-checklist.md` |
