...
grep 'enrichers' .helios/generated/enrichers.generated.ts

# Check if widgets are registered
grep 'injection' .helios/generated/injection-widgets.generated.ts

# Check if interceptors are registered
grep 'interceptors' .helios/generated/interceptors.generated.ts
```
