...
describe('akeneo preset', () => {
  it('reads credentials and optional settings from env', () => {
    const preset = readAkeneoEnvPreset({
      HELIOS_INTEGRATION_AKENEO_API_URL: 'https://example.akeneo.com',
      HELIOS_INTEGRATION_AKENEO_CLIENT_ID: 'client-id',
      HELIOS_INTEGRATION_AKENEO_CLIENT_SECRET: 'client-secret',
      HELIOS_INTEGRATION_AKENEO_USERNAME: 'api-user',
      HELIOS_INTEGRATION_AKENEO_PASSWORD: 'api-pass',
      HELIOS_INTEGRATION_AKENEO_PRODUCT_LOCALE: 'de_DE',
      HELIOS_INTEGRATION_AKENEO_IMPORT_CHANNELS: 'ecommerce, mobile',
      HELIOS_INTEGRATION_AKENEO_PRODUCTS_SETTINGS_JSON: JSON.stringify({
        fieldMap: {
  ...
  it('builds discovered mappings and applies env overrides', () => {
    const preset = readAkeneoEnvPreset({
      ...
      HELIOS_INTEGRATION_AKENEO_IMPORT_ALL_CHANNELS: 'false',
      HELIOS_INTEGRATION_AKENEO_IMPORT_CHANNELS: 'ecommerce',
      HELIOS_INTEGRATION_AKENEO_ATTRIBUTE_FAMILY_FILTER: 'clothing',
      HELIOS_INTEGRATION_AKENEO_PRODUCTS_SETTINGS_JSON: JSON.stringify({
  ...
  it('keeps backward compatibility with legacy HELIOS_AKENEO aliases', () => {
    const preset = readAkeneoEnvPreset({
      HELIOS_AKENEO_API_URL: 'https://example.akeneo.com',
      HELIOS_AKENEO_CLIENT_ID: 'client-id',
      HELIOS_AKENEO_CLIENT_SECRET: 'client-secret',
      HELIOS_AKENEO_USERNAME: 'api-user',
      HELIOS_AKENEO_PASSWORD: 'api-pass',
    })
