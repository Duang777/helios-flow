...
function printHelp(): void {
  console.log('Usage: yarn helios sync_akeneo configure-from-env --tenant <tenantId> --org <organizationId> [--force]')
  console.log('')
  console.log('Required env vars:')
  console.log('  HELIOS_INTEGRATION_AKENEO_API_URL')
  console.log('  HELIOS_INTEGRATION_AKENEO_CLIENT_ID')
  console.log('  HELIOS_INTEGRATION_AKENEO_CLIENT_SECRET')
  console.log('  HELIOS_INTEGRATION_AKENEO_USERNAME')
  console.log('  HELIOS_INTEGRATION_AKENEO_PASSWORD')
  console.log('')
  console.log('Optional env vars:')
  console.log('  HELIOS_INTEGRATION_AKENEO_PRODUCT_LOCALE')
  console.log('  HELIOS_INTEGRATION_AKENEO_CATEGORY_LOCALE')
  console.log('  HELIOS_INTEGRATION_AKENEO_PRODUCT_CHANNEL')
  console.log('  HELIOS_INTEGRATION_AKENEO_IMPORT_CHANNELS')
  console.log('  HELIOS_INTEGRATION_AKENEO_IMPORT_ALL_CHANNELS')
  console.log('  HELIOS_INTEGRATION_AKENEO_CREATE_MISSING_CHANNELS')
  console.log('  HELIOS_INTEGRATION_AKENEO_SYNC_ASSOCIATIONS')
  console.log('  HELIOS_INTEGRATION_AKENEO_ATTRIBUTE_FAMILY_FILTER')
  console.log('  HELIOS_INTEGRATION_AKENEO_PRODUCTS_SETTINGS_JSON')
  console.log('  HELIOS_INTEGRATION_AKENEO_CATEGORIES_SETTINGS_JSON')
  console.log('  HELIOS_INTEGRATION_AKENEO_ATTRIBUTES_SETTINGS_JSON')
  console.log('')
  console.log('Legacy aliases still work:')
  console.log('  HELIOS_AKENEO_*')
  console.log('  AKENEO_*')
}
