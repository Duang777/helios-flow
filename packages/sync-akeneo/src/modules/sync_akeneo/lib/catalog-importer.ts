...
import { emitCrudSideEffects, setCustomFieldsIfAny } from '@helios/shared/lib/commands/helpers'
...
import type { DataMapping } from '@helios/core/modules/data_sync/lib/adapter'
import type { ExternalIdMappingService } from '@helios/core/modules/data_sync/lib/id-mapping'
import { SyncExternalIdMapping } from '@helios/core/modules/integrations/data/entities'
import {
  CatalogOffer,
...
} from '@helios/core/modules/catalog/data/entities'
import { ensureCustomFieldDefinitions } from '@helios/core/modules/entities/lib/field-definitions'
import { CustomFieldDef, CustomFieldEntityConfig } from '@helios/core/modules/entities/data/entities'
import { normalizeEntityFieldsetConfig, type CustomFieldsetDefinition } from '@helios/core/modules/entities/lib/fieldsets'
import { invalidateDefinitionsCache } from '@helios/core/modules/entities/api/definitions.cache'
import { Attachment } from '@helios/core/modules/attachments/data/entities'
import { buildAttachmentFileUrl, buildAttachmentImageUrl, slugifyAttachmentFileName } from '@helios/core/modules/attachments/lib/imageUrls'
import { deletePartitionFile, storePartitionFile } from '@helios/core/modules/attachments/lib/storage'
import { ensureDefaultPartitions, resolveDefaultPartitionCode } from '@helios/core/modules/attachments/lib/partitions'
import { mergeAttachmentMetadata } from '@helios/core/modules/attachments/lib/metadata'
import { attachmentCrudEvents, attachmentCrudIndexer } from '@helios/core/modules/attachments/lib/crud'
import { emitCatalogQueryIndexEvent } from '@helios/core/modules/catalog/commands/shared'
import { SalesChannel } from '@helios/core/modules/sales/data/entities'
import type { CustomFieldDefinition } from '@helios/shared/modules/entities'
import {
