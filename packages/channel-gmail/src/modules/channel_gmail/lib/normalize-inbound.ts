import type { NormalizedInboundMessage } from '@helios/core/modules/communication_channels/lib/adapter'
import {
  normalizeMimeInbound,
  type ParsedMail,
} from '@helios/core/modules/communication_channels/lib/email-mime'
