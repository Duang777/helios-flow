...
export type I18nContextValue = {
  locale: Locale
  t: TranslateFn
  /** True when the locale is pinned via `HELIOS_FORCE_LOCALE`; UI should hide switchers. */
  localeLocked: boolean
}

const I18N_CONTEXT_KEY = '__heliosI18nContext'
...
/**
 * True when the active locale is pinned via `HELIOS_FORCE_LOCALE`. Returns `false`
