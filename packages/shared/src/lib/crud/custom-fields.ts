import type { CustomFieldSet, EntityId } from '@helios/shared/modules/entities'
import type { EntityManager } from '@mikro-orm/core'
import { CustomFieldDef, CustomFieldValue } from '@helios/core/modules/entities/data/entities'
import type { WhereValue } from '@helios/shared/lib/query/types'
...
// `HELIOS_CF_DEF_CACHE_TTL_MS=300000` (or any positive integer) to opt in.
const CF_DEF_INDEX_DEFAULT_TTL_MS = 0

function resolveCfDefIndexCacheTtlMs(): number {
  const raw = process.env.HELIOS_CF_DEF_CACHE_TTL_MS
