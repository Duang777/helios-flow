 ...
 * (`x-helios-ext-<moduleId>-<key>`, see `umes/extension-headers.ts`). The
...
export const OPTIMISTIC_LOCK_HEADER_NAME = 'x-helios-ext-optimistic-lock-expected-updated-at'
...
export const OPTIMISTIC_LOCK_ENV_VAR = 'HELIOS_OPTIMISTIC_LOCK'
