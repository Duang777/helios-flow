 ...
 * `runRouteMutationGuards()` from `@helios/shared/lib/crud/route-mutation-guard`
 * for custom write routes, or `runMutationGuards()` from
 * `@helios/shared/lib/crud/mutation-guard-registry` directly. The legacy
 ...
 * `@helios/shared/lib/crud/route-mutation-guard`, or the
 * `afterSuccessCallbacks` returned by `runMutationGuards()` from
 * `@helios/shared/lib/crud/mutation-guard-registry`. This function will be
