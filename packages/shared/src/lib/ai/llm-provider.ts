 ...
 * routing layer to pick defaults when `HELIOS_AI_MODEL` is not set.
 */
...
export interface LlmProvider {
   ...
   * `openai`, `internal-litellm`). The `HELIOS_AI_PROVIDER` env var resolves to
