...
const ENV_KEYS = {
  minLength: 'HELIOS_PASSWORD_MIN_LENGTH',
  requireDigit: 'HELIOS_PASSWORD_REQUIRE_DIGIT',
  requireUppercase: 'HELIOS_PASSWORD_REQUIRE_UPPERCASE',
  requireSpecial: 'HELIOS_PASSWORD_REQUIRE_SPECIAL',
} as const
