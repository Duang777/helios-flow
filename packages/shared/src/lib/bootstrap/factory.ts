 ...
 *
 * @param data - All generated registry data from .helios/generated/
...
async function registerWidgetsAndOptionalPackages(data: BootstrapData, options: BootstrapOptions): Promise<void> {
  ...
  try {
    const [dashboardRegistry, injectionRegistry, coreInjection] = await Promise.all([
      import('@helios/ui/backend/dashboard/widgetRegistry'),
      import('@helios/ui/backend/injection/widgetRegistry'),
      import('@helios/core/modules/widgets/lib/injection'),
    ])
