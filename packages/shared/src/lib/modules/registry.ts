...
import { applyModuleOverridesToModules } from '@helios/shared/modules/overrides'
...
// node_modules/@helios/shared/dist/. Mirrors the same workaround used
// by `getDiRegistrars()` in `../di/container.ts`.
const GLOBAL_KEY = '__heliosModulesRegistry__'
