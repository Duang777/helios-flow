...
import { matchWildcardPattern } from '@helios/shared/lib/patterns/wildcard'
import type {
...
const GLOBAL_INJECTION_WIDGETS_KEY = '__heliosCoreInjectionWidgetEntries__'
const GLOBAL_INJECTION_TABLES_KEY = '__heliosCoreInjectionTables__'
const GLOBAL_ENABLED_MODULE_IDS_KEY = '__heliosEnabledModuleIds__'
const GLOBAL_INJECTION_REGISTRY_VERSION_KEY = '__heliosCoreInjectionRegistryVersion__'
const INJECTION_REGISTRY_CHANGED_EVENT = '__heliosInjectionRegistryChanged__'
