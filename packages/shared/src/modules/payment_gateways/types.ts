...
const ADAPTER_REGISTRY_KEY = '__heliosPaymentGatewayAdapters__'
const WEBHOOK_REGISTRY_KEY = '__heliosPaymentGatewayWebhookHandlers__'
const DESCRIPTOR_REGISTRY_KEY = '__heliosPaymentGatewayDescriptors__'
