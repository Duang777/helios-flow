...
function printHelp(): void {
  console.log('Usage: yarn helios storage_s3 configure-from-env [--tenant <tenantId> --org <organizationId> | --all-tenants] [--force]')
  console.log('')
  console.log('Modes:')
  ...
  console.log('  HELIOS_INTEGRATION_STORAGE_S3_ACCESS_KEY_ID')
  console.log('  HELIOS_INTEGRATION_STORAGE_S3_SECRET_ACCESS_KEY')
  console.log('  HELIOS_INTEGRATION_STORAGE_S3_REGION')
  console.log('  HELIOS_INTEGRATION_STORAGE_S3_BUCKET')
  console.log('')
  console.log('Optional env vars:')
  console.log('  HELIOS_INTEGRATION_STORAGE_S3_SESSION_TOKEN')
  console.log('  HELIOS_INTEGRATION_STORAGE_S3_ENDPOINT')
  console.log('  HELIOS_INTEGRATION_STORAGE_S3_FORCE_PATH_STYLE')
  console.log('  HELIOS_INTEGRATION_STORAGE_S3_FORCE_PRECONFIGURE')
}
