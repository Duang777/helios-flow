...
export default function PrivacyPage() {
  return (
    ...
    >
      <p>
        <strong>This Privacy Policy</strong> (this &ldquo;Policy&rdquo;) describes how <strong>Helios</strong> sp. z o.o.,
        ...
        <a href="https://helios.com" target="_blank" rel="noreferrer">https://helios.com</a>{' '}
      ...
      <p>
        ...
        <a href="https://demo.helios.com" target="_blank" rel="noreferrer">https://demo.helios.com</a>{' '}
        and to related informational resources, including technical and feature documentation available at{' '}
        <a href="https://docs.helios.com" target="_blank" rel="noreferrer">https://docs.helios.com</a>.
      </p>
      ...
      <ul>
        <li>Helios sp. z o.o., ul. Wyspa S&#322;odowa 7, 50-266 Wroc&#322;aw, Poland.</li>
