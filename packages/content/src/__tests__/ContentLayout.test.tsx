...
describe('ContentLayout', () => {
  ...
  describe('header navigation', () => {
    ...
    it('renders the logo with correct alt text and link', () => {
      ...
      const logoLink = screen.getByLabelText('Go to the Helios home page')
      expect(logoLink).toHaveAttribute('href', '/')
      const logoImage = within(logoLink).getByAltText('Helios logo')
  ...
  describe('footer', () => {
    ...
    it('displays a copyright notice with the current year', () => {
      ...
      expect(footer!.textContent).toContain('Helios')
    })
  })
