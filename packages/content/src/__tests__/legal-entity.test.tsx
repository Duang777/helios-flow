...
const operatorName = 'Helios sp. z o.o.'
...
describe.each([
  ...
  it('names Helios sp. z o.o. as the operating entity', () => {
  ...
  it('routes contact to the Helios address', () => {
    expect(text).toContain('info@helios.com')
  })
...
describe('legal documents', () => {
  ...
  it('records the current registration identifiers in the contributor licence agreement', () => {
    ...
    expect(contents).toContain('Helios spółka z o.o.')
    for (const identifier of registrationIdentifiers) {
