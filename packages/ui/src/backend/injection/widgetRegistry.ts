import type { ModuleInjectionWidgetEntry } from '@helios/shared/modules/registry'
import type { InjectionWidgetModule } from '@helios/shared/modules/widgets/injection'
import { applyInjectionWidgetOverridesToEntries } from '@helios/shared/modules/overrides'
...
export function registerInjectionWidgets(entries: Entry[]) {
  if (_injectionWidgetEntries !== null && process.env.NODE_ENV === 'development') {
    logger.debug('Injection widgets re-registered (this may occur during HMR)')
  }
