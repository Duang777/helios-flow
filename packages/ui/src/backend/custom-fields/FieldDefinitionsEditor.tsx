...
import { CUSTHELIOS_FIELD_KINDS } from '@helios/shared/modules/entities/kinds'
import { useOptionalT, type TranslateFn } from '@helios/shared/lib/i18n/context'
...
} from '@helios/shared/modules/entities/options'
...
const DEFAULT_VALUE_NONE = '__helios_no_default__'
...
export function FieldDefinitionsEditor({
  ...
  const resolvedKindOptions = React.useMemo(
    () =>
      kindOptions ??
      CUSTHELIOS_FIELD_KINDS.map((kind) => ({
        value: kind,
