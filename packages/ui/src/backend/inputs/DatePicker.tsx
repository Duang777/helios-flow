/**
 * @deprecated Import from `@helios/ui/primitives/date-picker` instead.
 *
 * This shim preserves the legacy import path
 * `@helios/ui/backend/inputs/DatePicker` for existing consumers
...
/** @deprecated Use `DatePicker` from `@helios/ui/primitives/date-picker`. */
