 ...
 * `@helios/ui/primitives/rich-editor` for any new rich-text input.
 *
...
/** @deprecated Use `RichEditor` from `@helios/ui/primitives/rich-editor` for new code. See module JSDoc. */
