...
import type { NotificationDto, NotificationRendererProps } from '@helios/shared/modules/notifications/types'
...
export type NotificationPanelProps = {
   ...
   * @example
   * ```tsx
   * import { salesNotificationTypes } from '@helios/core/modules/sales/notifications.client'
   *
