...
import { getMessageUiComponentRegistry } from '@helios/core/modules/messages/components/utils/typeUiRegistry'
import { getMessageObjectType } from '@helios/core/modules/messages/lib/message-objects-registry'
