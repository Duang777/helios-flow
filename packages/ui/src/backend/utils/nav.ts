...
import type { Module, ModuleRoute, PageMetadata } from '@helios/shared/modules/registry'
import { hasAllFeatures as checkFeatures } from '@helios/shared/security/features'
