...
describe('date display format helpers', () => {
  ...
  it('treats system-like env values as unset', () => {
    process.env.NEXT_PUBLIC_HELIOS_DATE_FORMAT = 'system'
  ...
  it('uses OM-prefixed env formats before legacy env formats', () => {
    ...
    process.env.NEXT_PUBLIC_HELIOS_DATE_FORMAT = 'dd.MM.yyyy'
    process.env.NEXT_PUBLIC_HELIOS_DATE_TIME_FORMAT = 'dd.MM.yyyy HH:mm'
