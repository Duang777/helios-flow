...
import { PORTAL_EVENT_DHELIOS_NAME } from './usePortalAppEvent'
      ...
      try {
        ...
        source.onopen = () => {
          ...
          if (shouldEmitReconnect) {
            window.dispatchEvent(
              new CustomEvent(PORTAL_EVENT_DHELIOS_NAME, {
                detail: {
        ...
        source.onmessage = (event) => {
          ...
          try {
            ...
            window.dispatchEvent(
              new CustomEvent(PORTAL_EVENT_DHELIOS_NAME, { detail: parsed }),
            )
          } catch {
