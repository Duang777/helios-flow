/**
 * @deprecated Import `EmptyState` from `@helios/ui/primitives/empty-state`
 ...
 * `@helios/ui/portal/components/PortalEmptyState` for existing
...
/** @deprecated Use `EmptyState` from `@helios/ui/primitives/empty-state` with `variant="subtle"` and `size="lg"`. */
