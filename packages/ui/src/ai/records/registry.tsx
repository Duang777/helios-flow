...
export function registerRecordCardUiParts(): void {
  ...
  registered = true
  defaultAiUiPartRegistry.register('helios.deal-card', DealCardPart)
  defaultAiUiPartRegistry.register('helios.person-card', PersonCardPart)
  defaultAiUiPartRegistry.register('helios.company-card', CompanyCardPart)
  defaultAiUiPartRegistry.register('helios.product-card', ProductCardPart)
...
// `@helios/ui/ai` get the cards wired up without manual bootstrap.
