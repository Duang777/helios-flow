...
/**
 * Recognise an `helios:<kind> { ... }` token the model emitted
...
/**
 * Walk through a markdown segment and pull every `helios:<kind>
 ...
 * `helios:<kind> { ... }` tokens the model emitted without
...
export function parseAiContentSegments(content: string): AiMessageContentSegment[] {
  ...
  // Recovery pass: lift fenceless `helios:<kind> { ... }` tokens out
