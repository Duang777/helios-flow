...
import { createAiAgentTransport } from '@helios/ai-assistant/modules/ai_assistant/lib/agent-transport'
...
const SESSION_STORAGE_PREFIX = 'helios-ai-chat:'
const SESSION_IMPORT_MARKER_PREFIX = 'helios-ai-chat-imported:'
const SESSION_STORAGE_VERSION = 1
const SESSION_UPDATED_EVENT = 'helios-ai-chat-session-updated'
const SESSION_STREAM_STATE_EVENT = 'helios-ai-chat-session-stream-state'
...
// `{ v, data }` envelope from `@helios/shared/lib/browser/versionedPreference`
