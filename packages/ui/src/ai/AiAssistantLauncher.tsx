 ...
 *     launcher wins when an Helios page has focus.
 */
...
const AI_ASSISTANT_DOCS_URL = 'https://docs.helios.com/framework/ai-assistant/overview'
const AI_ASSISTANT_SETTINGS_DOCS_URL = 'https://docs.helios.com/framework/ai-assistant/settings'
