...
const STORAGE_KEY = 'helios-ai-dock-v1'
const MIN_WIDTH = 320
const MAX_WIDTH = 960
  ...
  return (
    <AiDockContext.Provider value={api}>
      <div
        ...
        className={reservedWidth != null ? 'lg:pr-[var(--helios-ai-dock-width)]' : undefined}
        style={
          reservedWidth != null
            ? ({ ['--helios-ai-dock-width' as string]: `${reservedWidth}px` } as React.CSSProperties)
            : undefined
        }
      >
        {children}
