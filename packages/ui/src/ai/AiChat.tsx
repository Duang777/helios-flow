...
export function AiChat({
  ...
  React.useEffect(() => {
    ...
    window.addEventListener('helios-ai-chat-fix-request', handler as EventListener)
    return () => {
      window.removeEventListener('helios-ai-chat-fix-request', handler as EventListener)
    }
  }, [handleSendMessage])
  ...
  // composer's send button. CSS lives in `apps/helios/src/app/globals.css`
