...
import { useLocale, useLocaleLocked, useT } from '@helios/shared/lib/i18n/context'
...
export function LanguageSwitcher() {
  ...
  // Locale is pinned via HELIOS_FORCE_LOCALE — switching is a no-op, so hide the control.
