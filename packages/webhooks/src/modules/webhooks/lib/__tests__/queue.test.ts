...
describe('webhooks queue', () => {
  ...
  afterEach(() => {
    ...
    delete (globalThis as typeof globalThis & {
      __heliosWebhookLocalWorkerPromise__?: Promise<void>
    }).__heliosWebhookLocalWorkerPromise__
  })
  ...
  it('starts the local delivery worker when enqueueing in local mode', async () => {
    ...
    const createModuleQueue = jest.requireMock('@helios/queue').createModuleQueue as jest.Mock
