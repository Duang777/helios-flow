...
import { createUserFixture, deleteUserIfExists } from '@helios/core/helpers/integration/authFixtures';
import { deleteUserAclInDb, setUserAclInDb } from '@helios/core/helpers/integration/dbFixtures';
...
export const MOCK_INBOUND_WEBHOOK_SECRET =
  process.env.MOCK_INBOUND_WEBHOOK_SECRET?.trim() || 'helios-mock-dev-inbound-webhook-secret';
