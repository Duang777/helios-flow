...
import { readJsonSafe } from '@helios/core/helpers/integration/generalFixtures';
import { readIntegrationEnvFlag } from '@helios/core/helpers/integration/standaloneEnv';
import { createWebhookFixture, deleteWebhookIfExists } from './helpers/fixtures';

/**
 * TC-WEBHOOK-009: Invalid and unsafe URL rejection
 * Source: https://github.com/helios/helios/issues/2482
 *
 ...
 * deployment opts in via HELIOS_WEBHOOKS_ALLOW_PRIVATE_URLS (the integration env enables
 ...
 */
const PRIVATE_URLS_ALLOWED = readIntegrationEnvFlag('HELIOS_WEBHOOKS_ALLOW_PRIVATE_URLS');
