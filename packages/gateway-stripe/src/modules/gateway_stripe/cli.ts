...
function printHelp(): void {
  console.log('Usage: yarn helios gateway_stripe configure-from-env --tenant <tenantId> --org <organizationId> [--force]')
  console.log('')
  console.log('Required env vars:')
  console.log('  HELIOS_INTEGRATION_STRIPE_PUBLISHABLE_KEY')
  console.log('  HELIOS_INTEGRATION_STRIPE_SECRET_KEY')
  console.log('  HELIOS_INTEGRATION_STRIPE_WEBHOOK_SECRET')
  console.log('')
  console.log('Optional env vars:')
  console.log('  HELIOS_INTEGRATION_STRIPE_API_VERSION')
  console.log('  HELIOS_INTEGRATION_STRIPE_ENABLED')
  console.log('  HELIOS_INTEGRATION_STRIPE_FORCE_PRECONFIGURE')
  console.log('')
  console.log('Legacy aliases still work:')
  console.log('  HELIOS_STRIPE_*')
  console.log('  STRIPE_*')
}
