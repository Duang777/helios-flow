    ...
    fields: [
      {
        ...
        labelKey: 'integrations.providers.gateway_stripe.credentials.publishableKey.label',
        type: 'text',
        required: true,
        placeholder: 'pk_live_...',
        helpText: 'Stripe Dashboard -> Developers -> API keys. Copy the Publishable key for the same mode you use here (test or live).',
        helpTextKey: 'integrations.providers.gateway_stripe.credentials.publishableKey.help',
      },
      {
        key: 'secretKey',
        label: 'Secret Key',
        labelKey: 'integrations.providers.gateway_stripe.credentials.secretKey.label',
        type: 'secret',
        required: true,
        ...
        helpTextKey: 'integrations.providers.gateway_stripe.credentials.secretKey.help',
      },
      {
        key: 'webhookSecret',
        label: 'Webhook Signing Secret',
        labelKey: 'integrations.providers.gateway_stripe.credentials.webhookSecret.label',
        type: 'secret',
        required: true,
        placeholder: 'whsec_...',
        helpText: 'Use the Stripe endpoint signing secret that starts with whsec_, not your API key.',
        helpTextKey: 'integrations.providers.gateway_stripe.credentials.webhookSecret.help',
