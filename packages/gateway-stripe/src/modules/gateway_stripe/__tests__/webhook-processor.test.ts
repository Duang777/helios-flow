...
import { claimWebhookProcessing } from '@helios/core/modules/payment_gateways/lib/webhook-utils'
...
jest.mock('@helios/core/modules/payment_gateways/lib/webhook-utils', () => ({
