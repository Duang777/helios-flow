...
describe('Cache Service', () => {
  afterEach(() => {
    ...
    fs.rmSync(path.resolve('.helios/cache'), { recursive: true, force: true })
  })
  ...
  describe('Strategy selection', () => {
    ...
    it('should keep file-backed cache defaults under .helios', async () => {
      expect(DEFAULT_SQLITE_CACHE_PATH).toBe('.helios/cache/cache.db')
      expect(DEFAULT_JSON_FILE_CACHE_PATH).toBe('.helios/cache/cache.json')
    })
  })
