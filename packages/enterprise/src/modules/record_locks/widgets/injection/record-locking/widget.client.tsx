...
import { BACKEND_MUTATION_ERROR_EVENT } from '@helios/ui/backend/injection/mutationEvents'
import { registerRecordLockConflictHandler } from '@helios/ui/backend/conflicts'
...
} from '@helios/enterprise/modules/record_locks/notifications.handlers'
import {
  ChangedFieldsTable,
  type ChangeRow,
} from '@helios/core/modules/audit_logs/lib/display-helpers'
import {
...
} from '@helios/enterprise/modules/record_locks/lib/clientLockStore'
import { isUuid, resolveConflictId, runAcceptIncoming } from './conflictResolution'
import { isOptimisticLockFloorConflict } from '@helios/enterprise/modules/record_locks/lib/optimisticLockFloor'
...
const GLOBAL_RECORD_LOCK_OWNERS_KEY = '__heliosRecordLockWidgetOwners__'
...
export default function RecordLockingWidget({
  ...
  const topBannerTarget = mounted ? document.getElementById('helios-top-banners') : null
