...
import { ActionLog } from '@helios/core/modules/audit_logs/data/entities'
...
import { parseDecryptedFieldValue } from '@helios/shared/lib/encryption/tenantDataEncryptionService'
...
export function readRecordLockHeaders(headers: Headers): ParsedRecordLockHeaders {
  const raw = {
    resourceKind: trimToNull(headers.get('x-helios-record-lock-kind')) ?? undefined,
    resourceId: trimToNull(headers.get('x-helios-record-lock-resource-id')) ?? undefined,
    token: trimToNull(headers.get('x-helios-record-lock-token')) ?? undefined,
    baseLogId: trimToNull(headers.get('x-helios-record-lock-base-log-id')) ?? undefined,
    resolution: trimToNull(headers.get('x-helios-record-lock-resolution')) ?? undefined,
    conflictId: trimToNull(headers.get('x-helios-record-lock-conflict-id')) ?? undefined,
  }
