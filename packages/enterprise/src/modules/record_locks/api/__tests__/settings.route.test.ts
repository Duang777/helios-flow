import { GET, POST } from '@helios/enterprise/modules/record_locks/api/settings/route'
import { resolveRecordLocksApiContext } from '@helios/enterprise/modules/record_locks/api/utils'
