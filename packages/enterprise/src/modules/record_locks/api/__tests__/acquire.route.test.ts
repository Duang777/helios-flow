import { POST } from '@helios/enterprise/modules/record_locks/api/acquire/route'
import { resolveRecordLocksApiContext, resolveRequestIp } from '@helios/enterprise/modules/record_locks/api/utils'

jest.mock('@helios/enterprise/modules/record_locks/api/utils', () => ({
