...
import type { MfaProvider } from '@helios/enterprise/modules/security/types'
...
jest.mock('@helios/enterprise/modules/security/components/mfa-ui-registry', () => ({
...
jest.mock(
  '@helios/enterprise/modules/security/components/mfa-provider-list-items/RecoveryCodesListItem',
  () => ({
    __esModule: true,
...
jest.mock('@helios/ui/backend/DataTable', () => ({ DataTable: () => <div /> }))
jest.mock('@helios/ui/backend/EmptyState', () => ({ EmptyState: () => <div /> }))
jest.mock('@helios/ui/backend/detail', () => ({ LoadingMessage: () => <div /> }))
jest.mock('@helios/ui/backend/forms/FormHeader', () => ({ FormHeader: () => <div /> }))
jest.mock('@helios/enterprise/modules/security/components/MfaEnrollmentNotice', () => ({
  __esModule: true,
  default: () => null,
}))
jest.mock('@helios/enterprise/modules/security/components/hooks/useMfaStatus', () => ({
  useMfaStatus: () => ({ loading: false, methods: [], providers: [] }),
}))
jest.mock('@helios/enterprise/modules/security/lib/mfa-enrollment-notice', () => ({
