...
> Design system for Helios: audit of 160 pages, 34 modules, semantic tokens (OKLCH), component library (shadcn/ui + Radix + CVA), governance model. From foundations to adoption metrics.
