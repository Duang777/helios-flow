...
- **Lint tells you what's wrong BEFORE the reviewer does:** `helios-ds/require-empty-state` highlights the problem in your editor. You don't find out about it in a review after waiting 2 days.
