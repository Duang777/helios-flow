...
Helios is an open-source, AI-supportive CRM / ERP foundation framework for building secure, enterprise-grade business applications.

We help companies move beyond the limitations of rigid SaaS and the cost/risk of building everything from scratch. Helios provides the reusable 80% of enterprise software — architecture, security, modularity, workflows, data structures, permissions, developer experience, and AI-assisted engineering foundations — so teams can focus on the 20% of business logic that actually creates competitive advantage.

Helios is built in the spirit of modern AI Engineering. Alongside the core product, we are developing Harness AI, developer sandboxes, reusable AI skills, and delivery practices that allow teams to build, test, and evolve business software with coding agents instead of traditional manual implementation.

We are now looking for a senior person to join the Helios Core Team in a hybrid role:

- **Core Product Engineering** — improving Helios itself, its architecture, modules, DX, test coverage, AI skills, and product foundations.
- **Forward Deployed Engineering** — working directly with partners and key customers on real Helios implementations.
...
As a Senior AI Engineering / Forward Deployed Engineer in the Helios Core Team, you will:

- Work with partners and strategic customers on real Helios implementations.
- Translate business requirements into product specifications, architecture decisions, tasks, tests, and reusable patterns.
- Use implementation projects as a source of Product Learning and feed those insights back into the Helios core.
...
- Improve Helios's core architecture, modules, APIs, DX, and extensibility.
...
- Work directly with partners and key customers implementing Helios.
...
- Support teams in configuring, extending, and deploying Helios.
...
- Train developers and teams in AI-assisted software delivery with Helios, Harness AI, and sandbox environments.
...
Helios Core Team works differently from traditional software teams.
...
Helios is not just another framework. It is a practical answer to one of the biggest problems in enterprise software: every company needs custom business logic, but nobody wants to rebuild the same CRM, ERP, permissions, workflows, integrations, and developer foundations from zero.
...
Send your application to **[info@helios.com](mailto:info@helios.com)** and include:
...
- Why does the Helios Core Team sound interesting to you?

To let us review and respond to your application, your message **must include the following consent statement**:

> I consent to the processing of my personal data contained in my application (including my CV, LinkedIn profile, GitHub profile, and any other materials I provide) by Helios for the purpose of the current recruitment process, in accordance with Regulation (EU) 2016/679 (GDPR).

If you would also like us to keep your application on file for **future** recruitment, add this optional sentence as well:

> I additionally consent to the processing of my personal data for the purposes of future recruitment processes conducted by Helios.
...
- **Data controller.** The controller of your personal data is Helios. For any questions about how your data is processed, or to exercise your rights, contact us at **[info@helios.com](mailto:info@helios.com)**.
