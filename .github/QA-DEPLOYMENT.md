...
```
https://preview-{appName}-{uniqueId}.helios.com/backend
```
...
| Slot | URL |
|------|-----|
| qa1 | https://qa1.helios.com/backend |
| qa2 | https://qa2.helios.com/backend |
| qa3 | https://qa3.helios.com/backend |
| qa4 | https://qa4.helios.com/backend |
...
Any other app-specific secrets your tenant configuration requires can be added here too (see `apps/helios/.env.example`).
