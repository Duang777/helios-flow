...
![Sudo verification dialog](/screenshots/helios-security-sudo-challenge.png)
...
The following steps describe how to protect a custom module feature with sudo using `@helios/enterprise/modules/security`.
...
```ts
import type { SecuritySudoTarget } from '@helios/enterprise/modules/security'
...
import { requireSudo } from '@helios/enterprise/modules/security'
...
```tsx
import { SudoProvider } from '@helios/enterprise/modules/security'
...
import { useSudoChallenge } from '@helios/enterprise/modules/security'
