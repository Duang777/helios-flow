...
![Record locking settings page](/screenshots/helios-record-locking-settings.png)
...
![Active editors and notifications for a shared record](/screenshots/helios-record-locking-notifications.png)
...
![Conflict resolution modal with changed fields](/screenshots/helios-conflict.png)
