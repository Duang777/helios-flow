---
title: helios feature_toggles override-set-value
sidebar_label: override-set-value
description: Sets a feature toggle override for an tenant.
---

`yarn helios feature_toggles override-set-value` creates or updates a feature toggle override for a specific tenant.

## Usage

```bash
yarn helios feature_toggles override-set-value --identifier <id> --tenantId <uuid> --value <value>
```
