---
title: helios feature_toggles toggle-create
sidebar_label: toggle-create
description: Creates a new feature toggle.
---

`yarn helios feature_toggles toggle-create` creates a new feature toggle in the system.

## Usage

```bash
yarn helios feature_toggles toggle-create --identifier <id> --name <name> [options]
```
