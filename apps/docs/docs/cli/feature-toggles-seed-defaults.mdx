---
title: helios feature_toggles seed-defaults
sidebar_label: seed-defaults
description: Seeds default feature toggles from a JSON file.
---

`yarn helios feature_toggles seed-defaults` seeds the system with default feature toggles defined in a JSON file.

## Usage

```bash
yarn helios feature_toggles seed-defaults [--filePath <path>]
```
