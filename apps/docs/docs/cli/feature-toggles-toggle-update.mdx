---
title: helios feature_toggles toggle-update
sidebar_label: toggle-update
description: Updates an existing feature toggle.
---

`yarn helios feature_toggles toggle-update` updates the properties of an existing feature toggle.

## Usage

```bash
yarn helios feature_toggles toggle-update --identifier <id> [options]
```
