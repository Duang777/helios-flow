...
![Document numbers](/screenshots/helios-orders-settings-numbering.png)
...
![Order editing guards](/screenshots/helios-orders-settings-editing-guards.png)
...
![Payment methods](/screenshots/helios-orders-settings-payment-methods.png)
...
![Payment statuses](/screenshots/helios-orders-settings-payment-statuses.png)

## Shipping methods and shipment statuses

![Shipping methods](/screenshots/helios-orders-settings-shipping-methods.png)
...
![Shipment statuses](/screenshots/helios-orders-settings-shipment-statuses.png)

## Order statuses and line statuses

![Order statuses](/screenshots/helios-orders-settings-order-statuses.png)
...
![Order line statuses](/screenshots/helios-orders-settings-order-line-statuses.png)

## Adjustment kinds

![Adjustment kinds](/screenshots/helios-orders-settings-adjustment-kinds.png)

- Curate reusable kinds (Discount, Shipping, Tax, Surcharge, Custom). Kinds drive the adjustment dialog and reporting.

## Tax rates

![Tax rates](/screenshots/helios-orders-settings-tax-rates.png)
