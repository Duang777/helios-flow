...
description: Tour the Helios admin home and learn what operators see first.
---

Welcome to the Helios admin experience. This user guide introduces the primary screens your teams interact with day to day. Start here, then continue to specific topics like authentication, organizations, roles, and entities.

![Helios dashboard](/screenshots/helios-homepage.png)
