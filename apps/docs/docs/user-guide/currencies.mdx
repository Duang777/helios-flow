...
![Currencies screen](/screenshots/helios-currencies-all-results.png)
...
Helios includes built-in providers that fetch exchange rates automatically.
...
- Or use the CLI: `yarn helios currencies fetch-rates` (see CLI section below)
