...
description: Define, manage, and execute business logic and automation rules in Helios.
---
...
![Business Rules Overview](/screenshots/helios-business-rules-overview.png)
...
![Rules List View](/screenshots/helios-business-rules-list.png)
*Rules list page showing all defined business rules with filters and actions*

### Rule Types

Helios supports five rule types:
