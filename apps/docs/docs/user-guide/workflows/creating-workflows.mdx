...
description: Step-by-step guide to building your first workflow in Helios
---
...
![Workflow visual editor showing a sales order approval flow](/screenshots/helios-workflows-visual-editor.png)

*Workflow visual editor with a seeded sales order approval definition loaded from the Helios demo instance*
