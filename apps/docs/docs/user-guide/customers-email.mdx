...
You need at least one personal mailbox connected to Helios before you can send email from the CRM. The mailbox you connect is **yours alone** — Helios never reads another user's mailbox and never shares your emails with teammates unless you explicitly flip an email to "shared."
...
When an email arrives in your connected mailbox, Helios checks every address in the From, To, Cc, and Bcc fields against the primary email addresses of all People in your CRM. If one or more matches are found:
