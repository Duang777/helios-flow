...
Keep Helios secure by curating roles, features, and user-specific overrides. The Auth module ships dedicated admin pages for both roles and users so you can adjust access in one place.

![Managing roles and ACLs](/screenshots/helios-managing-roles.png)
...
![Editing a user ACL](/screenshots/helios-edit-user-and-acl.png)
