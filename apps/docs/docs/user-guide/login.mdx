...
description: How users access Helios, reset credentials, and switch organizations.
---
...
![Helios login](/screenshots/helios-login.png)
...
![Dashboard widgets overview](/screenshots/helios-dashboard.png)
