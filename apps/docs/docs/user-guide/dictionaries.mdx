...
![Dictionary overview screen](/screenshots/helios-dictionaries-manage.png)
...
![Editing dictionary entries](/screenshots/helios-dictionary-entry.png)
...
![Configuring a dictionary-backed custom field](/screenshots/helios-custom-fields-based-on-dictionaries.png)
...
- Save and run `yarn helios entities install --tenant <tenantId>` so definitions sync with your tenants.
...
![Customer profile showing dictionary-driven fields](/screenshots/helios-customer-dictionaries.png)
