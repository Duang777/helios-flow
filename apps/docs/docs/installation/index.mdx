...
Scaffold a standalone project that pulls Helios packages from npm. Your modules, overrides, and customisations live in your repo while the core stays untouched and upgradeable.
...
Deploy a standalone app with `helios deploy railway`. The repeatable CLI flow provisions PostgreSQL, Redis, the app service, an optional worker, environment variables, and a public domain.

[Open guide →](/deployment/railway)
