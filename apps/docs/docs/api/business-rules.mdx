...
- **TypeScript/JavaScript**: `@helios/api-client`
- **Python**: `helios` (PyPI)
- **Go**: `github.com/helios/go-client`

Install and use:

```typescript
import { BusinessRulesClient } from "@helios/api-client";
...
- Header: `X-Helios-Event: rule.executed`
- Header: `X-Helios-Signature: hmac-sha256-signature`
