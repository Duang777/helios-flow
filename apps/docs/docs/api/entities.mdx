...
Entity extensibility is central to Helios. Every endpoint published by the module lives under `/api/entities/*`; the tables below list the suffix you append to your API origin.

```bash
export BASE_URL="http://localhost:3000/api"
export API_KEY="<paste your API key secret here>"
export ENTITY_ID="example.todo"              # generated or custom entity id
export CUSTHELIOS_ENTITY_ID="<uuid from POST /entities/entities>"
