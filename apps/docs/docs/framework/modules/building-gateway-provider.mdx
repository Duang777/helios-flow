...
Add the package to `apps/helios/src/modules.ts` to enable it.
...
```ts
import type { IntegrationDefinition } from '@helios/shared/modules/integrations/types'
...
export const integration: IntegrationDefinition = {
  ...
  icon: 'myprovider',
  package: '@helios/gateway-myprovider',
  version: '1.0.0',
  author: 'Your Name',
...
```ts
import type { Job } from '@helios/queue'
import type { WorkerContext, WorkerMeta } from '@helios/shared/modules/registry'
...
1. Add the package to `apps/helios/src/modules.ts`.
...
The `@helios/gateway-stripe` package is the reference implementation. It demonstrates:
