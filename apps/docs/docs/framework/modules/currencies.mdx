...
```typescript
import type { ExchangeRateService } from '@helios/modules/currencies/services/exchangeRateService'
...
```typescript
import type { RateFetchingService } from '@helios/modules/currencies/services/rateFetchingService'
...
```typescript
import { NBPProvider } from '@helios/modules/currencies/services/providers/nbp'
...
```typescript
import { RaiffeisenProvider } from '@helios/modules/currencies/services/providers/raiffeisen'
...
```typescript
import type { RateProvider, RateProviderResult } from '@helios/modules/currencies/services/providers/base'
...
```bash
# Fetch for today
yarn helios currencies fetch-rates

# Fetch for specific date
yarn helios currencies fetch-rates --date 2024-01-15

# Fetch for date range
yarn helios currencies fetch-rates --from 2024-01-01 --to 2024-01-31
```

### List Providers

```bash
yarn helios currencies list-providers
```
...
```typescript
import { createCurrency, updateCurrency, deleteCurrency } from '@helios/modules/currencies/commands/currencies'
import { createExchangeRate, updateExchangeRate, deleteExchangeRate } from '@helios/modules/currencies/commands/exchange-rates'
...
```typescript
import { currencyCreateSchema, exchangeRateCreateSchema } from '@helios/modules/currencies/data/validators'
...
Enable in `apps/helios/src/modules.ts`:
