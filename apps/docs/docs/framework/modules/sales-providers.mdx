...
import { registerPaymentProvider } from '@helios/core/modules/sales/lib/providers'
...
```ts
// src/modules/your-module/index.ts
import { registerShippingProvider } from '@helios/core/modules/sales/lib/providers'
...
```ts
import { registerStripeProvider } from '@helios/core/modules/sales/lib/providers'
