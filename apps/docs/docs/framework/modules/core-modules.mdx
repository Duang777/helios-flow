---
title: Core Modules
description: All built-in modules shipped with Helios core — purpose, scope, and key capabilities.
---

# Core Modules

Helios ships with the following built-in modules in `@helios/core`. Each module is independently enabled in `apps/helios/src/modules.ts`.
