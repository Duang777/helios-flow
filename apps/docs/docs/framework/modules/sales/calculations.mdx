...
import { registerSalesLineCalculator } from '@helios/core/modules/sales/lib/calculations'
...
```ts
// src/modules/your-module/index.ts
import { registerSalesTotalsCalculator } from '@helios/core/modules/sales/lib/calculations'
