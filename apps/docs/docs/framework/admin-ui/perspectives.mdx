...
Both permissions are seeded by `helios auth setup`. If you introduce new roles manually, remember to add the features to their ACLs.
...
import { fetchInitialPerspectiveState } from '@helios/core/modules/perspectives/utils/initialState'
