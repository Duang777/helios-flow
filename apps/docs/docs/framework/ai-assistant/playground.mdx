...
The playground also includes a **Tools** tab with search and module grouping. It lists every AI tool visible to the caller, marks which ones are whitelisted on the selected agent, and labels read/write, bulk, and destructive tools for quick review before a demo.
