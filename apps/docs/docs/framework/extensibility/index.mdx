...
description: Complete map of what can be extended in Helios today, including UMES coverage and integration enhancement paths.
---

This directory is a practical map of Helios extension surfaces.
...
When you run `yarn generate`, extension points are discovered and wired into generated registries in `apps/helios/.helios/generated/`.
