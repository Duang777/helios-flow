...
```ts
import { getEnrichersForEntity } from '@helios/shared/lib/crud/enricher-registry'
...
import type { SyncQueryEventPayload, SyncQueryEventResult } from '@helios/shared/lib/query/sync-query-event-types'
...
| Type | Import |
|------|--------|
| `QueryExtensionsConfig` | `@helios/shared/lib/query/types` |
| `EnricherQueryEngineConfig` | `@helios/shared/lib/crud/response-enricher` |
| `EnricherSurfaceSelector` | `@helios/shared/lib/crud/enricher-registry` |
| `SyncQueryEventPayload` | `@helios/shared/lib/query/sync-query-event-types` |
| `SyncQueryEventResult` | `@helios/shared/lib/query/sync-query-event-types` |
