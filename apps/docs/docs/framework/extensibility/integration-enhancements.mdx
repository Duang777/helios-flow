...
This page focuses on extension points used to integrate Helios with external systems.
...
Import: `import { InjectionWizard } from '@helios/ui/backend/injection/InjectionWizard'`
...
Import: `import { StatusBadgeRenderer } from '@helios/ui/backend/injection/StatusBadgeRenderer'`
