...
description: Step-by-step guide to creating new REST APIs in helios with practical examples.
---

# Building API Modules

This workflow provides a practical, step-by-step guide to creating new APIs in helios. We'll create a complete "Tasks" module as an example, covering all components from data model to API endpoints.
...
import { E } from "@helios/core/generated/entities.ids.generated";
...
import { createTestContext } from "@helios/shared/lib/test";
import { executeCommand } from "@helios/shared/lib/commands";
...
This workflow provides a complete guide to creating robust, scalable APIs in helios with all the necessary components working together.
