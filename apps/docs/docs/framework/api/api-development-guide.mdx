...
description: Complete guide to creating REST APIs in helios with CRUD factory, commands, custom fields, and OpenAPI generation.
---

# API Development Guide

This guide provides a comprehensive overview of creating REST APIs in the helios application. It covers the key components: CRUD factory, commands, query engine, custom fields, and OpenAPI generation.
...
- **Profile slow queries** with `HELIOS_PROFILE=*`
