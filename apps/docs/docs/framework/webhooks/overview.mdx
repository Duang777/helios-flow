...
Helios provides a built-in webhook system compliant with the [Standard Webhooks](https://www.standardwebhooks.com/) specification. The webhooks module enables:
...
If you're building a service that receives webhooks from Helios, verify the signature to ensure authenticity:
...
import {
  ...
  parseWebhookSecret,
} from '@helios/shared/lib/webhooks'
```
...
- [SPEC-057 — Webhooks Module](https://github.com/helios/helios/issues/257) — full technical specification
