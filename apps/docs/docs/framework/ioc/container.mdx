...
Helios uses [Awilix](https://github.com/jeffijoe/awilix) to assemble services at runtime. Each HTTP request, background job, or CLI command spins up a scoped container with core services and module contributions.
