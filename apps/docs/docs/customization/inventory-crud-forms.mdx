...
```bash
mkdir -p apps/helios/src/modules/inventory/backend/inventory/create
touch apps/helios/src/modules/inventory/backend/inventory/create/page.tsx
touch apps/helios/src/modules/inventory/backend/inventory/create/page.meta.ts
```

```tsx title="apps/helios/src/modules/inventory/backend/inventory/create/page.tsx"
import { CrudForm } from '@helios/ui/backend/CrudForm';
import type { CrudFormSchema } from '@helios/ui/backend/CrudForm/types';
...
```ts title="apps/helios/src/modules/inventory/backend/inventory/create/page.meta.ts"
...
```bash
mkdir -p apps/helios/src/modules/inventory/backend/inventory/[id]/edit
touch apps/helios/src/modules/inventory/backend/inventory/[id]/edit/page.tsx
touch apps/helios/src/modules/inventory/backend/inventory/[id]/edit/page.meta.ts
```

```tsx title="apps/helios/src/modules/inventory/backend/inventory/[id]/edit/page.tsx"
import { CrudForm } from '@helios/ui/backend/CrudForm';
import type { CrudFormSchema } from '@helios/ui/backend/CrudForm/types';
import { readApiResultOrThrow } from '@helios/ui/backend/utils/apiCall';
import type { UpsertInventoryItemInput } from '../../../data/validators';
...
```ts title="apps/helios/src/modules/inventory/backend/inventory/[id]/edit/page.meta.ts"
import type { PageMetadata } from '@helios/shared/modules/registry';
