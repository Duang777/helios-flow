...
const screenshots = [
  {
    src: '/screenshots/helios-homepage.png',
    alt: 'Helios dashboard overview',
  },
  {
    src: '/screenshots/helios-users-management.png',
    alt: 'Users management list',
  },
  {
    src: '/screenshots/helios-define-custom-fields.png',
    alt: 'Custom fields configuration',
  },
  {
    src: '/screenshots/helios-custom-entity-records.png',
...
const gettingStartedLinks = [
  {
    ...
    description: 'Scaffold a new project with npx create-helios-app — the fastest way to start building.',
  ...
  },
  {
    ...
    description: 'See how teams ship CRMs, ERPs, and commerce backends on Helios.',
  ...
  return (
    <header className="hero hero--primary">
      <div className="container">
        <h1 className="hero__title">Welcome to Helios</h1>
        <p className="hero__subtitle">
          Helios is a new‑era, AI‑supportive ERP foundation framework.
        </p>
        <p>
  ...
  return (
    <Layout>
      <Head>
        <meta
          name="description"
          content="Documentation for the Helios framework covering modules, APIs, data extensibility, and admin customization."
        />
      </Head>
      <HomepageHeader />
      <main>
