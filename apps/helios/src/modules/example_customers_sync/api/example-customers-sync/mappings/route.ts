...
import { CustomerInteraction } from '@helios/core/modules/customers/data/entities'
import { loadCustomerSummaries } from '@helios/core/modules/customers/lib/interactionReadModel'
