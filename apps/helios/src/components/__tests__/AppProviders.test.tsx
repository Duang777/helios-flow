...
jest.mock('@helios/ui/theme/ThemeProvider', () => ({
  ThemeProvider: ({ children }: { children: React.ReactNode }) => <>{children}</>,
}))

jest.mock('@helios/ui/theme/QueryProvider', () => ({
  QueryProvider: ({ children }: { children: React.ReactNode }) => <>{children}</>,
}))

jest.mock('@helios/ui/frontend/Layout', () => ({
  FrontendLayout: ({ children }: { children: React.ReactNode }) => <div data-testid="frontend-layout">{children}</div>,
}))

jest.mock('@helios/ui/frontend/AuthFooter', () => ({
