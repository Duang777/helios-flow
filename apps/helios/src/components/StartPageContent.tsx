...
import { getApiDocsResources } from '@helios/core/modules/api_docs/lib/resources'
  ...
  return (
    <>
      <section className="rounded-lg border bg-gradient-to-br from-background to-muted/20 p-8 text-center">
        <h2 className="text-2xl font-semibold mb-3">{t('startPage.welcome.title', 'Welcome to Your Helios Installation')}</h2>
        <p className="text-muted-foreground max-w-2xl mx-auto">
          {t('startPage.welcome.description', 'This is a customizable start page for your fresh Helios installation. Choose your role below to get started and explore the features available to you.')}
        </p>
      </section>
            ...
            <div className="space-y-3">
              <div>
                ...
                <p className="text-sm text-status-success-text/90">
                  {t('startPage.onboarding.description', 'Create a tenant, organization, and administrator account in minutes. We\'ll verify your email and deliver a pre-seeded environment so you can explore Helios with real data.')}
                </p>
              </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-status-info-text">
              ...
              <code className="px-1.5 py-0.5 rounded border border-status-info-border/70 bg-background/70 font-mono text-xs text-foreground">yarn helios auth set-password --email &lt;email&gt; --password &lt;newPassword&gt;</code>
          ...
          <RoleTile
            ...
            disabledMessage={
              <>
                ...
                {t('startPage.roles.superAdmin.disabledMessage2', 'Install Helios locally for full access via')}{' '}
                <a
                  href="https://github.com/helios"
                  target="_blank"
                  rel="noreferrer"
