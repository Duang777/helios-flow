...
import { AuthSessionGuard } from '@helios/ui/backend/AuthSessionGuard'
import { IconButton } from '@helios/ui/primitives/icon-button'
import { Popover, PopoverContent, PopoverTrigger } from '@helios/ui/primitives/popover'
import { IntegrationsButton } from '@helios/ui/backend/IntegrationsButton'
...
const LazyAiChatHeaderButton = dynamic(
  () => import('@helios/ai-assistant/frontend').then((module) => module.AiChatHeaderButton),
  { ssr: false, loading: () => null },
)
const LazyTopbarSearchInline = dynamic(
  () => import('@helios/search/modules/search/frontend').then((module) => module.TopbarSearchInline),
  { ssr: false, loading: () => null },
)
...
const LazyMessagesIcon = dynamic(
  () => import('@helios/ui/backend/messages').then((module) => module.MessagesIcon),
  { ssr: false, loading: () => null },
)
