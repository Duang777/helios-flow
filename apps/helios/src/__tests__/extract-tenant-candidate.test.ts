...
import { forbidden } from '@helios/shared/lib/crud/errors'
...
jest.mock('@/.helios/generated/api-routes.generated', () => ({
  apiRoutes: [],
}))
...
jest.mock('@helios/core/modules/auth/lib/tenantAccess', () => {
  const actual = jest.requireActual('@helios/core/modules/auth/lib/tenantAccess')
