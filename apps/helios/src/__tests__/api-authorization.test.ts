...
import type { ApiRouteManifestEntry, HttpMethod } from '@helios/shared/modules/registry'
...
jest.mock('@helios/shared/modules/registry', () => {
  const actual = jest.requireActual('@helios/shared/modules/registry')
  return {
    ...actual,
...
import { registerModules } from '@helios/shared/lib/i18n/server'
