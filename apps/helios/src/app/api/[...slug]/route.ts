...
import { findApiRouteManifestMatch, getApiRouteManifests, registerApiRouteManifests, type HttpMethod } from '@helios/shared/modules/registry'
import { isCrudHttpError } from '@helios/shared/lib/crud/errors'
import { apiRoutes } from '@/.helios/generated/api-routes.generated'
import { resolveAuthFromRequestDetailed } from '@helios/shared/lib/auth/server'
...
import { resolveFeatureCheckContext } from '@helios/core/modules/directory/utils/organizationScope'
import { enforceTenantSelection, normalizeTenantId } from '@helios/core/modules/auth/lib/tenantAccess'
import { runWithCacheTenant } from '@helios/cache'
...
import { getGlobalEventBus } from '@helios/shared/modules/events'
import { applicationLifecycleEvents, type ApplicationLifecycleEventId } from '@helios/shared/lib/runtime/events'
import { withModuleResourceUsage } from '@helios/shared/lib/modules/resource-usage'
