import { modules } from '@/.helios/generated/modules.app.generated'
  ...
  return (
    <main className="min-h-svh w-full p-8 flex flex-col gap-8">
      <header className="flex flex-col md:flex-row md:items-center gap-4 md:gap-6">
        <Image
          src="/helios.svg"
          alt={t('app.page.logoAlt', 'Helios')}
          width={40}
          height={40}
          priority
         className="dark:invert" />
        <div className="flex-1">
          <h1 className="text-3xl font-semibold tracking-tight">{t('app.page.title', 'Helios')}</h1>
