...
import { findRouteManifestMatch, registerBackendRouteManifests } from '@helios/shared/modules/registry'
...
import { hasAllFeatures } from '@helios/shared/lib/auth/featureMatch'
import { profilePathPrefixes } from '@helios/core/modules/auth/lib/profile-sections'
...
export default async function BackendLayout({
  ...
  const baseProductName = translate('appShell.productName', 'Helios')
