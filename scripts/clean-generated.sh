...
# Clean .helios folders (Next.js app generated files)
find . -type d -name '.helios' -not -path '*/node_modules/*' -exec rm -rf {} + 2>/dev/null || true
...
echo "Done! Cleaned: .helios, generated/, .turbo, .next, dist/"
