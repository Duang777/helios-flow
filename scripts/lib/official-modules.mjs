...
//   apps/helios/src/official-modules.generated.ts — compiled output consumed by modules.ts
//
// Module-id convention: npm package `@helios/<suffix>` maps to module id `<suffix>`
// with dashes converted to underscores (mirrors `@helios/ai-assistant` -> `ai_assistant`).
...
export const DEFAULT_CONFIG = {
  repo: 'https://github.com/helios/official-modules.git',
...
export function renderGenerated(activated) {
  ...
  return (
    ...
    '//\n' +
    '// Why is this file in src/ and not under .helios/generated/?\n' +
