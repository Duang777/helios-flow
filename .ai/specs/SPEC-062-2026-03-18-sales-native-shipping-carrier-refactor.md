...
**GitHub issue**: Related to [#864](https://github.com/helios/helios/issues/864) (shipping equivalent of SPEC-058)
...
1. Add `@deprecated` JSDoc to `registerShippingProvider` and `getShippingProvider` in `sales/lib/providers/registry.ts`:
   ```typescript
   /**
    * @deprecated Use `registerShippingAdapter` from `@helios/core/modules/shipping_carriers`
