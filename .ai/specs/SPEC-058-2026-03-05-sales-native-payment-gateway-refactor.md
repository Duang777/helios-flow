...
**npm name:** `@helios/gateway-wire-transfer`
...
### Phase 3a
- New npm package (`@helios/gateway-wire-transfer`) — opt-in installation.
- No changes to existing entities or contracts.

### Phase 3b
- New npm package (`@helios/gateway-cash`) — opt-in installation.
- No changes to existing entities or contracts.
