...
- `@helios/ui` DataTable suite: 8 suites / 34 tests green (incl. the 2 new unit specs). TC-CRM-086 green against the dev server. Manually verified in-browser: persisted width applies to header + body cells after reload.
