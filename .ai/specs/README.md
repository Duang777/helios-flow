...
This folder contains specifications and Architecture Decision Records (ADRs) that serve as the source of truth for design decisions and module behavior in Helios.
...
| [SPEC-068](SPEC-068-2026-03-02-use-case-examples-framework.md) | 2026-03-02 | Use-Case Examples Framework | `create-helios-app --example` pattern for bootstrapping use-case solutions |
...
| [Snapshots](2026-03-21-helios-develop-snapshot-release.md) | 2026-03-21 | Develop Snapshot Release | Develop branch snapshot release workflow |
...
| [Backend Route Collision Guard](2026-07-23-backend-route-collision-guard.md) | 2026-07-23 | Backend Route Collision Guard | Build-time `helios generate` guard that fails loud when two modules emit the same backend page URL (folder-derived), mirroring the duplicate-command-id guard; route overrides unaffected |
...
| [SPEC-050](implemented/SPEC-050-2026-02-26-dev-container-setup.md) | 2026-02-26 | Dev Container Setup | VS Code Dev Container configuration for Helios |
...
| [SPEC-057](implemented/SPEC-057-2026-03-05-standalone-app-ai-folder.md) | 2026-03-05 | Standalone App `.ai` Folder | Dedicated `.ai/` folder for `create-helios-app` template with adapted skills and UMES reference docs |
...
- [Architecture Guide](https://docs.helios.com/architecture/system-overview)
...
- **Documentation**: Browse the full documentation at [docs.helios.com](https://docs.helios.com/)
