...
**Scope:** OSS
**Status:** Draft
**Tracking issue:** [#3857](https://github.com/helios/helios/issues/3857)
...
| `entities/migrations/*` + `.snapshot-helios.json` | scoped migration for the new column |
...
- [x] Migration `Migration20260716120000` + snapshot reviewed — additive
      ...
      snapshot left untouched; active snapshot is `.snapshot-helios`).
