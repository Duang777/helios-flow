...
**Depends on**: [helios/helios#414](https://github.com/helios/helios/issues/414) (Messages module)  
**Related**: [SPEC-045](SPEC-045-2026-02-24-integration-marketplace.md) (Integration Marketplace), [SPEC-045d](SPEC-045d-communication-notification-hubs.md) (Communication & Notification Hubs), [Issue #676](https://github.com/helios/helios/issues/676) (Integrations panel)  
...
**Key Points:**
- Integrate external customer communication via WhatsApp with Helios.
...
- **No history in-app:** There is no conversation history from WhatsApp inside Helios, making it hard to audit or link to deals/orders.
...
4. **Integration with Messages module (#414)**
   - Implementation waits for PR/merge of helios/helios#414.
...
- **Operator** wants to see WhatsApp conversation history in Helios so that they have one place for all customer communication.
...
### 2026-02-22
- Initial specification (skeleton). Depends on helios/helios#414. Extends messaging with WhatsApp and AI summary + tiered reply (easy vs complex).
