...
> **Market Reference**: The closest reference model is the dedicated lead object found in Salesforce, HubSpot, and OroCRM. Helios should adopt the dedicated pre-CRM object and explicit conversion lineage, while keeping implementation aligned with existing `customers` CRUD, command, event, dictionary, and UI patterns.
