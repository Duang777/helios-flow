...
Helios Sandboxes are pre-provisioned cloud environments with Helios pre-installed (in dev mode) and AI coding agents wired in — for learning and building on Helios with no local setup. A sandbox boots in about 30 seconds.

- The full Helios framework in dev mode (entities, modules, generators, hot reload) on an industry-standard stack (TypeScript, React, Next.js, Postgres) — no proprietary lock-in, so skills transfer to real work.
...
Public waitlist: https://sandboxes.helios.com.
