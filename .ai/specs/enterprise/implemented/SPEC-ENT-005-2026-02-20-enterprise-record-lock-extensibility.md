...
## Overview
The original document described mutation guard extensibility with record-lock examples. The implemented contract is generic and shared (`@helios/shared`), so it belongs to OSS scope rather than Enterprise-only scope.
