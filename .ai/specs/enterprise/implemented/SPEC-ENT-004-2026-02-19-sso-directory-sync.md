# SPEC-ENT-004: SSO & Directory Sync Module for @helios/enterprise
...
| Group/role sync | N/A | IdP groups → roles in Helios |
...
| `sso_group_role_mappings` | IdP group → Helios role | `sso_config_id`, `idp_group_id`, `role_id` |
