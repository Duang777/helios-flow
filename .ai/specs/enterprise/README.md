...
This directory contains specifications for Helios Enterprise Edition features.

These features are commercial and are not released under the open source license used by the main Helios repository.
...
| [Health Endpoints](SPEC-ENT-002-2026-02-17-helios-health-endpoints.md) | 2026-02-17 | Enterprise Health Endpoints | Liveness (`/api/health/live`) and readiness (`/api/health/ready`) endpoints for deployment orchestration |
...
| [Sandboxes](Sandboxes.md) | — | Sandboxes | One-click cloud dev/build environments with Helios and coding agents preinstalled |
