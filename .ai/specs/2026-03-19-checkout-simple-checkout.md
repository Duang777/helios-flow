...
**Key Points:**
- Extends the existing `@helios/checkout` package (Phase A) with cart-based checkout — merchants define products/services on a link, and customers see a one-page checkout with items, totals, and payment.
...
```
┌────────────────────────────────────────────────────────────────────────┐
│  @helios/checkout (Phase B additions)                            │
│                                                                        │
