...
Helios already has the core primitives:
...
3. Enqueue a module worker through `@helios/queue`.
...
1. Use shared frontend progress events from `@helios/shared/lib/frontend/progressEvents`.
