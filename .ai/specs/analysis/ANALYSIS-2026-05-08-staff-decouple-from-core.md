...
2. **Open the Phase 3 spec** (delete-staff-from-core) once `@helios/staff` is published in `official-modules` and verified in a sandbox. Out-of-scope cleanup items (nav string refs, test fixtures) move under Phase 3.
