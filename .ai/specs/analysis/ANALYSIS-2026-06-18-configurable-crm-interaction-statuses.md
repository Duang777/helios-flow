...
in this prep pass). No major revision needed. Implement with `helios-implement-spec` or
`helios-auto-fix-github 3230`; Phase order as written. The contract-surface touch is limited to the
