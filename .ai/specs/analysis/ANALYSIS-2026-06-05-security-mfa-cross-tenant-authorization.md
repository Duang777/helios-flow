...
|------|----------|-----------|
| Reuse wildcard-aware `resolveIsSuperAdmin` / `enforceTenantSelection` | § A/§ B | ✅ Available from `@helios/core/modules/auth/lib/tenantAccess`; enterprise already imports core. Don't hand-roll superadmin checks. |
