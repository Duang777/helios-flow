...
| Shopify Field | Helios Entity/Field | Mapping | Notes |
|---------------|--------------------------|---------|-------|
...
| Shopify Concept | Helios Equivalent | Status |
|-----------------|------------------------|--------|
...
The Helios integration framework (SPEC-045) is well-designed for a Shopify connector. The bundle pattern, DataSyncAdapter contract, credential management, webhook handling, and progress tracking all fit the Shopify use case directly.
