...
**Date:** 2026-04-13
**Status:** Analysis
**Source:** [PR #1222](https://github.com/helios/helios/pull/1222) (closed — superseded by the official spec)
...
**Recommended adoption path:**
- Extract the model factory pattern from the existing `inbox_ops/lib/llmProvider.ts` into a shared utility inside `@helios/ai-assistant`.
