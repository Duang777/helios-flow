...
- result: `.helios/generated/modules.cli.generated.ts` lost worker entries and degraded subscriber metadata
...
- `helios queue worker --all` reported no queues
...
- [module-registry.ts](../../packages/cli/src/lib/generators/module-registry.ts)
- [helios.ts](../../packages/cli/src/helios.ts)
