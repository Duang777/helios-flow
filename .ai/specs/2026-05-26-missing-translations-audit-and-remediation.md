...
**Owner:** platform / i18n
**Date:** 2026-05-26
**Tracking issue:** [helios/helios#2077](https://github.com/helios/helios/issues/2077)
...
**Deliverables:**
1. `scripts/i18n-check-hardcoded.ts` — scans `.ts`/`.tsx` under `packages/**/src` and `apps/helios/src/modules/**` for:
