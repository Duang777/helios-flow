...
| `apps/helios/src/modules/example/backend/customer-tasks/page.tsx` | Delete | Remove duplicate route owner to avoid path collision |
| `apps/helios/src/modules/example_customers_sync/index.ts` | Create | Module metadata |
| `apps/helios/src/modules/example_customers_sync/acl.ts` | Create | Feature declarations |
| `apps/helios/src/modules/example_customers_sync/di.ts` | Create | Service/worker wiring via DI |
| `apps/helios/src/modules/example_customers_sync/events.ts` | Create | Sync module event declarations |
| `apps/helios/src/modules/example_customers_sync/data/entities.ts` | Create | Mapping entity |
| `apps/helios/src/modules/example_customers_sync/data/validators.ts` | Create | zod schemas for APIs/commands |
| `apps/helios/src/modules/example_customers_sync/subscribers/*` | Create | Cross-module event handlers |
| `apps/helios/src/modules/example_customers_sync/workers/*` | Create | Retryable sync workers |
| `apps/helios/src/modules/example_customers_sync/api/get/mappings/route.ts` | Create | Mapping inspection API |
| `apps/helios/src/modules/example_customers_sync/api/post/reconcile/route.ts` | Create | Reconciliation trigger API |
| `apps/helios/src/modules.ts` | Modify | Register new extension module |
