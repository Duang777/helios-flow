...
import { ExampleCustomerPriority } from '@helios/core/modules/example/data/entities'
...
import type { InjectionFieldWidget } from '@helios/shared/modules/widgets/injection'
...
- [x] Playwright scenarios TC-UMES-CF01..CF05 covered in `apps/helios/src/modules/example/__integration__/TC-UMES-004.spec.ts`
