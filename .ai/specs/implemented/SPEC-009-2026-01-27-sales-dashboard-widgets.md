...
- Generated registry: `apps/helios/.helios/generated/dashboard-widgets.generated.ts`
- Module ID: `sales`
...
import type { DashboardWidgetComponentProps } from '@helios/shared/modules/dashboard/widgets'
...
import { formatCurrency } from '@helios/shared/lib/format/currency'
import { formatRelativeDate } from '@helios/shared/lib/format/date'
...
```typescript
import type { DashboardWidgetModule } from '@helios/shared/modules/dashboard/widgets'
...
Default admin roles should be granted these features during `helios init`:
...
- Generate: `apps/helios/.helios/generated/dashboard-widgets.generated.ts`
...
import { bootstrapTest } from '@helios/shared/lib/testing/bootstrap'
