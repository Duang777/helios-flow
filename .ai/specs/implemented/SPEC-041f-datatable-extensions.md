...
import type { InjectionColumnWidget } from '@helios/shared/modules/widgets/injection'
...
import { InjectionPosition } from '@helios/shared/modules/widgets/injection-position'
import type { InjectionRowActionWidget } from '@helios/shared/modules/widgets/injection'
...
- [x] Dedicated unit/integration tests for column/action/filter/bulk extension behavior added in `packages/ui/src/backend/__tests__/DataTable.extensions.test.tsx` and `apps/helios/src/modules/example/__integration__/TC-UMES-004.spec.ts`
