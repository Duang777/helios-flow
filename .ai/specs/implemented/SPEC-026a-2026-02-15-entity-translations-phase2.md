...
**Date**: 2026-02-15
**Status**: Proposed
**Issue**: [#527](https://github.com/helios/helios/issues/527)
**Feedback**: [pkarw comment, Feb 14](https://github.com/helios/helios/issues/527)
...
|-----------|--------|-------|
| `Button` | `@helios/ui/primitives/button` | Save, locale tab actions |
| `LoadingMessage` | `@helios/ui/backend/detail` | Loading state |
| `ErrorMessage` | `@helios/ui/backend/detail` | Error state with retry |
| `flash()` | `@helios/ui/backend/FlashMessages` | Success/error toasts |
| `apiCall`/`readApiResultOrThrow` | `@helios/ui/backend/utils/apiCall` | API calls |
| `useT()` | `@helios/shared/lib/i18n/context` | i18n |
| `useOrganizationScopeVersion()` | `@helios/shared/lib/frontend/useOrganizationScope` | Cache key scoping |
| `getEntityFields()` | `#generated/entity-fields-registry` | Static field discovery |
| `useCustomFieldDefs()` | `@helios/ui/backend/utils/customFieldDefs` | Dynamic CF field discovery |
