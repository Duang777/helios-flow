...
- Reproduced on April 12, 2026: removing `example` from [`apps/helios/src/modules.ts`](/Users/mariuszlewczuk/Projects/omML/apps/helios/src/modules.ts:52) and running `yarn generate` followed by `yarn workspace @helios/app typecheck` still fails.
- The current failure is broader than issue #601 originally described:
  - missing generated entity modules such as `@/.helios/generated/entities/todo`
...
- The root problem is not only generator output. The app TypeScript program still includes all `src/modules/**` source files via [`apps/helios/tsconfig.json`](/Users/mariuszlewczuk/Projects/omML/apps/helios/tsconfig.json:14), while generation only emits artifacts for enabled modules.
...
Issue [#601](https://github.com/helios/helios/issues/601) reports that disabling the Example module causes the app build to fail. This remains reproducible in the current codebase.
...
1. Remove `{ id: 'example', from: '@app' }` from [`apps/helios/src/modules.ts`](/Users/mariuszlewczuk/Projects/omML/apps/helios/src/modules.ts:52).
2. Run `yarn generate`.
3. Run `yarn workspace @helios/app typecheck`.
...
- [`apps/helios/src/modules/example/api/todos/route.ts`](/Users/mariuszlewczuk/Projects/omML/apps/helios/src/modules/example/api/todos/route.ts:6) imports `@/.helios/generated/entities/todo` (field selectors) and reads `E.example.todo` at 6 call sites
- [`apps/helios/src/modules/example/api/customer-priorities/route.ts`](/Users/mariuszlewczuk/Projects/omML/apps/helios/src/modules/example/api/customer-priorities/route.ts:5) imports `@/.helios/generated/entities/example_customer_priority` and reads `E.example.example_customer_priority` at 2 call sites
- [`apps/helios/src/modules/example/commands/todos.ts`](/Users/mariuszlewczuk/Projects/omML/apps/helios/src/modules/example/commands/todos.ts:19) imports `E` and reads `E.example.todo` at 9 call sites (lines 63, 65, 71, 99, 163, 220, 306, 425, 535) — the heaviest user
- [`apps/helios/src/modules/example/cli.ts`](/Users/mariuszlewczuk/Projects/omML/apps/helios/src/modules/example/cli.ts:7) imports `E` and reads `E.example.todo` at line 110
- [`apps/helios/src/modules/example_customers_sync/lib/sync.ts`](/Users/mariuszlewczuk/Projects/omML/apps/helios/src/modules/example_customers_sync/lib/sync.ts:16) imports `E` via relative path and reads `E.example.todo` at line 315

Additionally, [`apps/helios/src/modules/example_customers_sync/lib/sync.ts`](/Users/mariuszlewczuk/Projects/omML/apps/helios/src/modules/example_customers_sync/lib/sync.ts:17) has a direct source import `import { Todo } from '../../example/data/entities'`. This does not cause a typecheck failure (entity source files exist regardless of enablement), but it represents tight cross-module coupling and a runtime dependency.

Note: [`apps/helios/src/modules/example/api/organizations/route.ts`](/Users/mariuszlewczuk/Projects/omML/apps/helios/src/modules/example/api/organizations/route.ts:3) also imports from generated files, but uses `E.directory.organization` and `@/.helios/generated/entities/organization` — both from the always-enabled directory module. It does not break when example is disabled.
...
Audit `apps/helios/src/modules/example/**` for:

- imports from `@/.helios/generated/entities/*`
...
- `apps/helios/src/modules/example/api/*`
- `apps/helios/src/modules/example/commands/*`
- `apps/helios/src/modules/example/cli.ts`
- `apps/helios/src/modules/example_customers_sync/**/*`
...
- `yarn generate`
- `yarn workspace @helios/app typecheck`
