...
Helios currently stores and processes mostly qty-centric line quantities. The platform already has a shared dictionary `unit`, and sales lines already persist `quantityUnit`, but there is no canonical conversion system that ties products, pricing, and documents together end-to-end.
