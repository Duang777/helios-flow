...
```typescript
import { lazyDashboardWidget, type DashboardWidgetModule } from '@helios/shared/modules/dashboard/widgets'
...
| Feature Helper | `@helios/shared/security/features` | `hasAllFeatures()` utility |
