...
- New generated registries in `apps/helios/.helios/generated/`:
...
- Runtime middleware executors in:
  ...
  - `apps/helios/src/app/(backend)/backend/page.tsx` (for parity)
...
This spec introduces a generated registration pattern for page middleware that matches existing Helios extension architecture (`api/interceptors.ts`, `notifications.ts`, `message-objects.ts`). The goal is to make redirect-oriented policies pluggable while preserving current baseline guard behavior.
...
- `apps/helios/src/app/(frontend)/[...slug]/page.tsx`
- `apps/helios/src/app/(backend)/backend/[...slug]/page.tsx`
- `apps/helios/src/app/(backend)/backend/page.tsx`
...
1. Add shared page middleware types and matcher utilities in `@helios/shared`.
...
| `apps/helios/.helios/generated/frontend-middleware.generated.ts` | Generate | Frontend middleware registry |
| `apps/helios/.helios/generated/backend-middleware.generated.ts` | Generate | Backend middleware registry |
| `apps/helios/src/app/(frontend)/[...slug]/page.tsx` | Modify | Execute frontend middleware after built-in checks |
| `apps/helios/src/app/(backend)/backend/[...slug]/page.tsx` | Modify | Execute backend middleware after built-in checks |
| `apps/helios/src/app/(backend)/backend/page.tsx` | Modify | Execute backend-index middleware for parity |
...
| packages/cli/AGENTS.md | Generator changes must emit to `.helios/generated/` | Compliant | New generated outputs follow existing pattern and checksums |
