...
1. **Direct import** — `import { SalesQuote } from '@helios/core/modules/sales/data/entities'` — creates hard compile-time coupling between modules, violating the module isolation principle.
