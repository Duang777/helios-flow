...
- refactored the Helios backend layout to stop building sidebar chrome on the SSR critical path and to use lazy client header chrome wrappers
...
## Problem Statement
Current first-load cost is concentrated in [`apps/helios/src/app/(backend)/backend/layout.tsx`](/Users/piotrkarwatka/Projects/helios-development-two/apps/helios/src/app/(backend)/backend/layout.tsx), which currently:
...
- [`apps/helios/src/app/(backend)/backend/[...slug]/page.tsx`](/Users/piotrkarwatka/Projects/helios-development-two/apps/helios/src/app/(backend)/backend/[...slug]/page.tsx) separately resolves page-level `requireFeatures`
- client menu surfaces use [`useInjectedMenuItems`](/Users/piotrkarwatka/Projects/helios-development-two/packages/ui/src/backend/injection/useInjectedMenuItems.ts), which repeats feature and role fetching per surface
...
- [`apps/helios/src/app/(backend)/backend/layout.tsx`](/Users/piotrkarwatka/Projects/helios-development-two/apps/helios/src/app/(backend)/backend/layout.tsx)
- [`packages/core/src/modules/auth/api/admin/nav.ts`](/Users/piotrkarwatka/Projects/helios-development-two/packages/core/src/modules/auth/api/admin/nav.ts)
...
Refactor [`apps/helios/src/app/(backend)/backend/layout.tsx`](/Users/piotrkarwatka/Projects/helios-development-two/apps/helios/src/app/(backend)/backend/layout.tsx) so it no longer:
- calls `buildAdminNav()`
...
Reuse and extend [`packages/core/src/modules/auth/api/admin/nav.ts`](/Users/piotrkarwatka/Projects/helios-development-two/packages/core/src/modules/auth/api/admin/nav.ts) as the single backend chrome payload endpoint.
...
Refactor [`packages/ui/src/backend/AppShell.tsx`](/Users/piotrkarwatka/Projects/helios-development-two/packages/ui/src/backend/AppShell.tsx) so the authoritative sidebar/settings/profile data comes from the shared provider rather than server-passed resolved nav.
...
Refactor [`packages/ui/src/backend/injection/useInjectedMenuItems.ts`](/Users/piotrkarwatka/Projects/helios-development-two/packages/ui/src/backend/injection/useInjectedMenuItems.ts) to stop calling:
...
[`apps/helios/src/app/(backend)/backend/[...slug]/page.tsx`](/Users/piotrkarwatka/Projects/helios-development-two/apps/helios/src/app/(backend)/backend/[...slug]/page.tsx) must continue to enforce:
- `requireAuth`
- `requireRoles`
- `requireFeatures`
