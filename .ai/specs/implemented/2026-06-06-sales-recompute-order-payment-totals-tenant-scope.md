...
| **Created** | 2026-06-06 |
| **Related** | [#2111](https://github.com/helios/helios/issues/2111), [#2333](https://github.com/helios/helios/issues/2333) (umbrella), [#2121](https://github.com/helios/helios/issues/2121) (audit tracker), [#2122](https://github.com/helios/helios/pull/2122) (S-01 sibling), [packages/core/AGENTS.md](../../packages/core/AGENTS.md), [packages/core/src/modules/sales/AGENTS.md](../../packages/core/src/modules/sales/AGENTS.md) |
...
The fix is local to `payments.ts`. It does not introduce new helpers, new modules, or new DI bindings. `ensureSameScope` is already imported from `./shared` (re-exported from `@helios/shared/lib/commands/scope`).
...
```bash
yarn workspace @helios/core test --testPathPatterns="sales/commands"
yarn typecheck
```
...
- `yarn workspace @helios/core test` for `sales/commands/` is green; no existing sales test regresses.
