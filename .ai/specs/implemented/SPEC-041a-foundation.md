...
```typescript
// apps/helios/src/modules/example/widgets/injection/example-menus/widget.ts
...
**Example module file exercised**: `apps/helios/src/modules/example/widgets/injection/example-menus/widget.ts`
...
| **NEW** | `apps/helios/src/modules/example/widgets/injection/example-menus/widget.ts` |
...
| **MODIFY** | `apps/helios/src/modules/example/widgets/injection-table.ts` (add menu spot) |
