...
**Key Points:**
- Issue [#824](https://github.com/helios/helios/issues/824) asks for default values on custom attributes so newly created records can start with predefined values such as a default status.
...
Issue URL: `https://github.com/helios/helios/issues/824`
...
| CLI | `helios entities` CLI can write `configJson.defaultValue` |
