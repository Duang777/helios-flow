...
| **Created** | 2026-06-05 |
| **Related** | [#2598](https://github.com/helios/helios/issues/2598), [#2333](https://github.com/helios/helios/issues/2333), [#2596](https://github.com/helios/helios/issues/2596), [PR #2549](https://github.com/helios/helios/pull/2549), [SPEC-018 Atomic Phased Flush](./SPEC-018-2026-02-05-safe-entity-flush.md), [BACKWARD_COMPATIBILITY.md](../../BACKWARD_COMPATIBILITY.md), [packages/shared/AGENTS.md](../../packages/shared/AGENTS.md), [packages/core/AGENTS.md](../../packages/core/AGENTS.md) |
...
- The helper MUST stay framework-side only: no domain types, no module-specific imports. It belongs to `@helios/shared`.
...
## Proposed Solution
Add a single helper in `@helios/shared/lib/commands/runCrudCommandWrite`:
...
} from '@helios/shared/lib/crud/types'
...
1. `yarn workspace @helios/shared test`
2. `yarn workspace @helios/core test`
...
- `yarn workspace @helios/shared test`, `yarn workspace @helios/core test`, and `yarn typecheck` all green.
