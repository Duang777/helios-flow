...
- **Object attachments** - Attach Helios entities (e.g., leave requests, orders) with actions
...
import type { MessageTypeDefinition } from '@helios/shared/modules/messages/types'
...
3. The module registry generator emits two generated files in `apps/helios/.helios/generated/`:
...
```typescript
// apps/helios/.helios/generated/message-types.generated.ts
// AUTO-GENERATED by helios generate registry
import type { MessageTypeDefinition } from '@helios/shared/modules/messages/types'
import * as MSG_staff_1 from '@helios/core/modules/staff/message-types'
import * as MSG_messages_2 from '@helios/core/modules/messages/message-types'
...
export async function linkAttachmentsToMessage(
  ...
  const { Attachment } = await import('@helios/core/modules/attachments/data/entities')
...
import { AttachmentUploader } from '@helios/core/modules/attachments/components/AttachmentUploader'
import { AttachmentList } from '@helios/core/modules/attachments/components/AttachmentList'
...
import type { ObjectPreviewProps } from '@helios/shared/modules/messages/types'
...
import { formatFileSize } from '@helios/shared/lib/format'
        ...
        <Container style={styles.container}>
          ...
          <Section style={styles.footer}>
            <Text style={styles.footerText}>
              This message was sent via Helios. 
...
import { json } from '@helios/shared/lib/api/response'
...
import { getOrm } from '@helios/shared/lib/db/mikro'
...
import { emitRealtimeEvent } from '@helios/shared/lib/frontend/realtimeEvents'
...
import { AttachmentUploader } from '@helios/core/modules/attachments/components/AttachmentUploader'
import { AttachmentList } from '@helios/core/modules/attachments/components/AttachmentList'
import { MESSAGE_ATTACHMENT_ENTITY_ID, MESSAGE_ATTACHMENT_PARTITION } from '@helios/core/modules/messages/lib/attachments'
