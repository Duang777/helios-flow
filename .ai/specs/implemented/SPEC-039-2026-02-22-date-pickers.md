...
- UI: DateTimePicker, TimePicker, TimeInput available in `@helios/ui/backend/inputs` — not yet used in ActivitiesSection, ActivityForm, AvailabilitySchedule, InlineEditors, AvailabilityRulesEditor, CurrencyFetchingConfig
...
This spec introduces three shared input components — `DatePicker`, `DateTimePicker`, and `TimePicker` — as part of the `@helios/ui` package, following the same pattern as existing reusable inputs (`ComboboxInput`, `TagsInput`, `LookupSelect`).
...
**Locale file paths:**
- `apps/helios/src/i18n/{en,pl,de,es}.json`
...
7. Add i18n translation keys to all locale files (en, pl, de, es) in `apps/helios/src/i18n/`
...
2. Add `ui.datePicker.todayButton` and `ui.datePicker.clearButton` keys to all locale files (en, pl, de, es) in `apps/helios/src/i18n/` and `packages/create-app/template/src/i18n/`
...
| `apps/helios/src/i18n/en.json` | Modify | 2 ✅ + 4 ✅ | Add `ui.datePicker.*`, `ui.dateTimePicker.*`, `ui.timePicker.*` keys (English) |
| `apps/helios/src/i18n/pl.json` | Modify | 2 ✅ + 4 ✅ | Same keys (Polish) |
| `apps/helios/src/i18n/de.json` | Modify | 2 ✅ + 4 ✅ | Same keys (German) |
| `apps/helios/src/i18n/es.json` | Modify | 2 ✅ + 4 ✅ | Same keys (Spanish) |
...
1. **Components available** — DatePicker, DateTimePicker, TimePicker, TimeInput, Popover, Calendar in `@helios/ui`; CrudForm supports `type: 'datepicker'`, `type: 'datetime'`, and `type: 'time'`
