...
**Date:** 2026-03-15
**Status:** Draft
**Scope:** OSS — Changesets-based stable and prerelease publishing workflow for `helios/official-modules`
**Author:** Helios Team
...
```json
{
  ...
  "changelog": ["@changesets/changelog-github", { "repo": "helios/official-modules" }],
  "commit": false,
  "fixed": [],
  "linked": [],
  "access": "public",
...
```md
---
"@helios/module-n8n-integration": minor
"@helios/module-stripe-payments": patch
---
...
```md
---
"@helios/module-example-a": minor
"@helios/module-example-b": patch
---
...
| `HELIOS_RELEASE_CHANNEL` | workflow-defined | Release channel for scripts (`stable` or `preview`) |
