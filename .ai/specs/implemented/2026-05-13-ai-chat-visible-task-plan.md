...
**Primary Scope:** OSS, `@helios/ai-assistant`, `@helios/ui`
**Companion Scope:** `apps/helios`, `packages/create-app`, shared backend DataTable UX
**Extends:**
...
Files:
- `apps/helios/src/lib/dev-origins.ts`
- `packages/create-app/template/src/lib/dev-origins.ts`
- `apps/helios/src/__tests__/dev-origins.test.ts`
...
- `yarn workspace @helios/app test --runTestsByPath src/__tests__/dev-origins.test.ts --runInBand` — PASS.
- `cmp -s apps/helios/src/lib/dev-origins.ts packages/create-app/template/src/lib/dev-origins.ts` — PASS, template and app helper are in sync.
...
- `yarn workspace @helios/ui test --runTestsByPath src/backend/__tests__/DataTable.render.test.tsx --runInBand` — PASS.
