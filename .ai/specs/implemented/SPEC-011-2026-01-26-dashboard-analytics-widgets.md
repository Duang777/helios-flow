...
|-----------|----------|-------------|
| Chart Components | `@helios/ui/backend/charts` | BarChart, LineChart, PieChart, KpiCard, TopNTable |
| Date Range Components | `@helios/ui/backend/date-range` | DateRangeSelect, InlineDateRangeSelect, date utilities |
| Analytics Types | `@helios/shared/modules/analytics` | Shared types and global registry |
...
import type { AnalyticsModuleConfig } from '@helios/shared/modules/analytics'
...
Use the shared chart components from `@helios/ui/backend/charts`:

```typescript
import { KpiCard } from '@helios/ui/backend/charts'
import { DateRangeSelect, type DateRangePreset } from '@helios/ui/backend/date-range'
```
...
} from '@helios/ui/backend/date-range'
...
- Moved chart components to `@helios/ui/backend/charts`
- Moved date range components to `@helios/ui/backend/date-range`
