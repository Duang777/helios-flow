...
- Date: 2026-06-04
- Issue: [#2127](https://github.com/helios/helios/issues/2127)
...
- Generalizing `RecordNotFoundState` itself into a frontend/portal export path (its `@helios/ui/
...
Compose `EmptyState` from `@helios/ui/primitives/empty-state` instead of `ErrorMessage`:
