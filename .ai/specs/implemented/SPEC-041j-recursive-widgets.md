...
| Action | File |
|--------|------|
| **NEW** | `apps/helios/src/modules/example/widgets/injection/crud-validation-addon/widget.ts` |
| **MODIFY** | `apps/helios/src/modules/example/widgets/injection/crud-validation/widget.client.tsx` (add nested InjectionSpot) |
| **MODIFY** | `apps/helios/src/modules/example/widgets/injection/crud-validation/widget.ts` (delegate lifecycle events to nested widget spot) |
| **MODIFY** | `apps/helios/src/modules/example/widgets/injection-table.ts` (add nested spot mapping) |
| **MIRROR** | `packages/create-app/template/src/modules/example/widgets/injection/*` + `injection-table.ts` (template sync) |
| **NEW** | `apps/helios/src/modules/example/__integration__/TC-UMES-009.spec.ts` (TC-UMES-RW01, TC-UMES-RW02) |
