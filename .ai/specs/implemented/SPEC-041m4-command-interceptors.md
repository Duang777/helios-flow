...
import type { CommandInterceptor } from '@helios/shared/lib/commands/command-interceptor'

export const interceptors: CommandInterceptor[] = [...]
```

`yarn generate` discovers `commands/interceptors.ts` and generates `command-interceptors.generated.ts` into `apps/helios/.helios/generated/`.
