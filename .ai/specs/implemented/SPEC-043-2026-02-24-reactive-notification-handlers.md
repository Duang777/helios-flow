...
The CLI generator (`yarn generate`) discovers `notifications.handlers.ts` files and generates a handler registry in `apps/helios/.helios/generated/notification-handlers.ts`:
