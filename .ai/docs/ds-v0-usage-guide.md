...
How to use the DS v0 components, tokens, and tooling in Helios.
...
```tsx
import { StatusBadge, type StatusMap } from '@helios/ui/primitives/status-badge'
...
```tsx
import { SectionHeader } from '@helios/ui/backend/SectionHeader'
...
```tsx
import { CollapsibleSection } from '@helios/ui/backend/SectionHeader'
...
bash .ai/skills/helios-ds-guardian/scripts/ds-migrate-colors.sh packages/core/src/modules/MODULE_NAME/

# Migrate arbitrary text sizes in a module
bash .ai/skills/helios-ds-guardian/scripts/ds-migrate-typography.sh packages/core/src/modules/MODULE_NAME/
...
// Section headers
import { SectionHeader, CollapsibleSection } from '@helios/ui/backend/SectionHeader'
