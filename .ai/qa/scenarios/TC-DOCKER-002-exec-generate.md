...
| 2 | Note the modification time of `apps/helios/.helios/generated/` on host | Baseline timestamp recorded |
...
| 5 | Check `apps/helios/.helios/generated/` modification time | Files have been updated (newer than baseline) |
...
- Running with no container active should print: `Error: No running Helios app container found` with startup instructions
