...
- **Undo banner / toast** after a mutation — client store keeps the last operations for **60 s** (`LAST_OPERATION_TTL_MS`), auto-dismiss default **10 s** (`NEXT_PUBLIC_HELIOS_UNDO_BANNER_TIMEOUT_MS`), stack limit 20.
