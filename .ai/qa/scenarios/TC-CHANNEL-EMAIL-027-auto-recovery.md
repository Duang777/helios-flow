...
| 2 | Restore IMAP. Wait 30 minutes (or set `HELIOS_CHANNEL_AUTO_RECOVER_MINUTES=0` for the test). | Next tick re-enqueues the channel; poll succeeds; status flips back to `connected`. |
