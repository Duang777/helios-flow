...
**PR:** https://github.com/helios/helios/pull/2023
...
- Out-of-scope changes still in the diff (noted as non-blocking by prior reviewer):
  ...
  - `packages/ui/src/backend/upgrades/UpgradeActionBanner.tsx`: x-helios-forbidden-redirect/x-helios-unauthorized-redirect headers
