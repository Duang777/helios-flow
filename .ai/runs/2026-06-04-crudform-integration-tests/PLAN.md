...
**Source umbrella:** https://github.com/helios/helios/issues/2466
...
create + update, gated behind `HELIOS_INTEGRATION_CRUDFORM_EXTENSION_TESTS_DISABLED`.
...
- `HELIOS_INTEGRATION_CRUDFORM_EXTENSION_TESTS_DISABLED` (default **false** → tests run).
...
- Parsed via `parseBooleanWithDefault` from `@helios/shared/lib/boolean`.
