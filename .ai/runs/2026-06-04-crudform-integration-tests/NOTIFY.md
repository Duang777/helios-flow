...
- Brief: author automated CrudForm field-persistence integration tests (incl. custom fields),
  one stacked PR per module, gated by `HELIOS_INTEGRATION_CRUDFORM_EXTENSION_TESTS_DISABLED`
...
- Integration smoke on live :3000: TC-CUR-CRUDFORM-001 passes (default) and skips when
  HELIOS_INTEGRATION_CRUDFORM_EXTENSION_TESTS_DISABLED=1. Harness proven end-to-end + skippable.
