...
**PR:** #3715 (against helios:develop) — supersedes design-spec PR #3685
...
- @helios/cli as a create-app build-time devDependency (extractor import in build.mjs).

## Remaining (owner / CI)
- PR CI runs build:app + integration suites (N/A per spec but CI-covered). A formal `helios-auto-review-pr` may run on the PR.
