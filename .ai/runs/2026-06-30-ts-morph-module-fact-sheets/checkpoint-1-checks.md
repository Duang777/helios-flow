...
**Touched packages:** `packages/cli` (new `module-facts.ts` + `module-facts-generate.ts` generator), `apps/helios` (versioned `module-facts.generated.json` artifact only)
...
| Generated artifact present `apps/helios/src/module-facts.generated.json` | ✅ 125 KB, 9 D5 modules |
