...
| 1 | 1.6 | Wire into yarn generate → versioned apps/helios/src/module-facts.generated.json | done | 2e9740062 |
...
- Versioned monorepo artifact `apps/helios/src/module-facts.generated.json` (NOT under `.helios/generated/`).
...
- **R1 (spec) version skew:** baked facts can lag installed `@helios/core`; mitigated by a version stamp; generate-time regeneration deferred.
