...
- Steps 1.1..3.1 verified. `checkpoint-1-checks.md` written. Pre-existing workspace `@helios/cache` resolution failures reproduced against `origin/develop` → not a regression introduced by this PR. No UI changes in window → Playwright skipped, no artifacts.
