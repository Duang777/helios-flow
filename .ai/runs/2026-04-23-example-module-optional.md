...
- `apps/helios` and `packages/create-app/template` starter surfaces that still expose example-only links or behavior when `example` is absent
...
2. Perform code-review and backward-compatibility self-review, then open the PR and run `helios-auto-review-pr`.
...
- [x] 3.2 Perform code-review and backward-compatibility self-review, then open the PR and run `helios-auto-review-pr`
