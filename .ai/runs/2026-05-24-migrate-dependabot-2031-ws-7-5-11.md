...
- Source PR: [#2031](https://github.com/helios/helios/pull/2031) (base `main`, Dependabot)
- Target base: `develop`
- Date: 2026-05-24
...
- Touching the separate `ws@^8.x` resolution that PR [#2018](https://github.com/helios/helios/pull/2018) is updating to 8.20.1. The two yarn.lock entries are independent.
