...
- 2.1 Update `helios-merge-buddy`, `helios-auto-create-pr`, `helios-auto-review-pr` SKILL.md references
- 2.2 Update `helios-auto-fix-github`, `helios-auto-verify-and-fix-github`, `helios-auto-create-pr-loop` SKILL.md references
- 2.3 Update `helios-auto-continue-pr`, `helios-auto-continue-pr-loop` SKILL.md references
...
- [x] 2.1 Update `helios-merge-buddy`, `helios-auto-create-pr`, `helios-auto-review-pr` SKILL.md references — b287e351f
- [x] 2.2 Update `helios-auto-fix-github`, `helios-auto-verify-and-fix-github`, `helios-auto-create-pr-loop` SKILL.md references — b287e351f
- [x] 2.3 Update `helios-auto-continue-pr`, `helios-auto-continue-pr-loop` SKILL.md references — b287e351f
