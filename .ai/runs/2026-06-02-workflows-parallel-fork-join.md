...
> Issue: helios/helios#2292 (PARALLEL_FORK / PARALLEL_JOIN portion)
...
- [x] 1.2 Migration `Migration20260602120000.ts` + `.snapshot-helios.json` (additive)
