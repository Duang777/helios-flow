...
status: complete
related-prs:
  - https://github.com/helios/helios/pull/1888
  - https://github.com/helios/helios/pull/1889
  - https://github.com/helios/helios/pull/1890
  - https://github.com/helios/helios/pull/1891
  - https://github.com/helios/helios/pull/1892
precedent:
...
Combine the five open Dependabot PRs targeting `main` ([#1888 minor-and-patch group](https://github.com/helios/helios/pull/1888), [#1889 major group](https://github.com/helios/helios/pull/1889), [#1890 mermaid](https://github.com/helios/helios/pull/1890), [#1891 next (apps/helios)](https://github.com/helios/helios/pull/1891), [#1892 next (root + apps/helios)](https://github.com/helios/helios/pull/1892)) into a single PR against `develop` and close the originals, so the next release cycle picks up the dependency bumps without re-opening separate Dependabot branches against the moving `develop` base.
...
|---------|---------------|----|-------|
| `@ai-sdk/openai` | `^3.0.53` | `^3.0.63` | root, apps/helios, packages/ai-assistant, packages/search |
...
| `@tanstack/react-query` | `^5.100.5` | `^5.100.10` | root, apps/helios |
| `@tanstack/react-virtual` | `^3.13.23` | `^3.13.24` | packages/ui |
| `ai` | `^6.0.168` / `6.0.168` | `^6.0.177` / `6.0.177` | root (resolution + dep), apps/helios, packages/ai-assistant, packages/core, packages/search |
| `next` + `eslint-config-next` | `16.2.4` | `16.2.6` | root, apps/helios |
| `pdfjs-dist` | `^5.4.149` | `^5.7.284` | root, apps/helios, packages/core |
| `react` + `react-dom` | `19.2.5` / `^19.2.5` | `19.2.6` / `^19.2.6` | root, apps/helios, apps/docs |
| `react-email` | `^6.0.0` | `^6.1.1` | root, apps/helios |
| `resend` | `^6.12.0` | `^6.12.3` | root, apps/helios |
| `semver` | `^7.7.4` | `^7.8.0` | root, apps/helios, packages/cli, packages/core |
| `tailwind-merge` | `^3.5.0` | `^3.6.0` | root, apps/helios |
| `zod` | `4.3.6` / `^4.3.6` | `4.4.3` / `^4.4.3` | root, apps/helios, packages/search |
| `@types/node` | `^25.6.0` | `^25.6.2` | root, apps/docs, apps/helios, packages/cache, packages/create-app, packages/queue, packages/scheduler |
| `eslint` | `^10.2.1` | `^10.3.0` | root, apps/helios |
...
| `@stripe/react-stripe-js` | `^6.2.0` | `^6.3.0` | apps/helios, packages/gateway-stripe |
| `stripe` | `^22.1.0` | `^22.1.1` | packages/gateway-stripe |
| `bullmq` | `^5.76.2` | `^5.76.7` | apps/helios |
| `@tailwindcss/postcss` + `tailwindcss` | `^4.2.4` | `^4.3.0` | apps/helios |
...
Covered by #1888 above (which bumps `next` and `eslint-config-next` to `16.2.6` in root + apps/helios). No additional action needed.
...
- Reference PR: [#1625](https://github.com/helios/helios/pull/1625) — establishes the "consolidated PR against develop" pattern
