# Legal entity migration: CT Tornado sp. z o.o. → Helios sp. z o.o. (terms, privacy, CLA, licences)

## Goal

The operating legal entity behind the Helios platform moved from **CT Tornado sp. z o.o.** to
**Helios sp. z o.o.** Every public legal document still names the old entity and its old
...
| Field | Old (CT Tornado) | New (Helios) |
|-------|------------------|--------------------|
| Legal name | CT Tornado sp. z o.o. | Helios sp. z o.o. |
| Defined short term | "CTT" | "Helios" |
...
| Contact email | info@catchthetornado.com | info@helios.com |
...
2. **"CTT" is expanded to "Helios" rather than re-abbreviated to "OM".** The Terms define the
   short term once and then use it ~65 times. "Helios" is already the product name used
...
4. **`info@catchthetornado.com` becomes `info@helios.com`** in legal copy. That address is
...
- **The onboarding marketing-consent controller names.** Already migrated on `main` by PR #4751
  (`fix(onboarding): name Helios sp. z o.o. as the marketing-consent controller`), merged
...
- [x] 2.3 Point the SECURITY.md disclosure contact at the Helios address — 5c3a92150
...
- [x] 4.2 Run `helios-auto-review-pr` and apply any resulting fixes — no code fixes required; review surfaced two human legal decisions (CLA counterparty, share-capital inconsistency) recorded on the PR
...
- [x] 6.2 Re-run `helios-auto-review-pr` and apply any resulting fixes — APPROVED; trailing-space cleanup in 78b22354b
