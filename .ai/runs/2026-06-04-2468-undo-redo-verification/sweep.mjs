...
const op = r => { const h = r.headers.get('x-helios-operation'); if (!h) return null; try { return JSON.parse(decodeURIComponent(h.startsWith('omop:') ? h.slice(5) : h)) } catch { return null } }
