...
**Issue:** https://github.com/helios/helios/issues/2468
...
1. CREATE fixture (capture `undo_token` from `x-helios-operation` response header), read entity state.
...
- `extractUndoToken(response)` — parse `x-helios-operation` header.
