...
Source follow-up: https://github.com/helios/helios/pull/3397#issuecomment-4791481983
...
1. the *Enabled* badge toggle sends `x-helios-ext-optimistic-lock-expected-updated-at` and the write persists;
