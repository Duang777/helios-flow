...
- `yarn.cmd workspace @helios/shared test packages/shared/src/lib/encryption/__tests__/tenantDataEncryptionService.test.ts packages/shared/src/lib/query/__tests__/engine.test.ts`
- `yarn.cmd workspace @helios/core test packages/core/src/modules/query_index/__tests__/hybrid-engine.test.ts`
- `git diff --check`
