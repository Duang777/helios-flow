...
- `yarn workspace @helios/core test src/modules/customers/__tests__/ai-agents.test.ts --runInBand`
- `yarn workspace @helios/core test src/modules/customers/__tests__/ai-tools/deals-pack.mutation.test.ts --runInBand`

## Notes

- `yarn workspace @helios/core typecheck` could not run in this fresh worktree because the workspace script could not find `tsc`.
