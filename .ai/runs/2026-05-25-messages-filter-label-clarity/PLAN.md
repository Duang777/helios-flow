...
Tooltip en values:
- hasObjectsTooltip: "Shows messages that have Helios records attached — such as orders, quotes, or customers."
...
- Add `tooltip: t('messages.filters.hasObjectsTooltip', 'Shows messages that have Helios records attached — such as orders, quotes, or customers.')`
