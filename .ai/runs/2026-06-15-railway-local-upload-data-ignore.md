...
Fix fresh `create-helios-app` Railway local-source deployments so required app module `data/` source folders are uploaded and the remote build can resolve their imports.
