...
**Non-goals:** No manifest version bump (package.json stays 0.6.5 — out of scope per helios-auto-update-changelog rules), no git tag, no Highlights authoring (left as TODO for a human maintainer).

**Source:** Drafted by the `helios-auto-update-changelog` skill.
