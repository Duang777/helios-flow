...
- Brief: Implement `.ai/specs/2026-07-05-attachment-metadata-assignment-layout.md` via `helios-auto-create-pr-loop`.
...
- Brief: Opened https://github.com/helios/helios/pull/3780 as a draft PR from the fork branch.
