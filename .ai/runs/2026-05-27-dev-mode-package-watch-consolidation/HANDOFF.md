...
- Added Linux RSS profiling helper (`scripts/profile-dev-rss.mjs`) and an opt-in legacy escape hatch via `HELIOS_WATCH_PACKAGES_MODE=legacy`.
...
- Path: `/home/pkarw/Projects/github-janitor/.janitor/repos/helios__helios/worktrees/2b7952ad-219e-4dce-9755-8dce291d54c5`
