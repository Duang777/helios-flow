...
**Branch:** `fix/ai-chat-sessions-scope-isolation` (pushed to `adeptofvoltron/helios` fork)
**PR:** will be opened against `helios/helios:develop` in this commit step
...
## Worktree
- Path: `/home/bernard/workspace/HeliosTest/.ai/tmp/auto-create-pr/ai-chat-sessions-scope-isolation-20260528-110909`
