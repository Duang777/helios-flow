...
- `@helios/ui` full test suite: 142 suites / 1105 tests / 0 failures
- Built `@helios/ai-assistant` once to unblock pre-existing AiChat tests that depend on dist output. Not a regression introduced by this run.
