...
Prepare the Helios 0.6.0 release metadata by updating the changelog with merged `develop` PRs since 0.5.0 and bumping workspace package versions to `0.6.0`.
...
- `.ai/skills/helios-auto-update-changelog/SKILL.md` — adopted release-window, categorization, contributor-credit, and reporting rules. Extended scope only because the user explicitly requested package version bumps in the same release-prep PR.
