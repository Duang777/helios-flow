...
status: complete
related-prs:
  - https://github.com/helios/helios/pull/1724
  - https://github.com/helios/helios/pull/1723
precedent:
...
Combine the two open Dependabot PRs that target `main` ([#1724 major group](https://github.com/helios/helios/pull/1724), [#1723 minor-and-patch group](https://github.com/helios/helios/pull/1723)) into a single PR against `develop`, so the next release cycle can consume their dependency bumps without re-opening separate Dependabot branches against the moving `develop` base.

## Scope

This run follows the precedent set by [PR #1625](https://github.com/helios/helios/pull/1625), but the BC-breaker landscape on `develop` has shifted since then. As of `develop@ccbadc819`:
...
|---------|---------------|----|-------|
| `@napi-rs/canvas` | `^0.1.78` | `^0.1.100` | `package.json`, `apps/helios/package.json` |
| `@stripe/stripe-js` | `^9.2.0` | `^9.3.1` | `apps/helios/package.json`, `packages/gateway-stripe/package.json` |
| `@tanstack/react-query` | `^5.99.2` | `^5.100.5` | `package.json`, `apps/helios/package.json` |
| `lucide-react` | `^1.8.0` | `^1.11.0` | `package.json`, `apps/helios/package.json` |
| `@tailwindcss/postcss` | `^4.2.2` | `^4.2.4` | `apps/helios/package.json` |
| `tailwindcss` | `^4.2.2` | `^4.2.4` | `apps/helios/package.json` |
| `bullmq` | `^5.75.2` | `^5.76.2` | `apps/helios/package.json` |
...
- Reference PR: [#1625](https://github.com/helios/helios/pull/1625) — the prior migration that this PR mirrors
