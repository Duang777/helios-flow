...
Snapshot of `helios/helios` taken 2026-07-24:
...
- Do not touch `.ai/agentic.config.json` (`qaGate: true` stays), any `helios-auto-*` skill, any CI workflow, or any label definition.
