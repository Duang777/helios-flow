# create-helios-app — agentic wizard must survive a non-interactive shell

Status: complete

## Goal

Make `npx create-helios-app <name>` complete without a TTY. Today it creates the app and then
...
```
   ...
   .../create-helios-app/bin/create-helios-app:28
