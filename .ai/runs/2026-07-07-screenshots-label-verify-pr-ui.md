# Execution plan: `screenshots` meta-label for helios-auto-verify-pr-ui
...
Add an informational, additive `screenshots` meta-label that `helios-auto-verify-pr-ui`
...
- `.ai/skills/helios-auto-verify-pr-ui/SKILL.md` — apply `screenshots` (variant A: default-on
...
- Applied via the GraphQL label flow (per helios-auto-review-pr step 8), with a short label comment,
