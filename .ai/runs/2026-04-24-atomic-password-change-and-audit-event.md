...
- 6.2 Self code-review (`.ai/skills/helios-code-review/SKILL.md`) + BC self-review (`BACKWARD_COMPATIBILITY.md`).
- 6.3 Open PR against `develop`, apply `security` + `needs-qa` labels.
- 6.4 Run `helios-auto-review-pr` in autofix mode; iterate until clean or only non-actionable findings remain.
