...
- Executors reported: checkout full suite 43/43; auth editable-entities guard 34/34 + ui-coverage 2/2 green; `tsc --noEmit` clean for @helios/core, @helios/ui, @helios/checkout.
