...
`helios-auto-verify-pr-ui` run on #3438 exercised every guarded write surface end-to-end with a
...
- PR #3438 + its `helios-auto-verify-pr-ui` evidence + integration-test follow-up comment.
