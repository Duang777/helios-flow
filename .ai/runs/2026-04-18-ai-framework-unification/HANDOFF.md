...
**PR:** https://github.com/helios/helios/pull/1593 (held by
...
- **Typecheck**: `yarn turbo run typecheck --filter=@helios/core
  --filter=@helios/ai-assistant --filter=@helios/app` → 2/2
...
- Path: `/Users/piotrkarwatka/Projects/helios-development` (user's
