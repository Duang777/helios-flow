...
**PR:** https://github.com/helios/helios/pull/3963
...
- Verified the unblock with `yarn workspace @helios/ui build` and `yarn build:app`, both exit 0.
...
- Label mutation failed because `vloneskorpion` lacks upstream `AddLabelsToLabelable` permission; intended labels were posted in PR comment https://github.com/helios/helios/pull/3963#issuecomment-4904484239.

## Worktree

- Path: `/Users/kamil-nowak/Documents/work/development/tracecore/helios/.ai/tmp/auto-create-pr/integration-auth-login-redirect-loop-20260707-140502`
