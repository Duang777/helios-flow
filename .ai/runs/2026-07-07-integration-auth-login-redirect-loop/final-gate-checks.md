...
| `yarn generate` | pass | Generated artifacts; validation-generated `apps/helios/src/module-facts.generated.json` churn was reverted. |
...
|---------|--------|-------|
| `yarn workspace @helios/ui build` | PASS | Rebuilt the UI package after the one-line `AdvancedFilterPanel` fix. |
