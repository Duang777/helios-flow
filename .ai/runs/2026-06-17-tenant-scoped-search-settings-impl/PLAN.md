...
- 4.3 Update `packages/search/AGENTS.md`, `packages/core/AGENTS.md`, UPGRADE_NOTES.

## Environment / fork notes

- Fork workflow: push to `fork` (`adeptofvoltron/helios`); PR via `gh pr create --repo helios/helios --base develop --head adeptofvoltron:feat/tenant-scoped-search-settings-impl`.
