...
**Packages touched:** `@helios/search` (`modules/search/lib/*`, `modules/search/api/*`)

## Checks

| Check | Scope | Result |
|-------|-------|--------|
| Compile — `yarn workspace @helios/search build` | search | ✅ built successfully (exit 0), 88 entry points |
