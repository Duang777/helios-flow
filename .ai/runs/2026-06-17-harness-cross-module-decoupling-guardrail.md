...
- No edits to `module-dependencies.mdx`, BC contract surfaces, `helios-implement-spec`/`helios-pre-implement-spec`, or `helios-create-agents-md` (rejected by the audit as redundant or off-budget).
...
3. No edit restates the ORM/import bans (they exist at root `AGENTS.md`:30/268, `packages/core/AGENTS.md`:24, helios-code-review checklist).
...
- [x] 3.1 Add soft-optional/direction bullet to helios-code-review `references/review-checklist.md` § 1 — 00c32368f
- [x] 3.2 Add mechanism/direction/absent-behavior bullet to helios-spec-writing `references/spec-checklist.md` § 2 — 00c32368f
- [x] 3.3 Extend helios-spec-writing `SKILL.md` heuristic #5 (Module Isolation) for optional peers — 00c32368f
