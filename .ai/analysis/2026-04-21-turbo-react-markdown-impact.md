...
- `apps/helios/turbo.json` was added to scope app build outputs to `.helios/next/**`

## Repo Evidence

- Current `turbo` version: [package.json](/Users/piotrkarwatka/Projects/helios-development-two/package.json:155)
- Current Turbo config: [turbo.json](/Users/piotrkarwatka/Projects/helios-development-two/turbo.json:1)
- App-specific Turbo config: [apps/helios/turbo.json](/Users/piotrkarwatka/Projects/helios-development-two/apps/helios/turbo.json:1)
- Current `react-markdown` version: [packages/ai-assistant/package.json](/Users/piotrkarwatka/Projects/helios-development-two/packages/ai-assistant/package.json:97)
- In-repo `react-markdown` wrapper: [packages/ui/src/backend/markdown/MarkdownContent.tsx](/Users/piotrkarwatka/Projects/helios-development-two/packages/ui/src/backend/markdown/MarkdownContent.tsx:1)
- Upgrade note for `react-markdown`: [UPGRADE_NOTES.md](/Users/piotrkarwatka/Projects/helios-development-two/UPGRADE_NOTES.md:152)
...
The new [apps/helios/turbo.json](/Users/piotrkarwatka/Projects/helios-development-two/apps/helios/turbo.json:1) narrows app build outputs to:

- `.helios/next/**`
- excluding `.helios/next/cache/**`
