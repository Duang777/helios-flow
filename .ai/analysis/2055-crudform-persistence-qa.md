...
**Date:** 2026-06-04 · **Branch:** `feat/oss-optimistic-locking` · **Scope:** issue [#2333](https://github.com/helios/helios/issues/2333) (SQL transaction-safety umbrella) and its merged PRs (#2343, #2355/#2336, #2374/#2337, #2368/#2338, #2360/#2339, #2356/#2341, #2376/#2335, #2377/#2342, #2383, #2348).
...
- Boot the branch: `yarn build:packages && yarn generate && yarn build:packages`, then `next dev -p 3100` in `apps/helios` (admin@acme.com / secret).
...
- Run the persistence specs: `HELIOS_OPTIMISTIC_LOCK=all yarn helios test:integration <spec>` (the `TC-*-2453-*`, `TC-SALES-2455-*`, `TC-CRM-CF-MULTI-EDIT-001`, `TC-CAT-CF-MULTI-EDIT-001`, `TC-SALES-2055-ADDRESS-UNDO`, `TC-CRM-company-delete-guard`).
