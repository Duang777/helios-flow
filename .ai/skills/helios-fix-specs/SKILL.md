...
1. Run a dry run first:
   `python3 .ai/skills/helios-fix-specs/scripts/fix_spec_conflicts.py --dry-run`
2. Review planned renames and file updates.
3. Apply changes:
   `python3 .ai/skills/helios-fix-specs/scripts/fix_spec_conflicts.py --apply`
