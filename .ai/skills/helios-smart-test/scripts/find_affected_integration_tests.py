...
def extract_module_identity_from_path(file_path: str) -> tuple[str, str] | None:
    ...
    apps/helios/src/modules/example and packages/create-app/template/src/modules/example.
    """
    ...
    for index, part in enumerate(parts):
        ...
        if len(prefix) >= 3 and prefix[:3] == ("apps", "helios", "src"):
            return module_name, "apps/helios"
