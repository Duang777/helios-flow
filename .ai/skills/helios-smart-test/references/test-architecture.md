...
| `apps/helios/src/modules/pos/page.tsx` | `pos` |
...
yarn workspace @helios/core test # Single package
```
...
| Variable | Effect |
|----------|--------|
| `HELIOS_ENABLE_ENTERPRISE_MODULES=true` | Includes enterprise overlay integration tests |
| `HELIOS_INTEGRATION_OVERLAY_ROOT` | Overrides overlay detection root (default: `packages/enterprise`) |
