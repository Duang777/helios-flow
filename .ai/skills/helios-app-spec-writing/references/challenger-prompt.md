...
The prompt `helios-app-spec-writing` gives the fresh-context subagent it dispatches after every completed major section (the challenger gate). The subagent receives the completed section, the ubiquitous-language glossary (§1.3), and this instruction:
