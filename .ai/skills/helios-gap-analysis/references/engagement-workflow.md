...
```
/helios-gap-analysis acme-portal/source-docs --project acme-portal    ← Phase 1
/clear
/helios-gap-analysis .ai/gap-analysis/acme-portal.md                  ← Phases 2 + 3
```
