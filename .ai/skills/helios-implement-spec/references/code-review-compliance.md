...
This is a condensed reference of the most common violations to check during implementation. For the full checklist, see `.agents/skills/helios-code-review/references/review-checklist.md`.
