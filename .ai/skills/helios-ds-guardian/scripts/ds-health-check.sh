...
# Usage: bash .ai/skills/helios-ds-guardian/scripts/ds-health-check.sh
...
CUSTHELIOS_SWITCH=$(count_matches 'role=["'\'']switch["'\'']')
report "  Custom role='switch': $CUSTHELIOS_SWITCH (target: 0)"
