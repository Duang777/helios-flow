...
name: helios-help
description: >
  Helios workflow navigator. Use when a developer or agent asks: "what should I do now?",
  "which skill should I use?", "where do I start?", "next steps?", "I'm lost", "what comes after X?",
  "how do I add/create/build Y in Helios?", "where does Z go?", "what's the order for a feature/bugfix/PR?",
...
## Mode 2: Knowledge — "How do I do X in Helios?"
...
- **Skill catalog** (all helios-* skills, tiers, triggers, sequencing): `references/skills-catalog.md`
